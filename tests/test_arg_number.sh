...
# Usage: Run this script with "bash test_arg_number.sh".
...
args=(
    ...
    "var_4 | d,D        | var-4,var-d | VAL_4     | false    | A-C     | char | *      | Optional options     |            | arbitrarily many values with default and choice   "
    "var_5 | e,E        | var-5,var-e | VAL_5     | true     |         | str  | ?      | Optional options     |            | one optional value with default                   "
