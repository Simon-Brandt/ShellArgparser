...
args_definition=(
    [var_1]="-:var_1,var_A:-:-:1:Arguments:one value without default or choice"
    [var_2]="-:var_2,var_B:-:-:+:Arguments:at least one value without default or choice"
    [var_3]="-:var_3,var_C:-:A,B:+:Arguments:at least one value with choice"
    [var_4]="-:var_4,var_D:A:A,B,C:1:Options:one value with default and choice"
    [var_5]="-:var_5,var_E:E:-:1:Options:one value with default"
    [var_6]="-:var_6,var_F:false:-:0:Options:no value (flag) with default"
)
