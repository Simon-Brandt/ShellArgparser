...
1. [Reference](#8-reference)
   ...
   1. [Environment variables](#84-environment-variables)
      ...
      1. [`ARGPARSER_HELP_DESCRIPTION`](#8423-argparser_help_description)
      1. [`ARGPARSER_HELP_EXIT_CODE`](#8424-argparser_help_exit_code)
      1. [`ARGPARSER_HELP_FILE`](#8425-argparser_help_file)
      1. [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8426-argparser_help_file_include_char)
      1. [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8427-argparser_help_file_keep_comments)
      1. [`ARGPARSER_HELP_OPTIONS`](#8428-argparser_help_options)
      1. [`ARGPARSER_HELP_STYLE`](#8429-argparser_help_style)
      1. [`ARGPARSER_LANGUAGE`](#8430-argparser_language)
      1. [`ARGPARSER_MAX_COL_WIDTH_1`](#8431-argparser_max_col_width_1)
      1. [`ARGPARSER_MAX_COL_WIDTH_2`](#8432-argparser_max_col_width_2)
      1. [`ARGPARSER_MAX_COL_WIDTH_3`](#8433-argparser_max_col_width_3)
      1. [`ARGPARSER_MAX_WIDTH`](#8434-argparser_max_width)
      1. [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group)
      1. [`ARGPARSER_READ_ARGS`](#8436-argparser_read_args)
      1. [`ARGPARSER_SCRIPT_ARGS`](#8437-argparser_script_args)
      1. [`ARGPARSER_SCRIPT_NAME`](#8438-argparser_script_name)
      1. [`ARGPARSER_SET_ARGS`](#8439-argparser_set_args)
      1. [`ARGPARSER_SET_ARRAYS`](#8440-argparser_set_arrays)
      1. [`ARGPARSER_SILENCE_ERRORS`](#8441-argparser_silence_errors)
      1. [`ARGPARSER_SILENCE_WARNINGS`](#8442-argparser_silence_warnings)
      1. [`ARGPARSER_TRANSLATION_FILE`](#8443-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#8444-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#8445-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#8446-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#8447-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#8448-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8449-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8450-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8451-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8452-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#8453-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#8454-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#8455-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#8456-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#8457-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION`](#8458-argparser_version)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#8459-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_OPTIONS`](#8460-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#8461-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#8462-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#8463-argparser_write_args)
   1. [Translations](#85-translations)
      ...
      1. [`Error env var styles`](#8530-error-env-var-styles)
      1. [`Error env var option type`](#8531-error-env-var-option-type)
      1. [`Error env var orientation`](#8532-error-env-var-orientation)
      1. [`Error env var delimiters`](#8533-error-env-var-delimiters)
      1. [`Error env var short name empty`](#8534-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#8535-error-env-var-short-name-length)
      1. [`Error env var short name inner duplication`](#8536-error-env-var-short-name-inner-duplication)
      1. [`Error env var short name outer duplication`](#8537-error-env-var-short-name-outer-duplication)
      1. [`Error env var short options`](#8538-error-env-var-short-options)
      1. [`Error env var long options`](#8539-error-env-var-long-options)
      1. [`Error env var files`](#8540-error-env-var-files)
      1. [`Error arg array 1`](#8541-error-arg-array-1)
      1. [`Error arg array 2`](#8542-error-arg-array-2)
      1. [`Error arg array 3`](#8543-error-arg-array-3)
      1. [`Error no arg def`](#8544-error-no-arg-def)
      1. [`Error arg def id`](#8545-error-arg-def-id)
      1. [`Error arg def file id`](#8546-error-arg-def-file-id)
      1. [`Error arg def field count`](#8547-error-arg-def-field-count)
      1. [`Error arg def file field count`](#8548-error-arg-def-file-field-count)
      1. [`Error arg def choice range hyphens`](#8549-error-arg-def-choice-range-hyphens)
      1. [`Error arg def choice range`](#8550-error-arg-def-choice-range)
      1. [`Error arg def short name empty`](#8551-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#8552-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#8553-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#8554-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#8555-error-arg-def-short-name-length)
      1. [`Error arg def short name inner duplication`](#8556-error-arg-def-short-name-inner-duplication)
      1. [`Error arg def short name outer duplication`](#8557-error-arg-def-short-name-outer-duplication)
      1. [`Error arg def long name empty`](#8558-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#8559-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#8560-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#8561-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#8562-error-arg-def-long-name-length)
      1. [`Error arg def long name inner duplication`](#8563-error-arg-def-long-name-inner-duplication)
      1. [`Error arg def long name outer duplication`](#8564-error-arg-def-long-name-outer-duplication)
      1. [`Error arg def pos default 1`](#8565-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#8566-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice`](#8567-error-arg-def-pos-choice)
      1. [`Error arg def pos optionals`](#8568-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#8569-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#8570-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#8571-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#8572-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#8573-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#8574-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#8575-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#8576-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#8577-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#8578-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#8579-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#8580-error-arg-def-pos-note)
      1. [`Error arg def option flag`](#8581-error-arg-def-option-flag)
      1. [`Error arg def option default 1`](#8582-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#8583-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#8584-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice`](#8585-error-arg-def-option-choice)
      1. [`Error arg def option type`](#8586-error-arg-def-option-type)
      1. [`Error arg def option bool`](#8587-error-arg-def-option-bool)
      1. [`Error arg def option char`](#8588-error-arg-def-option-char)
      1. [`Error arg def option float`](#8589-error-arg-def-option-float)
      1. [`Error arg def option int`](#8590-error-arg-def-option-int)
      1. [`Error arg def option uint`](#8591-error-arg-def-option-uint)
      1. [`Error arg def option note`](#8592-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#8593-error-arg-double-hyphen)
      1. [`Error arg double plus`](#8594-error-arg-double-plus)
      1. [`Error arg inversion`](#8595-error-arg-inversion)
      1. [`Error arg unknown`](#8596-error-arg-unknown)
      1. [`Error long option match`](#8597-error-long-option-match)
      1. [`Error long option negation`](#8598-error-long-option-negation)
      1. [`Error long option unknown`](#8599-error-long-option-unknown)
      1. [`Error short option merge`](#85100-error-short-option-merge)
      1. [`Error short option unknown`](#85101-error-short-option-unknown)
      1. [`Error pos arg count 1`](#85102-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#85103-error-pos-arg-count-2)
      1. [`Error arg no flag`](#85104-error-arg-no-flag)
      1. [`Error mandatory arg`](#85105-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#85106-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#85107-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#85108-error-wrong-arg-number-3)
      1. [`Error arg choice`](#85109-error-arg-choice)
      1. [`Error arg bool`](#85110-error-arg-bool)
      1. [`Error arg char`](#85111-error-arg-char)
      1. [`Error arg float`](#85112-error-arg-float)
      1. [`Error arg int`](#85113-error-arg-int)
      1. [`Error arg uint`](#85114-error-arg-uint)
      1. [`Error YAML`](#85115-error-yaml)
      1. [`Error include directive`](#85116-error-include-directive)
      1. [`Warning wrong arg number 1`](#85117-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#85118-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#85119-warning-wrong-arg-number-3)
      1. [`Warning deprecation`](#85120-warning-deprecation)
      1. [`Warning no identifier`](#85121-warning-no-identifier)
      1. [`Warning no translation`](#85122-warning-no-translation)
<!-- </toc> -->
<!-- </section> -->
...
- `arg_group`: the argument group for grouping of keyword arguments in the help text (like `"Optional options"` for `var_4`, default: [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group))
...
For this reason, the Argparser also supports configuration by a config file (see the example [`options.cfg`](../resources/options.cfg)), given by the [`ARGPARSER_CONFIG_FILE`](#8417-argparser_config_file) environment variable, or by command-line options.
...
The help message details all short and long option names, their optionality (*i.e.*, whether there are default values), and their choice values, using the same syntax as in the usage message (square brackets for optional arguments, curly braces for choice values). Additionally, the help text and notes from the arguments definition are given. The arguments are separated by their groups, thus structuring the help message. First, the group for the positional arguments is given (indicated by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group)), then follow the keyword argument groups in alphabetical order. Finally, the default `--help`, `--usage`, and `--version` arguments (the latter for the [version message](#48-version-messages)) are given as separate, yet unnamed group.

The help message's structure aims at reproducing the commonly found structure in command-line programs. By setting [`ARGPARSER_MAX_COL_WIDTH_1`](#8431-argparser_max_col_width_1), [`ARGPARSER_MAX_COL_WIDTH_2`](#8432-argparser_max_col_width_2), or [`ARGPARSER_MAX_COL_WIDTH_3`](#8433-argparser_max_col_width_3) (as done in `try_argparser.sh`), the column widths may be adapted to your needs, recommendably totalling 77 characters (thus 79 characters including the separating spaces). Note that columns are automatically shrunk, when their content is narrower, but they're not expanded, when their content is wider. This is to guarantee that the help message, when *e.g.* sent as logging output, nicely fits in the space you have.

Alternatively, you may want to set [`ARGPARSER_MAX_WIDTH`](#8434-argparser_max_width). By this, the help message will have a defined width, independent of shrunk columns. This is achieved by expanding the third column (with the help text) to the remaining width. For this to work, [`ARGPARSER_MAX_COL_WIDTH_3`](#8433-argparser_max_col_width_3) must be set to `0`.
...
For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8452-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8451-argparser_usage_message_option_type):
...
Additionally, we need a separate file, which we'll call [`help_message.txt`](../resources/help_message.txt) and have passed as value to [`ARGPARSER_HELP_FILE`](#8425-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
The argument groups serve to group some arguments in the help message. One group shall comprise all positional arguments (if any is defined) and is named by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group). Any other argument group shall only contain keyword arguments (options), and is sorted alphabetically in the help message. In the future, argument groups might be expanded to allow actual grouping of arguments upon parsing, such that options may only be given together or mutually exclusively.
...
The help text should consist of a terse summary of the argument's function, like turning a feature on or off (which may be accomplished by flags), what a file is used for (like for input or output), or how your script's output may be modified. A help text can take any form, but be wary of it being wrapped to fit the width of the third column in the help message (if [`ARGPARSER_MAX_COL_WIDTH_3`](#8433-argparser_max_col_width_3) is non-zero) or the total line length ([`ARGPARSER_MAX_WIDTH`](#8434-argparser_max_width)). Help messages are no replacement for the manual, so the help text shouldn't be overly verbose.
<!-- </section> -->

<!-- <section file="reference/colors_and_styles.md"> -->
### 8.2. Colors and styles

The Argparser employs [Select Graphic Rendition (SGR) ANSI escape sequence codes](https://en.wikipedia.org/wiki/ANSI_escape_code#Select_Graphic_Rendition_parameters "wikipedia.org &rightarrow; ANSI escape code &rightarrow; Select Graphic Rendition parameters") to set the appearance of help, usage, version, error, and warning messages. To this end, five environment variable are defined, *viz.* [`ARGPARSER_HELP_STYLE`](#8429-argparser_help_style), [`ARGPARSER_USAGE_STYLE`](#8454-argparser_usage_style), [`ARGPARSER_VERSION_STYLE`](#8461-argparser_version_style), [`ARGPARSER_ERROR_STYLE`](#8421-argparser_error_style), and [`ARGPARSER_WARNING_STYLE`](#8462-argparser_warning_style). Since the escape codes are nonprintable, not all terminals or text editors may support them. Many terminals do, while *e.g.* [`less`](https://man7.org/linux/man-pages/man1/less.1.html "man7.org &rightarrow; man pages &rightarrow; less(1)") has a dedicated flag, `--raw-control-chars`.

When [`ARGPARSER_USE_STYLES_IN_FILES`](#8457-argparser_use_styles_in_files) is set to `false`, the escape sequences are only included when `STDOUT`/`STDERR` is a terminal, keeping files plain 7-bit ASCII for simpler parsing. Note that, when your arguments definition or help file includes non-ASCII characters (as is usual for almost any language other than English varieties), the output contains these characters as well.
...
Six section names (include directives) are supported in the help files, and one (`@All`) in the usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8426-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8449-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#8425-argparser_help_file) with the following content:
...
The `@<ArgumentGroup>` directive prints the help message block for the respective `"<ArgumentGroup>"`, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#8425-argparser_help_file), denoting all arguments groups in the order preferred by you.

#### 8.3.3. `@Description` directive

The `@Description` directive prints the contents of [`ARGPARSER_HELP_DESCRIPTION`](#8423-argparser_help_description), wrapped to fit the help message's [`ARGPARSER_MAX_WIDTH`](#8434-argparser_max_width). If `ARGPARSER_HELP_DESCRIPTION` is empty (the default), nothing is printed.
...
The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#8438-argparser_script_name), defaulting to your script's name. This should be given as first line.
<!-- </section> -->
...
| [`ARGPARSER_HELP_EXIT_CODE`](#8424-argparser_help_exit_code)                       | *int*      | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#8422-argparser_help_arg_group)                       | *str*      | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#8425-argparser_help_file)                                 | *file*     | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8426-argparser_help_file_include_char)       | *char*     | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8427-argparser_help_file_keep_comments)     | *bool*     | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#8428-argparser_help_options)                           | *char*     | `"h,?"`                  |
| [`ARGPARSER_HELP_STYLE`](#8429-argparser_help_style)                               | *str*      | `"italic"`               |
| [`ARGPARSER_LANGUAGE`](#8430-argparser_language)                                   | *str*      | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#8431-argparser_max_col_width_1)                     | *uint*     | `5`[^19]                 |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#8432-argparser_max_col_width_2)                     | *uint*     | `33`[^19]                |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#8433-argparser_max_col_width_3)                     | *uint*     | `0`[^19]                 |
| [`ARGPARSER_MAX_WIDTH`](#8434-argparser_max_width)                                 | *uint*     | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group)           | *str*      | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#8436-argparser_read_args)                                 | *bool*     | `true`                   |
| [`ARGPARSER_SCRIPT_ARGS`](#8437-argparser_script_args)                             | *arr*      | *None* (unset)           |
| [`ARGPARSER_SCRIPT_NAME`](#8438-argparser_script_name)                             | *str*      | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#8439-argparser_set_args)                                   | *bool*     | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#8440-argparser_set_arrays)                               | *bool*     | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#8441-argparser_silence_errors)                       | *bool*     | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#8442-argparser_silence_warnings)                   | *bool*     | `false`                  |
| [`ARGPARSER_TRANSLATION_FILE`](#8443-argparser_translation_file)                   | *file*     | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#8444-argparser_unset_args)                               | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#8445-argparser_unset_env_vars)                       | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#8446-argparser_unset_functions)                     | *bool*     | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#8447-argparser_usage_exit_code)                     | *int*      | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#8448-argparser_usage_file)                               | *file*     | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8449-argparser_usage_file_include_char)     | *char*     | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8450-argparser_usage_file_keep_comments)   | *bool*     | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8451-argparser_usage_message_option_type) | *str*      | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8452-argparser_usage_message_orientation) | *str*      | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#8453-argparser_usage_options)                         | *char*     | `"u"`                    |
| [`ARGPARSER_USAGE_STYLE`](#8454-argparser_usage_style)                             | *str*      | `"italic"`               |
| [`ARGPARSER_USE_LONG_OPTIONS`](#8455-argparser_use_long_options)                   | *bool*     | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#8456-argparser_use_short_options)                 | *bool*     | `true`                   |
| [`ARGPARSER_USE_STYLES_IN_FILES`](#8457-argparser_use_styles_in_files)             | *bool*     | `false`                  |
| [`ARGPARSER_VERSION`](#8458-argparser_version)                                     | *str*      | `"1.0.0"`                |
| [`ARGPARSER_VERSION_EXIT_CODE`](#8459-argparser_version_exit_code)                 | *int*      | `0`                      |
| [`ARGPARSER_VERSION_OPTIONS`](#8460-argparser_version_options)                     | *char*     | `"V"`                    |
| [`ARGPARSER_VERSION_STYLE`](#8461-argparser_version_style)                         | *str*      | `"bold"`                 |
| [`ARGPARSER_WARNING_STYLE`](#8462-argparser_warning_style)                         | *str*      | `"red,bold"`             |
| [`ARGPARSER_WRITE_ARGS`](#8463-argparser_write_args)                               | *bool*     | `false`                  |
...
[^19]: Sum of values is recommended to be 77, except when [`ARGPARSER_MAX_COL_WIDTH_3`](#8433-argparser_max_col_width_3) is `0`.
<!-- </section> -->
...
- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8435-argparser_positional_arg_group).
...
- ***Message:*** `""`
- ***Description:*** The script's description, indicating its purpose in the help message, *i.e.*, the translated [`ARGPARSER_HELP_DESCRIPTION`](#8423-argparser_help_description). The value is empty by default, and hence also the translations.
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#8428-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#842-argparser_add_help) is set to `true`.

#### 8.5.13. `--usage`

- ***Message:*** `display the usage and exit`
- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#8453-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage) is set to `true`.

#### 8.5.14. `--version`

- ***Message:*** `display the version and exit`
- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#8460-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version) is set to `true`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8451-argparser_usage_message_option_type) is not set to `long` or `short`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8452-argparser_usage_message_orientation) is not set to `row` or `column`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8531-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#8456-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8531-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#8455-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the Argparser, as [`ARGPARSER_SCRIPT_NAME`](#8438-argparser_script_name).
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#8438-argparser_script_name) with the problematic definition.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_TRANSLATION_FILE`](#8443-argparser_translation_file), the Argparser found a YAML line that it doesn't recognize. This is most likely due to a YAML feature that the Argparser doesn't support to keep the parser simple.
- ***Interpolated variables:***
  - `$1`: The YAML line.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_HELP_FILE`](#8425-argparser_help_file) or [`ARGPARSER_USAGE_FILE`](#8448-argparser_usage_file), the Argparser found an include directive that is not supported.
- ***Interpolated variables:***
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8443-argparser_translation_file), the Argparser found that the translation to the [`ARGPARSER_LANGUAGE`](#8430-argparser_language) for the identifier is missing in the [`ARGPARSER_DICTIONARY`](#8419-argparser_dictionary), and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8443-argparser_translation_file).
  - `$2`: The [`ARGPARSER_LANGUAGE`](#8430-argparser_language).
