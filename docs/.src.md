...
1. [Reference](#8-reference)
   ...
   1. [Translations](#84-translations)
      1. [`Positional arguments`](#841-positional-arguments)
      1. [`Help options`](#842-help-options)
      1. [`Error`](#843-error)
      1. [`Warning`](#844-warning)
      1. [`Usage`](#845-usage)
      1. [`Arguments`](#846-arguments)
      1. [`Options`](#847-options)
      1. [`Mandatory arguments`](#848-mandatory-arguments)
      1. [`Deprecated`](#849-deprecated)
      1. [`Default`](#8410-default)
      1. [`--help`](#8411---help)
      1. [`--usage`](#8412---usage)
      1. [`--version`](#8413---version)
      1. [`false`](#8414-false)
      1. [`true`](#8415-true)
      1. [`Error env var bool`](#8416-error-env-var-bool)
      1. [`Error env var char`](#8417-error-env-var-char)
      1. [`Error env var identifier`](#8418-error-env-var-identifier)
      1. [`Error env var int`](#8419-error-env-var-int)
      1. [`Error env var uint`](#8420-error-env-var-uint)
      1. [`Error env var file 0001`](#8421-error-env-var-file-0001)
      1. [`Error env var file 0010`](#8422-error-env-var-file-0010)
      1. [`Error env var file 0011`](#8423-error-env-var-file-0011)
      1. [`Error env var file 0100`](#8424-error-env-var-file-0100)
      1. [`Error env var file 0101`](#8425-error-env-var-file-0101)
      1. [`Error env var file 0110`](#8426-error-env-var-file-0110)
      1. [`Error env var file 0111`](#8427-error-env-var-file-0111)
      1. [`Error env var file 1111`](#8428-error-env-var-file-1111)
      1. [`Error env var styles`](#8429-error-env-var-styles)
      1. [`Error env var option type`](#8430-error-env-var-option-type)
      1. [`Error env var orientation`](#8431-error-env-var-orientation)
      1. [`Error env var delimiters`](#8432-error-env-var-delimiters)
      1. [`Error env var short name empty`](#8433-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#8434-error-env-var-short-name-length)
      1. [`Error env var short name inner duplication`](#8435-error-env-var-short-name-inner-duplication)
      1. [`Error env var short name outer duplication`](#8436-error-env-var-short-name-outer-duplication)
      1. [`Error env var short options`](#8437-error-env-var-short-options)
      1. [`Error env var long options`](#8438-error-env-var-long-options)
      1. [`Error env var files`](#8439-error-env-var-files)
      1. [`Error arg array 1`](#8440-error-arg-array-1)
      1. [`Error arg array 2`](#8441-error-arg-array-2)
      1. [`Error arg array 3`](#8442-error-arg-array-3)
      1. [`Error no arg def`](#8443-error-no-arg-def)
      1. [`Error arg def id`](#8444-error-arg-def-id)
      1. [`Error arg def file id`](#8445-error-arg-def-file-id)
      1. [`Error arg def field count`](#8446-error-arg-def-field-count)
      1. [`Error arg def file field count`](#8447-error-arg-def-file-field-count)
      1. [`Error arg def choice range hyphens`](#8448-error-arg-def-choice-range-hyphens)
      1. [Error arg def choice range`](#8449-error-arg-def-choice-range)
      1. [`Error arg def short name empty`](#8450-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#8451-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#8452-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#8453-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#8454-error-arg-def-short-name-length)
      1. [`Error arg def short name inner duplication`](#8455-error-arg-def-short-name-inner-duplication)
      1. [`Error arg def short name outer duplication`](#8456-error-arg-def-short-name-outer-duplication)
      1. [`Error arg def long name empty`](#8457-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#8458-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#8459-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#8460-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#8461-error-arg-def-long-name-length)
      1. [`Error arg def long name inner duplication`](#8462-error-arg-def-long-name-inner-duplication)
      1. [`Error arg def long name outer duplication`](#8463-error-arg-def-long-name-outer-duplication)
      1. [`Error arg def pos default 1`](#8464-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#8465-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice`](#8466-error-arg-def-pos-choice)
      1. [`Error arg def pos optionals`](#8467-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#8468-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#8469-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#8470-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#8471-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#8472-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#8473-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#8474-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#8475-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#8476-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#8477-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#8478-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#8479-error-arg-def-pos-note)
      1. [`Error arg def option flag`](#8480-error-arg-def-option-flag)
      1. [`Error arg def option default 1`](#8481-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#8482-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#8483-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice`](#8484-error-arg-def-option-choice)
      1. [`Error arg def option type`](#8485-error-arg-def-option-type)
      1. [`Error arg def option bool`](#8486-error-arg-def-option-bool)
      1. [`Error arg def option char`](#8487-error-arg-def-option-char)
      1. [`Error arg def option float`](#8488-error-arg-def-option-float)
      1. [`Error arg def option int`](#8489-error-arg-def-option-int)
      1. [`Error arg def option uint`](#8490-error-arg-def-option-uint)
      1. [`Error arg def option note`](#8491-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#8492-error-arg-double-hyphen)
      1. [`Error arg double plus`](#8493-error-arg-double-plus)
      1. [`Error arg inversion`](#8494-error-arg-inversion)
      1. [`Error arg unknown`](#8495-error-arg-unknown)
      1. [`Error long option match`](#8496-error-long-option-match)
      1. [`Error long option negation`](#8497-error-long-option-negation)
      1. [`Error long option unknown`](#8498-error-long-option-unknown)
      1. [`Error short option merge`](#8499-error-short-option-merge)
      1. [`Error short option unknown`](#84100-error-short-option-unknown)
      1. [`Error pos arg count 1`](#84101-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#84102-error-pos-arg-count-2)
      1. [`Error arg no flag`](#84103-error-arg-no-flag)
      1. [`Error mandatory arg`](#84104-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#84105-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#84106-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#84107-error-wrong-arg-number-3)
      1. [`Error arg choice`](#84108-error-arg-choice)
      1. [`Error arg bool`](#84109-error-arg-bool)
      1. [`Error arg char`](#84110-error-arg-char)
      1. [`Error arg float`](#84111-error-arg-float)
      1. [`Error arg int`](#84112-error-arg-int)
      1. [`Error arg uint`](#84113-error-arg-uint)
      1. [`Error YAML`](#84114-error-yaml)
      1. [`Error include directive`](#84115-error-include-directive)
      1. [`Warning wrong arg number 1`](#84116-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#84117-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#84118-warning-wrong-arg-number-3)
      1. [`Warning deprecation`](#84119-warning-deprecation)
      1. [`Warning no identifier`](#84120-warning-no-identifier)
      1. [`Warning no translation`](#84121-warning-no-translation)
   1. [Environment variables](#85-environment-variables)
      1. [Overview](#851-overview)
      1. [`ARGPARSER_ADD_HELP`](#852-argparser_add_help)
      1. [`ARGPARSER_ADD_USAGE`](#853-argparser_add_usage)
      1. [`ARGPARSER_ADD_VERSION`](#854-argparser_add_version)
      1. [`ARGPARSER_ALLOW_FLAG_INVERSION`](#855-argparser_allow_flag_inversion)
      1. [`ARGPARSER_ALLOW_FLAG_NEGATION`](#856-argparser_allow_flag_negation)
      1. [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#857-argparser_allow_option_abbreviation)
      1. [`ARGPARSER_ALLOW_OPTION_MERGING`](#858-argparser_allow_option_merging)
      1. [`ARGPARSER_ARG_ARRAY_NAME`](#859-argparser_arg_array_name)
      1. [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file)
      1. [`ARGPARSER_ARG_DELIMITER_1`](#8511-argparser_arg_delimiter_1)
      1. [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2)
      1. [`ARGPARSER_ARGPARSER_VERSION`](#8513-argparser_argparser_version)
      1. [`ARGPARSER_ARGS`](#8514-argparser_args)
      1. [`ARGPARSER_CHECK_ARG_DEF`](#8515-argparser_check_arg_def)
      1. [`ARGPARSER_CHECK_ENV_VARS`](#8516-argparser_check_env_vars)
      1. [`ARGPARSER_CONFIG_FILE`](#8517-argparser_config_file)
      1. [`ARGPARSER_COUNT_FLAGS`](#8518-argparser_count_flags)
      1. [`ARGPARSER_DICTIONARY`](#8519-argparser_dictionary)
      1. [`ARGPARSER_ERROR_EXIT_CODE`](#8520-argparser_error_exit_code)
      1. [`ARGPARSER_ERROR_STYLE`](#8521-argparser_error_style)
      1. [`ARGPARSER_HELP_ARG_GROUP`](#8522-argparser_help_arg_group)
      1. [`ARGPARSER_HELP_EXIT_CODE`](#8523-argparser_help_exit_code)
      1. [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file)
      1. [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8525-argparser_help_file_include_char)
      1. [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8526-argparser_help_file_keep_comments)
      1. [`ARGPARSER_HELP_OPTIONS`](#8527-argparser_help_options)
      1. [`ARGPARSER_HELP_STYLE`](#8528-argparser_help_style)
      1. [`ARGPARSER_LANGUAGE`](#8529-argparser_language)
      1. [`ARGPARSER_MAX_COL_WIDTH_1`](#8530-argparser_max_col_width_1)
      1. [`ARGPARSER_MAX_COL_WIDTH_2`](#8531-argparser_max_col_width_2)
      1. [`ARGPARSER_MAX_COL_WIDTH_3`](#8532-argparser_max_col_width_3)
      1. [`ARGPARSER_MAX_WIDTH`](#8533-argparser_max_width)
      1. [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8534-argparser_positional_arg_group)
      1. [`ARGPARSER_READ_ARGS`](#8535-argparser_read_args)
      1. [`ARGPARSER_SCRIPT_ARGS`](#8536-argparser_script_args)
      1. [`ARGPARSER_SCRIPT_NAME`](#8537-argparser_script_name)
      1. [`ARGPARSER_SET_ARGS`](#8538-argparser_set_args)
      1. [`ARGPARSER_SET_ARRAYS`](#8539-argparser_set_arrays)
      1. [`ARGPARSER_SILENCE_ERRORS`](#8540-argparser_silence_errors)
      1. [`ARGPARSER_SILENCE_WARNINGS`](#8541-argparser_silence_warnings)
      1. [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#8543-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#8544-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#8545-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#8546-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#8547-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8548-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8549-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8550-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8551-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#8552-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#8553-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#8554-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#8555-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#8556-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION`](#8557-argparser_version)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#8558-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_OPTIONS`](#8559-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#8560-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#8561-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#8562-argparser_write_args)
<!-- </toc> -->
<!-- </section> -->
...
Further, long option names can be abbreviated, as long as no collision with other names arises (like when giving `--verb` in the example above). This requires [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#857-argparser_allow_option_abbreviation) to be set to `true`. In contrast, short option names may be merged with their value or other short option names (if they're flags, see below), given that [`ARGPARSER_ALLOW_OPTION_MERGING`](#858-argparser_allow_option_merging) is set to `true`. For the sake of an example without needing a novel script, we'll set the latter variable to the environment of the script execution by prefixing the assignments to the usual command line:
...
The argument-defining entries in the indexed array named by [`ARGPARSER_ARG_ARRAY_NAME`](#859-argparser_arg_array_name), defaulting to `"args"`, can be understood as some sort of key&ndash;value pair for each argument, but merged in one string (not as true keys and values in associative arrays). The key is a unique identifier for the Argparser functions, and the name under which the argument's value can be obtained from the associative array `args`. The corresponding value provides the argument's definition to the Argparser.

This Argparser-specific tabular format consists of eleven columns, each separated from each other by an [`ARGPARSER_ARG_DELIMITER_1`](#8511-argparser_arg_delimiter_1) character, defaulting to a pipe (`"|"`). Multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2) character, defaulting to a comma (`","`). The columns are defined as follows:
...
- `arg_group`: the argument group for grouping of keyword arguments in the help text (like `"Optional options"` for `var_4`, default: [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8534-argparser_positional_arg_group))
...
The Argparser accepts over 50 options for configuring the argument parsing, checking their values and the consistency of the arguments definition, creating the various message types (see below), and setting the required companion files. These options are available as [environment variables](#85-environment-variables). By this, you can set them directly in your script, and even [`export`](https://www.gnu.org/software/bash/manual/html_node/Bourne-Shell-Builtins.html#index-export "gnu.org &rightarrow; Bourne Shell Builtins &rightarrow; export") them to child processes. Thus, you can set these variables once and use them throughout your script suite.
...
No matter how many keyword arguments are defined, as long as [`ARGPARSER_ADD_HELP`](#852-argparser_add_help) and [`ARGPARSER_ADD_USAGE`](#853-argparser_add_usage) are set to `true` (the default), the Argparser interprets the flags from the [`ARGPARSER_HELP_OPTIONS`](#8527-argparser_help_options) (default: `-h` and `-?`) and `--help` as call for a verbose help message and the flags from the [`ARGPARSER_USAGE_OPTIONS`](#8552-argparser_usage_options) (default: `-u`) and `--usage` as call for a brief usage message. Then, these options are automatically added to the script's argument definition and override any same-named argument name (yielding an error message if [`ARGPARSER_CHECK_ARG_DEF`](#8515-argparser_check_arg_def) is set to `true`). This is to ensure that the novice user of your script can do exactly what we did, above: trying the most common variants to get some help over how to use a program or script by typing
...
For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8551-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8550-argparser_usage_message_option_type):
...
Additionally, we need a separate file, which we'll call `help_message.txt` and have passed as value to [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
Thereby, `<ArgumentGroup>` can be the name of any argument group given in the arguments definition, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. `@Help` prints the help, usage, and version options (depending on which of them are defined by [`ARGPARSER_ADD_HELP`](#852-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#853-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#854-argparser_add_version)), `@Remark` prints the remark that mandatory arguments to long options are mandatory for short options too, and `@Usage` prints the usage line. Finally, the shorthand `@All` means to print the usage line, the remark, all argument groups, and the help options, in this order, while `@Header` prints the usage line and the remark.

Further, lines starting with a `"#"` character in the help file aren't printed if [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8526-argparser_help_file_keep_comments) is set to `false` (the default). This allows you to comment your help file, perhaps to explain the structure&mdash;or just to write a header or footer with your name and debug email address inside.

The same as for help messages can be done for usage messages, using the [`ARGPARSER_USAGE_FILE`](#8547-argparser_usage_file), [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8548-argparser_usage_file_include_char), and [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8549-argparser_usage_file_keep_comments) environment variables. However there, only the `@All` directive is supported, yet.
<!-- </section> -->

<!-- <section file="tutorial/help_and_usage_message_localization.md"> -->
### 4.7. Help and usage message localization

It is even possible to localize your script's help and usage message. For the usage message, all you need is an [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file), a simplified YAML file giving the translation of the auto-generated parts in the messages. For each section, you give the language identifier for the language you want the message to be translated to, *i.e.*, the [`ARGPARSER_LANGUAGE`](#8529-argparser_language). For the usage message, this suffices, but in the help message, also non-auto-generated parts are included, especially each argument's help text. For them to be translated, you need a dedicated [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file) and possibly a localized [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file).
...
Besides the the [`ARGPARSER_HELP_OPTIONS`](#8527-argparser_help_options), `--help`, the [`ARGPARSER_USAGE_OPTIONS`](#8552-argparser_usage_options), and `--usage`, there is a third option intended to help the user, the [`ARGPARSER_VERSION_OPTIONS`](#8559-argparser_version_options) (default: `-V`) and `--version`. This flag compiles a brief version message for your script, showing its canonical name (the [`ARGPARSER_SCRIPT_NAME`](#8537-argparser_script_name)) and the version number (the [`ARGPARSER_VERSION`](#8557-argparser_version)). Just as for the help and usage messages, you can disable the version message (and its corresponding flags) by setting [`ARGPARSER_ADD_VERSION`](#854-argparser_add_version) to `false`. Note that the default short option name is an uppercase `V`, such that you can use the lowercase `v` (as `-v`) for your purposes, like `--verbatim` or `--verbose`. This is in line with the common behavior of command-line programs. By setting `ARGPARSER_VERSION_OPTIONS` accordingly, you can of course change it to your needs, if desired.
...
The reference details the actual definitions of all [colors and styles](#82-colors-and-styles), [include directives](#83-include-directives), and [environment variables](#85-environment-variables). While it may be advantageous to read it once in its entirety to see all features not discussed in the [tutorial](#4-tutorial), it is more designed as manual for specific questions regarding certain features.
<!-- </section> -->
...
The values in multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2) character, by default a comma (`","`). Absence of value is indicated by the empty string, resulting after trimming spaces. That is, a field consisting of only spaces means absence.
...
The argument identifier must be a valid variable identifier in Bash syntax (at least when [`ARGPARSER_SET_ARGS`](#8538-argparser_set_args) is set to `true`, else, the ID is only used as key in associative arrays). These are defined as a word beginning with an alphabetic character or an underscore, followed by an arbitrary number of alphanumeric characters or underscores. In Bash's extglob syntax, the regular expression for verification may look like `[[:alpha:]_]*([[:word:]])`, assuming C locale.

#### 8.1.2. Short option names (`short_opts`)

The short option names must comprise exactly one character, thereby, no leading hyphen may be given. Multiple short option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2) character. Bash is case-sensitive, so is the checking for option names. Thus, you would need to provide both `a` and `A` as short option names if you want both to be recognized. This distinction effectively allows doubling the number of available short option names defined as letters (`a-z` and `A-Z`).

#### 8.1.3. Long option names (`long_opts`)

The long option names must comprise more than one character, thereby, no leading hyphen may be given. Multiple long option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2) character.
...
The Python [`argparse`](https://docs.python.org/3/library/argparse.html "python.org &rightarrow; Python documentation &rightarrow; argparse module") module further defines `*` to accept any argument count, and `?` to accept exactly zero or one argument. Both features aren't yet supported by the Argparser, but the characters are reserved for future usage as such, invalidating them as values for [`ARGPARSER_ARG_DELIMITER_1`](#8511-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2).

#### 8.1.9. Argument group (`arg_group`)

The argument groups serve to group arguments in the help message. The first group shall comprise all positional arguments (if any is defined) and is named by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8534-argparser_positional_arg_group). Any other argument group shall only contain keyword arguments (options), and is sorted alphabetically in the help message. In the future, argument groups will be expanded to allow actual grouping of arguments upon parsing, such that options may only be given together or mutually exclusively.
...
Six section names (include directives) are supported in the help and usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8525-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8548-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file) with the following content:
...
The `@<ArgumentGroup>` directive prints the help text for the respective `"<ArgumentGroup>"`, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8534-argparser_positional_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file), denoting all arguments groups in the order preferred by you.
...
The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#8537-argparser_script_name), defaulting to your script's name. This should be given as first line.

#### 8.3.6. `@Help` directive

The `@Help` directive prints the help text for the `--help`, `--usage`, and `--version` flags (if added to the arguments definition by [`ARGPARSER_ADD_HELP`](#852-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#853-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#854-argparser_add_version)). Usually, you want to give this at the very end of all options.
<!-- </section> -->
...
- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8534-argparser_positional_arg_group).

#### 8.4.2. `Help options`

- ***Message:*** `Help options`
- ***Description:*** The name of the help options' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_HELP_ARG_GROUP`](#8522-argparser_help_arg_group).
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#8527-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#852-argparser_add_help) is set to `true`.

#### 8.4.12. `--usage`

- ***Message:*** `display the usage and exit`
- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#8552-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#853-argparser_add_usage) is set to `true`.

#### 8.4.13. `--version`

- ***Message:*** `display the version and exit`
- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#8559-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#854-argparser_add_version) is set to `true`.
...
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8516-argparser_check_env_vars) is set to `true`, the Argparser detected that an environment variable, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8517-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value not according to the data type `bool`. These Boolean values must be either `true` or `false`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8550-argparser_usage_message_option_type) is not set to `long` or `short`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8516-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8517-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value other than `long` and `short`. Since there are only short and long option names possible, other values are refused.
- ***Interpolated variables:***
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8551-argparser_usage_message_orientation) is not set to `row` or `column`.
...
- ***Description:*** The error that the environment variables [`ARGPARSER_ARG_DELIMITER_1`](#8511-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2) have an identical value.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8516-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variables `ARGPARSER_ARG_DELIMITER_1` and `ARGPARSER_ARG_DELIMITER_2`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8517-argparser_config_file), on the Argparser invokation command line, or as an environment variable, have the same value. This renders parsing of the arguments definition impossible, as multi-value fields cannot be told apart from column delimiters.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8430-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#8555-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8430-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#8554-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the Argparser, as [`ARGPARSER_SCRIPT_NAME`](#8537-argparser_script_name).
...
- ***Description:*** The error that [`ARGPARSER_ARG_ARRAY_NAME`](#859-argparser_arg_array_name) refers to a variable that's not defined.
...
- ***Reasons for error:*** When reading the arguments definition, the Argparser found a definition line giving only an argument name, but no definition corresponding to this argument in the accompanying [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file).
- ***Interpolated variables:***
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#8537-argparser_script_name) with the problematic definition.

#### 8.4.45. `Error arg def file id`

- ***Message:*** `Error: In the arguments definition file "$1", the column "id" is missing.`
- ***Description:*** The error that the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file) lacks a column, instead giving an unused one.
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file) with the problematic definition.
...
- ***Description:*** The error that in the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file), the lines have differing field counts.
...
- ***Reasons for error:*** When parsing the command line, the Argparser found an option that starts with a plus sign, meaning the intention to invert the flag, but [`ARGPARSER_ALLOW_FLAG_INVERSION`](#855-argparser_allow_flag_inversion) is set to `false`. This removes the ability to use the `+` prefix.
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#857-argparser_allow_option_abbreviation) is set to `true`, the Argparser found a long option being abbreviated, but matching more than one defined long option in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_FLAG_NEGATION`](#856-argparser_allow_flag_negation) is set to `true`, the Argparser found a long option starting with `--no-`, but the remaining (affirmative) version has not been defined in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_OPTION_MERGING`](#858-argparser_allow_option_merging) is set to `true`, the Argparser found a short option, merged with others, that has not been defined in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file), the Argparser found a YAML line that it doesn't recognize. This is most likely due to a YAML feature that the Argparser doesn't support to keep the parser simple.
- ***Interpolated variables:***
  - `$1`: The YAML line.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file) or [`ARGPARSER_USAGE_FILE`](#8547-argparser_usage_file), the Argparser found an include directive that is not supported.
- ***Interpolated variables:***
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file), the Argparser found that the identifier is missing in the [`ARGPARSER_DICTIONARY`](#8519-argparser_dictionary), and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file).
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file), the Argparser found that the translation to the [`ARGPARSER_LANGUAGE`](#8529-argparser_language) for the identifier is missing in the [`ARGPARSER_DICTIONARY`](#8519-argparser_dictionary), and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file).
  - `$2`: The [`ARGPARSER_LANGUAGE_`](#8529-argparser_language).
...
| ---------------------------------------------------------------------------------- | ---------- | ------------------------ |
| [`ARGPARSER_ADD_HELP`](#852-argparser_add_help)                                    | *bool*     | `true`                   |
| [`ARGPARSER_ADD_USAGE`](#853-argparser_add_usage)                                  | *bool*     | `true`                   |
| [`ARGPARSER_ADD_VERSION`](#854-argparser_add_version)                              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_INVERSION`](#855-argparser_allow_flag_inversion)            | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_NEGATION`](#856-argparser_allow_flag_negation)              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#857-argparser_allow_option_abbreviation)  | *bool*     | `false`                  |
| [`ARGPARSER_ALLOW_OPTION_MERGING`](#858-argparser_allow_option_merging)            | *bool*     | `false`                  |
| [`ARGPARSER_ARG_ARRAY_NAME`](#859-argparser_arg_array_name)                        | *str*[^17] | `"args"`                 |
| [`ARGPARSER_ARG_DEF_FILE`](#8510-argparser_arg_def_file)                           | *file*     | `""`                     |
| [`ARGPARSER_ARG_DELIMITER_1`](#8511-argparser_arg_delimiter_1)                     | *char*     | `"\|"`[^18]              |
| [`ARGPARSER_ARG_DELIMITER_2`](#8512-argparser_arg_delimiter_2)                     | *char*     | `","`[^18]               |
| [`ARGPARSER_ARGPARSER_VERSION`](#8513-argparser_argparser_version)                 | *str*      | *None* (unset)           |
| [`ARGPARSER_ARGS`](#8514-argparser_args)                                           | *arr*      | *None* (unset)           |
| [`ARGPARSER_CHECK_ARG_DEF`](#8515-argparser_check_arg_def)                         | *bool*     | `false`                  |
| [`ARGPARSER_CHECK_ENV_VARS`](#8516-argparser_check_env_vars)                       | *bool*     | `false`                  |
| [`ARGPARSER_CONFIG_FILE`](#8517-argparser_config_file)                             | *file*     | `""`                     |
| [`ARGPARSER_COUNT_FLAGS`](#8518-argparser_count_flags)                             | *bool*     | `false`                  |
| [`ARGPARSER_DICTIONARY`](#8519-argparser_dictionary)                               | *dict*     | *None* (unset)           |
| [`ARGPARSER_ERROR_EXIT_CODE`](#8520-argparser_error_exit_code)                     | *int*      | `1`                      |
| [`ARGPARSER_ERROR_STYLE`](#8521-argparser_error_style)                             | *str*      | `"red,bold,reverse"`     |
| [`ARGPARSER_HELP_EXIT_CODE`](#8523-argparser_help_exit_code)                       | *int*      | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#8522-argparser_help_arg_group)                       | *str*      | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#8524-argparser_help_file)                                 | *file*     | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8525-argparser_help_file_include_char)       | *char*     | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8526-argparser_help_file_keep_comments)     | *bool*     | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#8527-argparser_help_options)                           | *char*     | `"h,?"`                  |
| [`ARGPARSER_HELP_STYLE`](#8528-argparser_help_style)                               | *str*      | `"italic"`               |
| [`ARGPARSER_LANGUAGE`](#8529-argparser_language)                                   | *str*      | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#8530-argparser_max_col_width_1)                     | *uint*     | `5`[^19]                 |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#8531-argparser_max_col_width_2)                     | *uint*     | `33`[^19]                |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#8532-argparser_max_col_width_3)                     | *uint*     | `0`[^19]                 |
| [`ARGPARSER_MAX_WIDTH`](#8533-argparser_max_width)                                 | *uint*     | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8534-argparser_positional_arg_group)           | *str*      | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#8535-argparser_read_args)                                 | *bool*     | `true`                   |
| [`ARGPARSER_SCRIPT_ARGS`](#8536-argparser_script_args)                             | *arr*      | *None* (unset)           |
| [`ARGPARSER_SCRIPT_NAME`](#8537-argparser_script_name)                             | *str*      | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#8538-argparser_set_args)                                   | *bool*     | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#8539-argparser_set_arrays)                               | *bool*     | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#8540-argparser_silence_errors)                       | *bool*     | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#8541-argparser_silence_warnings)                   | *bool*     | `false`                  |
| [`ARGPARSER_TRANSLATION_FILE`](#8542-argparser_translation_file)                   | *file*     | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#8543-argparser_unset_args)                               | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#8544-argparser_unset_env_vars)                       | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#8545-argparser_unset_functions)                     | *bool*     | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#8546-argparser_usage_exit_code)                     | *int*      | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#8547-argparser_usage_file)                               | *file*     | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8548-argparser_usage_file_include_char)     | *char*     | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8549-argparser_usage_file_keep_comments)   | *bool*     | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8550-argparser_usage_message_option_type) | *str*      | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8551-argparser_usage_message_orientation) | *str*      | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#8552-argparser_usage_options)                         | *char*     | `"u"`                    |
| [`ARGPARSER_USAGE_STYLE`](#8553-argparser_usage_style)                             | *str*      | `"italic"`               |
| [`ARGPARSER_USE_LONG_OPTIONS`](#8554-argparser_use_long_options)                   | *bool*     | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#8555-argparser_use_short_options)                 | *bool*     | `true`                   |
| [`ARGPARSER_USE_STYLES_IN_FILES`](#8556-argparser_use_styles_in_files)             | *bool*     | `false`                  |
| [`ARGPARSER_VERSION`](#8557-argparser_version)                                     | *str*      | `"1.0.0"`                |
| [`ARGPARSER_VERSION_EXIT_CODE`](#8558-argparser_version_exit_code)                 | *int*      | `0`                      |
| [`ARGPARSER_VERSION_OPTIONS`](#8559-argparser_version_options)                     | *char*     | `"V"`                    |
| [`ARGPARSER_VERSION_STYLE`](#8560-argparser_version_style)                         | *str*      | `"bold"`                 |
| [`ARGPARSER_WARNING_STYLE`](#8561-argparser_warning_style)                         | *str*      | `"red,bold"`             |
| [`ARGPARSER_WRITE_ARGS`](#8562-argparser_write_args)                               | *bool*     | `false`                  |
