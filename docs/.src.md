...
1. [Roadmap](#7-roadmap)
   ...
   1. [Future enhancements](#72-future-enhancements)
      ...
      1. [Optional help message headings](#722-optional-help-message-headings)
      1. [Intermixed positional and keyword arguments](#723-intermixed-positional-and-keyword-arguments)
      1. [Single-hyphen long options](#724-single-hyphen-long-options)
      1. [Usage message include directives](#725-usage-message-include-directives)
      1. [License note](#726-license-note)
      1. [Programmable argument completion](#727-programmable-argument-completion)
      1. [POSIX compliance](#728-posix-compliance)
      1. [Alternative option prefixes (`+`/`/`)](#729-alternative-option-prefixes-)
