...
1. [Roadmap](#6-roadmap)
   1. [Future enhancements](#61-future-enhancements)
      ...
      1. [Value ranges](#615-value-ranges)
...
1. [Reference](#8-reference)
   ...
   1. [Translations](#84-translations)
      ...
      1. [`Error arg def short name empty`](#8448-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#8449-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#8450-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#8451-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#8452-error-arg-def-short-name-length)
      1. [`Error arg def short name inner duplication`](#8453-error-arg-def-short-name-inner-duplication)
      1. [`Error arg def short name outer duplication`](#8454-error-arg-def-short-name-outer-duplication)
      1. [`Error arg def long name empty`](#8455-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#8456-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#8457-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#8458-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#8459-error-arg-def-long-name-length)
      1. [`Error arg def long name inner duplication`](#8460-error-arg-def-long-name-inner-duplication)
      1. [`Error arg def long name outer duplication`](#8461-error-arg-def-long-name-outer-duplication)
      1. [`Error arg def pos default 1`](#8462-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#8463-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice`](#8464-error-arg-def-pos-choice)
      1. [`Error arg def pos optionals`](#8465-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#8466-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#8467-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#8468-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#8469-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#8470-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#8471-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#8472-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#8473-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#8474-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#8475-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#8476-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#8477-error-arg-def-pos-note)
      1. [`Error arg def option flag`](#8478-error-arg-def-option-flag)
      1. [`Error arg def option default 1`](#8479-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#8480-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#8481-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice`](#8482-error-arg-def-option-choice)
      1. [`Error arg def option type`](#8483-error-arg-def-option-type)
      1. [`Error arg def option bool`](#8484-error-arg-def-option-bool)
      1. [`Error arg def option char`](#8485-error-arg-def-option-char)
      1. [`Error arg def option float`](#8486-error-arg-def-option-float)
      1. [`Error arg def option int`](#8487-error-arg-def-option-int)
      1. [`Error arg def option uint`](#8488-error-arg-def-option-uint)
      1. [`Error arg def option note`](#8489-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#8490-error-arg-double-hyphen)
      1. [`Error arg double plus`](#8491-error-arg-double-plus)
      1. [`Error arg inversion`](#8492-error-arg-inversion)
      1. [`Error arg unknown`](#8493-error-arg-unknown)
      1. [`Error long option match`](#8494-error-long-option-match)
      1. [`Error long option negation`](#8495-error-long-option-negation)
      1. [`Error long option unknown`](#8496-error-long-option-unknown)
      1. [`Error short option merge`](#8497-error-short-option-merge)
      1. [`Error short option unknown`](#8498-error-short-option-unknown)
      1. [`Error pos arg count 1`](#8499-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#84100-error-pos-arg-count-2)
      1. [`Error arg no flag`](#84101-error-arg-no-flag)
      1. [`Error mandatory arg`](#84102-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#84103-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#84104-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#84105-error-wrong-arg-number-3)
      1. [`Error arg choice`](#84106-error-arg-choice)
      1. [`Error arg bool`](#84107-error-arg-bool)
      1. [`Error arg def char`](#84108-error-arg-def-char)
      1. [`Error arg float`](#84109-error-arg-float)
      1. [`Error arg int`](#84110-error-arg-int)
      1. [`Error arg uint`](#84111-error-arg-uint)
      1. [`Error YAML`](#84112-error-yaml)
      1. [`Error include directive`](#84113-error-include-directive)
      1. [`Warning wrong arg number 1`](#84114-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#84115-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#84116-warning-wrong-arg-number-3)
      1. [`Warning deprecation`](#84117-warning-deprecation)
      1. [`Warning no identifier`](#84118-warning-no-identifier)
      1. [`Warning no translation`](#84119-warning-no-translation)
