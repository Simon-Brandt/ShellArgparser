...
1. [Reference](#9-reference)
   ...
   1. [Translations](#95-translations)
      ...
      1. [`Warning style file message key`](#95131-warning-style-file-message-key)
      1. [`Warning deprecation`](#95132-warning-deprecation)
      1. [`Warning wrong arg number 1`](#95133-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#95134-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#95135-warning-wrong-arg-number-3)
      1. [`Warning wrong arg number 4`](#95136-warning-wrong-arg-number-4)
<!-- </toc> -->
<!-- </section> -->
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file) to the [`ARGPARSER_LANGUAGE`](#9431-argparser_language), the Argparser found that the translation identifier is missing in the dictionary, and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file).
  - `$2`: The missing identifier, including the [`ARGPARSER_LANGUAGE`](#9431-argparser_language).
