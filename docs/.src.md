...
1. [Tutorial](#4-tutorial)
   1. [Argument passing](#41-argument-passing)
      1. [Positional and keyword arguments](#411-positional-and-keyword-arguments)
      1. [Special options](#412-special-options)
      1. [Option name aliases and modifications](#413-option-name-aliases-and-modifications)
      1. [Argument value delimiters and aggregation](#414-argument-value-delimiters-and-aggregation)
      1. [Flags](#415-flags)
   1. [Argparser invokation](#42-argparser-invokation)
      1. [Argparser sourcing](#421-argparser-sourcing)
      1. [Arguments definition and retrieval](#422-arguments-definition-and-retrieval)
   1. [Argparser configuration](#43-argparser-configuration)
      1. [Configuration file](#431-configuration-file)
      1. [Command-line options](#432-command-line-options)
      1. [Option inheritance](#433-option-inheritance)
   1. [Arguments definition files](#44-arguments-definition-files)
   1. [Help and usage messages](#45-help-and-usage-messages)
      1. [Help messages](#451-help-messages)
      1. [Usage messages](#452-usage-messages)
   ...
   1. [Standalone usage](#411-standalone-usage)
      1. [Argparser introspection](#4111-argparser-introspection)
      1. [Invokation from other shells](#4112-invokation-from-other-shells)
...
1. [Roadmap](#6-roadmap)
   1. [Future enhancements](#61-future-enhancements)
      1. [Argument relations](#611-argument-relations)
      1. [Any argument number](#612-any-argument-number)
      1. [Debug mode](#613-debug-mode)
      1. [Intermixed positional and keyword arguments](#614-intermixed-positional-and-keyword-arguments)
      1. [Single-hyphen long options](#615-single-hyphen-long-options)
      1. [Usage message include directives](#616-usage-message-include-directives)
      1. [License note](#617-license-note)
      1. [POSIX compliance](#618-posix-compliance)
      1. [Alternative option prefixes (`+`/`/`)](#619-alternative-option-prefixes-)
...
1. [Reference](#8-reference)
   ...
   1. [Environment variables](#84-environment-variables)
      ...
      1. [`ARGPARSER_ARGS`](#8413-argparser_args)
      1. [`ARGPARSER_CHECK_ARG_DEF`](#8414-argparser_check_arg_def)
      1. [`ARGPARSER_CHECK_ENV_VARS`](#8415-argparser_check_env_vars)
      1. [`ARGPARSER_CONFIG_FILE`](#8416-argparser_config_file)
      1. [`ARGPARSER_COUNT_FLAGS`](#8417-argparser_count_flags)
      1. [`ARGPARSER_ERROR_EXIT_CODE`](#8418-argparser_error_exit_code)
      1. [`ARGPARSER_ERROR_STYLE`](#8419-argparser_error_style)
      1. [`ARGPARSER_HELP_ARG_GROUP`](#8420-argparser_help_arg_group)
      1. [`ARGPARSER_HELP_DESCRIPTION`](#8421-argparser_help_description)
      1. [`ARGPARSER_HELP_EXIT_CODE`](#8422-argparser_help_exit_code)
      1. [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file)
      1. [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8424-argparser_help_file_include_char)
      1. [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8425-argparser_help_file_keep_comments)
      1. [`ARGPARSER_HELP_OPTIONS`](#8426-argparser_help_options)
      1. [`ARGPARSER_HELP_STYLE`](#8427-argparser_help_style)
      1. [`ARGPARSER_LANGUAGE`](#8428-argparser_language)
      1. [`ARGPARSER_MAX_COL_WIDTH_1`](#8429-argparser_max_col_width_1)
      1. [`ARGPARSER_MAX_COL_WIDTH_2`](#8430-argparser_max_col_width_2)
      1. [`ARGPARSER_MAX_COL_WIDTH_3`](#8431-argparser_max_col_width_3)
      1. [`ARGPARSER_MAX_WIDTH`](#8432-argparser_max_width)
      1. [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group)
      1. [`ARGPARSER_READ_ARGS`](#8434-argparser_read_args)
      1. [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name)
      1. [`ARGPARSER_SET_ARGS`](#8436-argparser_set_args)
      1. [`ARGPARSER_SET_ARRAYS`](#8437-argparser_set_arrays)
      1. [`ARGPARSER_SILENCE_ERRORS`](#8438-argparser_silence_errors)
      1. [`ARGPARSER_SILENCE_WARNINGS`](#8439-argparser_silence_warnings)
      1. [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#8441-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#8442-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#8443-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#8444-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#8445-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8446-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8447-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8448-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8449-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#8450-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#8451-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#8452-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#8453-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#8454-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION`](#8455-argparser_version)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#8456-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_OPTIONS`](#8457-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#8458-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#8459-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#8460-argparser_write_args)
   1. [Translations](#85-translations)
      1. [`Positional arguments`](#851-positional-arguments)
      1. [`Help options`](#852-help-options)
      1. [`Help description`](#853-help-description)
      1. [`Error`](#854-error)
      1. [`Warning`](#855-warning)
      1. [`Usage`](#856-usage)
      1. [`Arguments`](#857-arguments)
      1. [`Options`](#858-options)
      1. [`Mandatory arguments`](#859-mandatory-arguments)
      1. [`Deprecated`](#8510-deprecated)
      1. [`Default`](#8511-default)
      1. [`--help`](#8512---help)
      1. [`--usage`](#8513---usage)
      1. [`--version`](#8514---version)
      1. [`false`](#8515-false)
      1. [`true`](#8516-true)
      1. [`Error env var bool`](#8517-error-env-var-bool)
      1. [`Error env var char`](#8518-error-env-var-char)
      1. [`Error env var identifier`](#8519-error-env-var-identifier)
      1. [`Error env var int`](#8520-error-env-var-int)
      1. [`Error env var uint`](#8521-error-env-var-uint)
      1. [`Error env var file 0001`](#8522-error-env-var-file-0001)
      1. [`Error env var file 0010`](#8523-error-env-var-file-0010)
      1. [`Error env var file 0011`](#8524-error-env-var-file-0011)
      1. [`Error env var file 0100`](#8525-error-env-var-file-0100)
      1. [`Error env var file 0101`](#8526-error-env-var-file-0101)
      1. [`Error env var file 0110`](#8527-error-env-var-file-0110)
      1. [`Error env var file 0111`](#8528-error-env-var-file-0111)
      1. [`Error env var file 1111`](#8529-error-env-var-file-1111)
      1. [`Error env var delimiters reserved`](#8530-error-env-var-delimiters-reserved)
      1. [`Error env var styles`](#8531-error-env-var-styles)
      1. [`Error env var option type`](#8532-error-env-var-option-type)
      1. [`Error env var orientation`](#8533-error-env-var-orientation)
      1. [`Error env var delimiters identical`](#8534-error-env-var-delimiters-identical)
      1. [`Error env var short name empty`](#8535-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#8536-error-env-var-short-name-length)
      1. [`Error env var short name duplication 1`](#8537-error-env-var-short-name-duplication-1)
      1. [`Error env var short name duplication 2`](#8538-error-env-var-short-name-duplication-2)
      1. [`Error env var short options`](#8539-error-env-var-short-options)
      1. [`Error env var long options`](#8540-error-env-var-long-options)
      1. [`Error env var files`](#8541-error-env-var-files)
      1. [`Error arg array 1`](#8542-error-arg-array-1)
      1. [`Error arg array 2`](#8543-error-arg-array-2)
      1. [`Error arg array 3`](#8544-error-arg-array-3)
      1. [`Error no arg def`](#8545-error-no-arg-def)
      1. [`Error arg def id`](#8546-error-arg-def-id)
      1. [`Error arg def file id`](#8547-error-arg-def-file-id)
      1. [`Error arg def field count`](#8548-error-arg-def-field-count)
      1. [`Error arg def file field count`](#8549-error-arg-def-file-field-count)
      1. [`Error arg def choice range hyphens`](#8550-error-arg-def-choice-range-hyphens)
      1. [`Error arg def choice range`](#8551-error-arg-def-choice-range)
      1. [`Error arg def short name empty`](#8552-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#8553-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#8554-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#8555-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#8556-error-arg-def-short-name-length)
      1. [`Error arg def short name duplication 1`](#8557-error-arg-def-short-name-duplication-1)
      1. [`Error arg def short name duplication 2`](#8558-error-arg-def-short-name-duplication-2)
      1. [`Error arg def long name empty`](#8559-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#8560-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#8561-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#8562-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#8563-error-arg-def-long-name-length)
      1. [`Error arg def long name duplication 1`](#8564-error-arg-def-long-name-duplication-1)
      1. [`Error arg def long name duplication 2`](#8565-error-arg-def-long-name-duplication-2)
      1. [`Error arg def pos default 1`](#8566-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#8567-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice`](#8568-error-arg-def-pos-choice)
      1. [`Error arg def pos optionals`](#8569-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#8570-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#8571-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#8572-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#8573-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#8574-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#8575-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#8576-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#8577-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#8578-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#8579-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#8580-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#8581-error-arg-def-pos-note)
      1. [`Error arg def option flag`](#8582-error-arg-def-option-flag)
      1. [`Error arg def option default 1`](#8583-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#8584-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#8585-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice`](#8586-error-arg-def-option-choice)
      1. [`Error arg def option type`](#8587-error-arg-def-option-type)
      1. [`Error arg def option bool`](#8588-error-arg-def-option-bool)
      1. [`Error arg def option char`](#8589-error-arg-def-option-char)
      1. [`Error arg def option float`](#8590-error-arg-def-option-float)
      1. [`Error arg def option int`](#8591-error-arg-def-option-int)
      1. [`Error arg def option uint`](#8592-error-arg-def-option-uint)
      1. [`Error arg def option note`](#8593-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#8594-error-arg-double-hyphen)
      1. [`Error arg double plus`](#8595-error-arg-double-plus)
      1. [`Error arg inversion`](#8596-error-arg-inversion)
      1. [`Error arg unknown`](#8597-error-arg-unknown)
      1. [`Error long option match`](#8598-error-long-option-match)
      1. [`Error long option negation`](#8599-error-long-option-negation)
      1. [`Error long option unknown`](#85100-error-long-option-unknown)
      1. [`Error short option merge`](#85101-error-short-option-merge)
      1. [`Error short option unknown`](#85102-error-short-option-unknown)
      1. [`Error pos arg count 1`](#85103-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#85104-error-pos-arg-count-2)
      1. [`Error arg no flag`](#85105-error-arg-no-flag)
      1. [`Error mandatory arg`](#85106-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#85107-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#85108-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#85109-error-wrong-arg-number-3)
      1. [`Error arg choice`](#85110-error-arg-choice)
      1. [`Error arg bool`](#85111-error-arg-bool)
      1. [`Error arg char`](#85112-error-arg-char)
      1. [`Error arg float`](#85113-error-arg-float)
      1. [`Error arg int`](#85114-error-arg-int)
      1. [`Error arg uint`](#85115-error-arg-uint)
      1. [`Error YAML`](#85116-error-yaml)
      1. [`Error include directive`](#85117-error-include-directive)
      1. [`Warning wrong arg number 1`](#85118-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#85119-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#85120-warning-wrong-arg-number-3)
      1. [`Warning deprecation`](#85121-warning-deprecation)
      1. [`Warning no identifier`](#85122-warning-no-identifier)
      1. [`Warning no translation`](#85123-warning-no-translation)
<!-- </toc> -->
<!-- </section> -->
...
The first section sets Argparser-specific [environment variables](#84-environment-variables) to optimize the visual output, which we'll investigate later. Then, the arguments are defined, and finally, the Argparser is called.
...
Shells other than Bash require a slightly different approach, the [standalone usage](#4112-invokation-from-other-shells) in a pipe, but most things still hold for this case. As a result of the Argparser's configurability (see below), it is necessary to give cour script's command line after a double hyphen, *i.e.*, using `-- "$@"`.
...
- `arg_group`: the argument group for grouping of keyword arguments in the help text (like `"Optional options"` for `var_4`, default: [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group))
...
For this reason, the Argparser also supports configuration by a config file (see the example [`options.cfg`](../resources/options.cfg)), given by the [`ARGPARSER_CONFIG_FILE`](#8416-argparser_config_file) environment variable, or by command-line options.
...
The help message details all short and long option names, their optionality (*i.e.*, whether there are default values), and their choice values, using the same syntax as in the usage message (square brackets for optional arguments, curly braces for choice values). Additionally, the help text and notes from the arguments definition are given. The arguments are separated by their groups, thus structuring the help message. First, the group for the positional arguments is given (indicated by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group)), then follow the keyword argument groups in alphabetical order. Finally, the default `--help`, `--usage`, and `--version` arguments (the latter for the [version message](#48-version-messages)) are given as separate, yet unnamed group.

The help message's structure aims at reproducing the commonly found structure in command-line programs. By setting [`ARGPARSER_MAX_COL_WIDTH_1`](#8429-argparser_max_col_width_1), [`ARGPARSER_MAX_COL_WIDTH_2`](#8430-argparser_max_col_width_2), or [`ARGPARSER_MAX_COL_WIDTH_3`](#8431-argparser_max_col_width_3) (as done in `try_argparser.sh`), the column widths may be adapted to your needs, recommendably totalling 77 characters (thus 79 characters including the separating spaces). Note that columns are automatically shrunk, when their content is narrower, but they're not expanded, when their content is wider. This is to guarantee that the help message, when *e.g.* sent as logging output, nicely fits in the space you have.

Alternatively, you may want to set [`ARGPARSER_MAX_WIDTH`](#8432-argparser_max_width). By this, the help message will have a defined width, independent of shrunk columns. This is achieved by expanding the third column (with the help text) to the remaining width. For this to work, [`ARGPARSER_MAX_COL_WIDTH_3`](#8431-argparser_max_col_width_3) must be set to `0`.
...
The usage message clearly summarizes the arguments, including name aliases (always taking all short options, or, if absent, all long options, or *vice versa*, see below), indicates whether they're optional or mandatory (optionals use square brackets), and specifies the choice values (in curly braces) and, partially, the argument number (an ellipsis, *i.e.*, `"..."`, for an infinite number). Short options precede long options, options with default precede those without, likewise for positionals, and keyword arguments precede positional arguments. All of these groups are sorted alphabetically by the first option name as key. The help, usage, and [version](#48-version-messages) options precede all groups.

For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8449-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8448-argparser_usage_message_option_type):
...
Additionally, we need a separate file, which we'll call [`help_message.txt`](../resources/help_message.txt) and have passed as value to [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
When you compare the structure of this help message with both the previous version and the help file, you see that there, you can include the sections from the auto-generated help message by prefixing their names with an [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8424-argparser_help_file_include_char) character, defaulting to an `"@"`. Generally speaking, an include directive, as the commands are referred to, like `@Section`, includes the section named `"Section"`.

The following section names (include directives) are supported, explained in greater detail in the [reference](#83-include-directives) below:

- [`@All`](#831-all-directive)
- [`@<ArgumentGroup>`](#832-argumentgroup-directive)
- [`@Description`](#833-description-directive)
- [`@Header`](#834-header-directive)
- [`@Help`](#835-help-directive)
- [`@Remark`](#836-remark-directive)
- [`@Usage`](#837-usage-directive)

Thereby, `<ArgumentGroup>` can be the name of any argument group given in the arguments definition, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. `@Description` prints the [`ARGPARSER_HELP_DESCRIPTION`](#8421-argparser_help_description), `@Help` prints the help, usage, and version options (depending on which of them are defined by [`ARGPARSER_ADD_HELP`](#842-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version)), `@Remark` prints the remark that mandatory arguments to long options are mandatory for short options too, and `@Usage` prints the usage line. Finally, the shorthand `@All` means to print the usage line, the description, the remark, all argument groups, and the help options, in this order, while `@Header` prints the usage line, the description, and the remark.

Further, lines starting with a `"#"` character in the help file aren't printed if [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8425-argparser_help_file_keep_comments) is set to `false` (the default). This allows you to comment your help file, perhaps to explain the structure&mdash;or just to write a header or footer with your name and debug email address inside.

The same as for help messages can be done for usage messages, using the [`ARGPARSER_USAGE_FILE`](#8445-argparser_usage_file), [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8446-argparser_usage_file_include_char), and [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8447-argparser_usage_file_keep_comments) environment variables. However there, only the `@All` directive is supported, yet.
<!-- </section> -->

<!-- <section file="tutorial/help_and_usage_message_localization.md"> -->
### 4.7. Help and usage message localization

It is even possible to localize your script's help and usage message. For the usage message, all you need is an [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file), a simplified [YAML](https://en.wikipedia.org/wiki/YAML "wikipedia.org &rightarrow; YAML") file giving the translation of the auto-generated parts in the messages. For each section, you give the language identifier for the language you want the message to be translated to, *i.e.*, the [`ARGPARSER_LANGUAGE`](#8428-argparser_language). For the usage message, this suffices, but in the help message, also non-auto-generated parts are included, especially each argument's help text. For them to be translated, you need a dedicated [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file) and possibly a localized [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file).
...
The Argparser outputs about a hundred different error and warning messages to give both you and your script's user as detailled feedback as possible about what went wrong with the argument parsing, value checking, *etc.* Each message starts with your script's canonical name (the [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name)), followed by either `"Error:"` or `"Warning:"` and the respective message. Using the same simplified [YAML](https://en.wikipedia.org/wiki/YAML "wikipedia.org &rightarrow; YAML") file as for the help and usage messages (the [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file)), also the error and warning messages can be fully localized.
...
- ***Description:*** Currently, for an [`ARGPARSER_USAGE_FILE`](#8445-argparser_usage_file), only the [`@All`](#831-all-directive) [include directive](#83-include-directives) is supported. Should there be demand to provide more fine-grained control, more directives could be added.
- ***Implementation likelihood:*** Medium.

#### 6.1.7. License note

- ***Description:*** Usually, a [version message](#48-version-messages) indicates the script's license, or at least gives a note about the lack of warranty for functionality of free software. The Argparser instead only gives the script's name (the [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name)) and the version number (the [`ARGPARSER_VERSION`](#8455-argparser_version)). Adding the dummy text for the warranty is easy, but would mean that any script employing the Argparser would indentify itself as free software. This would also hold for the (highly discouraged) proprietary software that may use the Argparser, thus misleading the users. Therefore, some environment variable may be needed to control the addition.  
...
The reference details the actual definitions of the [arguments definition](#81-arguments-definition), the [colors and styles](#82-colors-and-styles), the [include directives](#83-include-directives), the [environment variables](#84-environment-variables), and the [translations](#85-translations). While it may be advantageous to read it once in its entirety to see all features not discussed in the [tutorial](#4-tutorial), it is more designed as manual for specific questions regarding certain features.
<!-- </section> -->
...
The values in multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2) character, by default a comma (`","`). The absence of a value is indicated by the empty string, resulting after trimming spaces. That is, a field consisting of only spaces means absence.
...
The argument identifier must be a valid variable identifier in Bash syntax (at least when [`ARGPARSER_SET_ARGS`](#8436-argparser_set_args) is set to `true`, else, the ID is only used as key in associative arrays). These are defined as a word beginning with an alphabetic character or an underscore, followed by an arbitrary number of alphanumeric characters or underscores. In Bash's extglob syntax, the regular expression for verification may look like `[[:alpha:]_]*([[:word:]])`, assuming C locale.
...
The argument groups serve to group some arguments in the help message. One group shall comprise all positional arguments (if any is defined) and is named by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group). Any other argument group shall only contain keyword arguments (options), and is sorted alphabetically in the help message. In the future, argument groups might be expanded to allow actual grouping of arguments upon parsing, such that options may only be given together or mutually exclusively.
...
Six section names (include directives) are supported in the help files, and one (`@All`) in the usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8424-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8446-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file) with the following content:
...
The `@<ArgumentGroup>` directive prints the help message block for the respective `"<ArgumentGroup>"`, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file), denoting all arguments groups in the order preferred by you.

#### 8.3.3. `@Description` directive

The `@Description` directive prints the contents of [`ARGPARSER_HELP_DESCRIPTION`](#8421-argparser_help_description), wrapped to fit the help message's [`ARGPARSER_MAX_WIDTH`](#8432-argparser_max_width). If `ARGPARSER_HELP_DESCRIPTION` is empty (the default), nothing is printed.
...
The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name), defaulting to your script's name. This should be given as first line.
<!-- </section> -->
...
| [`ARGPARSER_ARGS`](#8413-argparser_args)                                           | *arr*      | *None* (unset)           |
| [`ARGPARSER_CHECK_ARG_DEF`](#8414-argparser_check_arg_def)                         | *bool*     | `false`                  |
| [`ARGPARSER_CHECK_ENV_VARS`](#8415-argparser_check_env_vars)                       | *bool*     | `false`                  |
| [`ARGPARSER_CONFIG_FILE`](#8416-argparser_config_file)                             | *file*     | `""`                     |
| [`ARGPARSER_COUNT_FLAGS`](#8417-argparser_count_flags)                             | *bool*     | `false`                  |
| [`ARGPARSER_ERROR_EXIT_CODE`](#8418-argparser_error_exit_code)                     | *int*      | `1`                      |
| [`ARGPARSER_ERROR_STYLE`](#8419-argparser_error_style)                             | *str*      | `"red,bold,reverse"`     |
| [`ARGPARSER_HELP_EXIT_CODE`](#8422-argparser_help_exit_code)                       | *int*      | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#8420-argparser_help_arg_group)                       | *str*      | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file)                                 | *file*     | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8424-argparser_help_file_include_char)       | *char*     | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8425-argparser_help_file_keep_comments)     | *bool*     | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#8426-argparser_help_options)                           | *char*     | `"h,?"`                  |
| [`ARGPARSER_HELP_STYLE`](#8427-argparser_help_style)                               | *str*      | `"italic"`               |
| [`ARGPARSER_LANGUAGE`](#8428-argparser_language)                                   | *str*      | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#8429-argparser_max_col_width_1)                     | *uint*     | `5`[^19]                 |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#8430-argparser_max_col_width_2)                     | *uint*     | `33`[^19]                |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#8431-argparser_max_col_width_3)                     | *uint*     | `0`[^19]                 |
| [`ARGPARSER_MAX_WIDTH`](#8432-argparser_max_width)                                 | *uint*     | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group)           | *str*      | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#8434-argparser_read_args)                                 | *bool*     | `true`                   |
| [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name)                             | *str*      | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#8436-argparser_set_args)                                   | *bool*     | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#8437-argparser_set_arrays)                               | *bool*     | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#8438-argparser_silence_errors)                       | *bool*     | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#8439-argparser_silence_warnings)                   | *bool*     | `false`                  |
| [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file)                   | *file*     | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#8441-argparser_unset_args)                               | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#8442-argparser_unset_env_vars)                       | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#8443-argparser_unset_functions)                     | *bool*     | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#8444-argparser_usage_exit_code)                     | *int*      | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#8445-argparser_usage_file)                               | *file*     | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8446-argparser_usage_file_include_char)     | *char*     | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8447-argparser_usage_file_keep_comments)   | *bool*     | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8448-argparser_usage_message_option_type) | *str*      | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8449-argparser_usage_message_orientation) | *str*      | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#8450-argparser_usage_options)                         | *char*     | `"u"`                    |
| [`ARGPARSER_USAGE_STYLE`](#8451-argparser_usage_style)                             | *str*      | `"italic"`               |
| [`ARGPARSER_USE_LONG_OPTIONS`](#8452-argparser_use_long_options)                   | *bool*     | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#8453-argparser_use_short_options)                 | *bool*     | `true`                   |
| [`ARGPARSER_USE_STYLES_IN_FILES`](#8454-argparser_use_styles_in_files)             | *bool*     | `false`                  |
| [`ARGPARSER_VERSION`](#8455-argparser_version)                                     | *str*      | `"1.0.0"`                |
| [`ARGPARSER_VERSION_EXIT_CODE`](#8456-argparser_version_exit_code)                 | *int*      | `0`                      |
| [`ARGPARSER_VERSION_OPTIONS`](#8457-argparser_version_options)                     | *char*     | `"V"`                    |
| [`ARGPARSER_VERSION_STYLE`](#8458-argparser_version_style)                         | *str*      | `"bold"`                 |
| [`ARGPARSER_WARNING_STYLE`](#8459-argparser_warning_style)                         | *str*      | `"red,bold"`             |
| [`ARGPARSER_WRITE_ARGS`](#8460-argparser_write_args)                               | *bool*     | `false`                  |
...
[^19]: Sum of values is recommended to be 77, except when [`ARGPARSER_MAX_COL_WIDTH_3`](#8431-argparser_max_col_width_3) is `0`.
<!-- </section> -->
...
- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8433-argparser_positional_arg_group).

#### 8.5.2. `Help options`

- ***Message:*** `Help options`
- ***Description:*** The name of the help options' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_HELP_ARG_GROUP`](#8420-argparser_help_arg_group).

#### 8.5.3. `Help description`

- ***Message:*** `""`
- ***Description:*** The script's description, indicating its purpose in the help message, *i.e.*, the translated [`ARGPARSER_HELP_DESCRIPTION`](#8421-argparser_help_description). The value is empty by default, and hence also the translations.
...
- ***Description:*** The remark that mandatory arguments to long options are mandatory for short options too, to be used in the help message for the [`@Remark`](#836-remark-directive) include directive.
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#8426-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#842-argparser_add_help) is set to `true`.

#### 8.5.13. `--usage`

- ***Message:*** `display the usage and exit`
- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#8450-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage) is set to `true`.

#### 8.5.14. `--version`

- ***Message:*** `display the version and exit`
- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#8457-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version) is set to `true`.
...
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8415-argparser_check_env_vars) is set to `true`, the Argparser detected that an environment variable, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8416-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value not according to the data type `bool`. These Boolean values must be either `true` or `false`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8448-argparser_usage_message_option_type) is not set to `long` or `short`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8415-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8416-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value other than `long` and `short`. Since there are only short and long option names possible, other values are refused.
- ***Interpolated variables:***
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8449-argparser_usage_message_orientation) is not set to `row` or `column`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8532-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#8453-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8532-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#8452-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the Argparser, as [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name).
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#8435-argparser_script_name) with the problematic definition.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file), the Argparser found a YAML line that it doesn't recognize. This is most likely due to a YAML feature that the Argparser doesn't support to keep the parser simple.
- ***Interpolated variables:***
  - `$1`: The YAML line.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_HELP_FILE`](#8423-argparser_help_file) or [`ARGPARSER_USAGE_FILE`](#8445-argparser_usage_file), the Argparser found an include directive that is not supported.
- ***Interpolated variables:***
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file), the Argparser found that the identifier is missing in the dictionary, and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file).
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file), the Argparser found that the translation to the [`ARGPARSER_LANGUAGE`](#8428-argparser_language) for the identifier is missing in the dictionary, and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8440-argparser_translation_file).
  - `$2`: The [`ARGPARSER_LANGUAGE`](#8428-argparser_language).
