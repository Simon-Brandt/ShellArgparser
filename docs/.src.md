...
1. [Roadmap](#7-roadmap)
   ...
   1. [Future enhancements](#72-future-enhancements)
      ...
      1. [Debug mode](#722-debug-mode)
      1. [Optional help message headings](#723-optional-help-message-headings)
      1. [Intermixed positional and keyword arguments](#724-intermixed-positional-and-keyword-arguments)
      1. [Single-hyphen long options](#725-single-hyphen-long-options)
      1. [Usage message include directives](#726-usage-message-include-directives)
      1. [License note](#727-license-note)
      1. [Programmable argument completion](#728-programmable-argument-completion)
      1. [POSIX compliance](#729-posix-compliance)
      1. [Alternative option prefixes (`+`/`/`)](#7210-alternative-option-prefixes-)
...
1. [Reference](#9-reference)
   ...
   1. [Translations](#95-translations)
      ...
      1. [`Error arg def pos choice flag`](#9568-error-arg-def-pos-choice-flag)
      1. [`Error arg def pos choice`](#9569-error-arg-def-pos-choice)
      1. [`Error arg def pos optionals`](#9570-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#9571-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#9572-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#9573-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#9574-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#9575-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#9576-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#9577-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#9578-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#9579-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#9580-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#9581-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#9582-error-arg-def-pos-note)
      1. [`Error arg def option flag 1`](#9583-error-arg-def-option-flag-1)
      1. [`Error arg def option flag 2`](#9584-error-arg-def-option-flag-2)
      ...
      1. [`Error arg def option choice flag 1`](#9587-error-arg-def-option-choice-flag-1)
      1. [`Error arg def option choice flag 2`](#9588-error-arg-def-option-choice-flag-2)
      1. [`Error arg def option choice`](#9589-error-arg-def-option-choice)
      ...
      1. [`Error arg no flag`](#95108-error-arg-no-flag)
      1. [`Error mandatory arg`](#95109-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#95110-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#95111-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#95112-error-wrong-arg-number-3)
      1. [`Error wrong arg number 4`](#95113-error-wrong-arg-number-4)
      1. [`Error arg choice`](#95114-error-arg-choice)
      1. [`Error arg bool`](#95115-error-arg-bool)
      1. [`Error arg char`](#95116-error-arg-char)
      1. [`Error arg float`](#95117-error-arg-float)
      1. [`Error arg int`](#95118-error-arg-int)
      1. [`Error arg uint`](#95119-error-arg-uint)
      1. [`Error YAML`](#95120-error-yaml)
      1. [`Error include directive`](#95121-error-include-directive)
      1. [`Warning deprecation`](#95122-warning-deprecation)
      1. [`Warning wrong arg number 1`](#95123-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#95124-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#95125-warning-wrong-arg-number-3)
      1. [`Warning wrong arg number 4`](#95126-warning-wrong-arg-number-4)
