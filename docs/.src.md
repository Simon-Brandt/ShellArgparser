...
1. [Tutorial](#4-tutorial)
   1. [Argument passing](#41-argument-passing)
   1. [Argparser invokation](#42-argparser-invokation)
   1. [Argparser configuration](#43-argparser-configuration)
   1. [Arguments definition files](#44-arguments-definition-files)
   1. [Help and usage messages](#45-help-and-usage-messages)
   1. [Help and usage message files](#46-help-and-usage-message-files)
   1. [Help and usage message localization](#47-help-and-usage-message-localization)
   1. [Version messages](#48-version-messages)
   1. [Error and warning messages](#49-error-and-warning-messages)
   1. [Message styles](#410-message-styles)
   1. [Standalone usage](#411-standalone-usage)
1. [Comparison of command-line parsers](#5-comparison-of-command-line-parsers)
   1. [Feature comparison](#51-feature-comparison)
   1. [Example scripts](#52-example-scripts)
      1. [`getopts`](#521-getopts)
      1. [`getopt`](#522-getopt)
      1. [shFlags](#523-shflags)
      1. [docopts](#524-docopts)
      1. [Argparser](#525-argparser)
   1. [Runtime comparison](#53-runtime-comparison)
   1. [Summary](#54-summary)
1. [Roadmap](#6-roadmap)
   1. [Future enhancements](#61-future-enhancements)
      1. [Mutually exclusive argument groups](#611-mutually-exclusive-argument-groups)
      1. [Any argument number](#612-any-argument-number)
      1. [Script description](#613-script-description)
      1. [Debug mode](#614-debug-mode)
      1. [Intermixed positional and keyword arguments](#615-intermixed-positional-and-keyword-arguments)
      1. [Single-hyphen long options](#616-single-hyphen-long-options)
      1. [POSIX compliance](#617-posix-compliance)
      1. [Alternative option prefixes (`+`/`/`)](#618-alternative-option-prefixes-)
   1. [Known bugs](#62-known-bugs)
1. [Contribution guide](#7-contribution-guide)
...
1. [Reference](#8-reference)
   1. [Arguments definition](#81-arguments-definition)
   ...
   1. [Colors and styles](#82-colors-and-styles)
   1. [Include directives](#83-include-directives)
   ...
   1. [Environment variables](#84-environment-variables)
      1. [Overview](#841-overview)
      1. [`ARGPARSER_ADD_HELP`](#842-argparser_add_help)
      1. [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage)
      1. [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version)
      1. [`ARGPARSER_ALLOW_FLAG_INVERSION`](#845-argparser_allow_flag_inversion)
      1. [`ARGPARSER_ALLOW_FLAG_NEGATION`](#846-argparser_allow_flag_negation)
      1. [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#847-argparser_allow_option_abbreviation)
      1. [`ARGPARSER_ALLOW_OPTION_MERGING`](#848-argparser_allow_option_merging)
      1. [`ARGPARSER_ARG_ARRAY_NAME`](#849-argparser_arg_array_name)
      1. [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file)
      1. [`ARGPARSER_ARG_DELIMITER_1`](#8411-argparser_arg_delimiter_1)
      1. [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2)
      1. [`ARGPARSER_ARGPARSER_VERSION`](#8413-argparser_argparser_version)
      1. [`ARGPARSER_ARGS`](#8414-argparser_args)
      1. [`ARGPARSER_CHECK_ARG_DEF`](#8415-argparser_check_arg_def)
      1. [`ARGPARSER_CHECK_ENV_VARS`](#8416-argparser_check_env_vars)
      1. [`ARGPARSER_CONFIG_FILE`](#8417-argparser_config_file)
      1. [`ARGPARSER_COUNT_FLAGS`](#8418-argparser_count_flags)
      1. [`ARGPARSER_DICTIONARY`](#8419-argparser_dictionary)
      1. [`ARGPARSER_ERROR_EXIT_CODE`](#8420-argparser_error_exit_code)
      1. [`ARGPARSER_ERROR_STYLE`](#8421-argparser_error_style)
      1. [`ARGPARSER_HELP_ARG_GROUP`](#8422-argparser_help_arg_group)
      1. [`ARGPARSER_HELP_EXIT_CODE`](#8423-argparser_help_exit_code)
      1. [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file)
      1. [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8425-argparser_help_file_include_char)
      1. [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8426-argparser_help_file_keep_comments)
      1. [`ARGPARSER_HELP_OPTIONS`](#8427-argparser_help_options)
      1. [`ARGPARSER_HELP_STYLE`](#8428-argparser_help_style)
      1. [`ARGPARSER_LANGUAGE`](#8429-argparser_language)
      1. [`ARGPARSER_MAX_COL_WIDTH_1`](#8430-argparser_max_col_width_1)
      1. [`ARGPARSER_MAX_COL_WIDTH_2`](#8431-argparser_max_col_width_2)
      1. [`ARGPARSER_MAX_COL_WIDTH_3`](#8432-argparser_max_col_width_3)
      1. [`ARGPARSER_MAX_WIDTH`](#8433-argparser_max_width)
      1. [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group)
      1. [`ARGPARSER_READ_ARGS`](#8435-argparser_read_args)
      1. [`ARGPARSER_SCRIPT_ARGS`](#8436-argparser_script_args)
      1. [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name)
      1. [`ARGPARSER_SET_ARGS`](#8438-argparser_set_args)
      1. [`ARGPARSER_SET_ARRAYS`](#8439-argparser_set_arrays)
      1. [`ARGPARSER_SILENCE_ERRORS`](#8440-argparser_silence_errors)
      1. [`ARGPARSER_SILENCE_WARNINGS`](#8441-argparser_silence_warnings)
      1. [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#8443-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#8444-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#8445-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#8446-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#8447-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8448-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8449-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8450-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8451-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#8452-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#8453-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#8454-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#8455-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#8456-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION`](#8457-argparser_version)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#8458-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_OPTIONS`](#8459-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#8460-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#8461-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#8462-argparser_write_args)
   1. [Translations](#85-translations)
      1. [`Positional arguments`](#851-positional-arguments)
      1. [`Help options`](#852-help-options)
      1. [`Error`](#853-error)
      1. [`Warning`](#854-warning)
      1. [`Usage`](#855-usage)
      1. [`Arguments`](#856-arguments)
      1. [`Options`](#857-options)
      1. [`Mandatory arguments`](#858-mandatory-arguments)
      1. [`Deprecated`](#859-deprecated)
      1. [`Default`](#8510-default)
      1. [`--help`](#8511---help)
      1. [`--usage`](#8512---usage)
      1. [`--version`](#8513---version)
      1. [`false`](#8514-false)
      1. [`true`](#8515-true)
      1. [`Error env var bool`](#8516-error-env-var-bool)
      1. [`Error env var char`](#8517-error-env-var-char)
      1. [`Error env var identifier`](#8518-error-env-var-identifier)
      1. [`Error env var int`](#8519-error-env-var-int)
      1. [`Error env var uint`](#8520-error-env-var-uint)
      1. [`Error env var file 0001`](#8521-error-env-var-file-0001)
      1. [`Error env var file 0010`](#8522-error-env-var-file-0010)
      1. [`Error env var file 0011`](#8523-error-env-var-file-0011)
      1. [`Error env var file 0100`](#8524-error-env-var-file-0100)
      1. [`Error env var file 0101`](#8525-error-env-var-file-0101)
      1. [`Error env var file 0110`](#8526-error-env-var-file-0110)
      1. [`Error env var file 0111`](#8527-error-env-var-file-0111)
      1. [`Error env var file 1111`](#8528-error-env-var-file-1111)
      1. [`Error env var styles`](#8529-error-env-var-styles)
      1. [`Error env var option type`](#8530-error-env-var-option-type)
      1. [`Error env var orientation`](#8531-error-env-var-orientation)
      1. [`Error env var delimiters`](#8532-error-env-var-delimiters)
      1. [`Error env var short name empty`](#8533-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#8534-error-env-var-short-name-length)
      1. [`Error env var short name inner duplication`](#8535-error-env-var-short-name-inner-duplication)
      1. [`Error env var short name outer duplication`](#8536-error-env-var-short-name-outer-duplication)
      1. [`Error env var short options`](#8537-error-env-var-short-options)
      1. [`Error env var long options`](#8538-error-env-var-long-options)
      1. [`Error env var files`](#8539-error-env-var-files)
      1. [`Error arg array 1`](#8540-error-arg-array-1)
      1. [`Error arg array 2`](#8541-error-arg-array-2)
      1. [`Error arg array 3`](#8542-error-arg-array-3)
      1. [`Error no arg def`](#8543-error-no-arg-def)
      1. [`Error arg def id`](#8544-error-arg-def-id)
      1. [`Error arg def file id`](#8545-error-arg-def-file-id)
      1. [`Error arg def field count`](#8546-error-arg-def-field-count)
      1. [`Error arg def file field count`](#8547-error-arg-def-file-field-count)
      1. [`Error arg def choice range hyphens`](#8548-error-arg-def-choice-range-hyphens)
      1. [Error arg def choice range`](#8549-error-arg-def-choice-range)
      1. [`Error arg def short name empty`](#8550-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#8551-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#8552-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#8553-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#8554-error-arg-def-short-name-length)
      1. [`Error arg def short name inner duplication`](#8555-error-arg-def-short-name-inner-duplication)
      1. [`Error arg def short name outer duplication`](#8556-error-arg-def-short-name-outer-duplication)
      1. [`Error arg def long name empty`](#8557-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#8558-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#8559-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#8560-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#8561-error-arg-def-long-name-length)
      1. [`Error arg def long name inner duplication`](#8562-error-arg-def-long-name-inner-duplication)
      1. [`Error arg def long name outer duplication`](#8563-error-arg-def-long-name-outer-duplication)
      1. [`Error arg def pos default 1`](#8564-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#8565-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice`](#8566-error-arg-def-pos-choice)
      1. [`Error arg def pos optionals`](#8567-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#8568-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#8569-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#8570-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#8571-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#8572-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#8573-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#8574-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#8575-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#8576-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#8577-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#8578-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#8579-error-arg-def-pos-note)
      1. [`Error arg def option flag`](#8580-error-arg-def-option-flag)
      1. [`Error arg def option default 1`](#8581-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#8582-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#8583-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice`](#8584-error-arg-def-option-choice)
      1. [`Error arg def option type`](#8585-error-arg-def-option-type)
      1. [`Error arg def option bool`](#8586-error-arg-def-option-bool)
      1. [`Error arg def option char`](#8587-error-arg-def-option-char)
      1. [`Error arg def option float`](#8588-error-arg-def-option-float)
      1. [`Error arg def option int`](#8589-error-arg-def-option-int)
      1. [`Error arg def option uint`](#8590-error-arg-def-option-uint)
      1. [`Error arg def option note`](#8591-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#8592-error-arg-double-hyphen)
      1. [`Error arg double plus`](#8593-error-arg-double-plus)
      1. [`Error arg inversion`](#8594-error-arg-inversion)
      1. [`Error arg unknown`](#8595-error-arg-unknown)
      1. [`Error long option match`](#8596-error-long-option-match)
      1. [`Error long option negation`](#8597-error-long-option-negation)
      1. [`Error long option unknown`](#8598-error-long-option-unknown)
      1. [`Error short option merge`](#8599-error-short-option-merge)
      1. [`Error short option unknown`](#85100-error-short-option-unknown)
      1. [`Error pos arg count 1`](#85101-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#85102-error-pos-arg-count-2)
      1. [`Error arg no flag`](#85103-error-arg-no-flag)
      1. [`Error mandatory arg`](#85104-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#85105-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#85106-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#85107-error-wrong-arg-number-3)
      1. [`Error arg choice`](#85108-error-arg-choice)
      1. [`Error arg bool`](#85109-error-arg-bool)
      1. [`Error arg char`](#85110-error-arg-char)
      1. [`Error arg float`](#85111-error-arg-float)
      1. [`Error arg int`](#85112-error-arg-int)
      1. [`Error arg uint`](#85113-error-arg-uint)
      1. [`Error YAML`](#85114-error-yaml)
      1. [`Error include directive`](#85115-error-include-directive)
      1. [`Warning wrong arg number 1`](#85116-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#85117-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#85118-warning-wrong-arg-number-3)
      1. [`Warning deprecation`](#85119-warning-deprecation)
      1. [`Warning no identifier`](#85120-warning-no-identifier)
      1. [`Warning no translation`](#85121-warning-no-translation)
<!-- </toc> -->
<!-- </section> -->
...
By design, the Argparser only requires Bash to run. However, for creating the documentation and for [comparing](#5-comparison-of-command-line-parsers) the different command-line parsers, several other tools are required, which you would need to install, should you want to contribute.
...
Further, long option names can be abbreviated, as long as no collision with other names arises (like when giving `--verb` in the example above). This requires [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#847-argparser_allow_option_abbreviation) to be set to `true`. In contrast, short option names may be merged with their value or other short option names (if they're flags, see below), given that [`ARGPARSER_ALLOW_OPTION_MERGING`](#848-argparser_allow_option_merging) is set to `true`. For the sake of an example without needing a novel script, we'll set the latter variable to the environment of the script execution by prefixing the assignments to the usual command line:
...
The first section sets Argparser-specific [environment variables](#84-environment-variables) to optimize the visual output, which we'll investigate later. Then, the arguments are defined, and finally, the Argparser is called. This call is central to the script as it is the line that runs the Argparser. So, most simply, from your Bash script whose command-line arguments you want to be parsed, the main thing you need to do is to [`source`](https://www.gnu.org/software/bash/manual/html_node/Bash-Builtins.html#index-source "gnu.org &rightarrow; Bash Builtins &rightarrow; source") the Argparser (sourcing means in-place execution without forking):

```bash
source argparser -- "$@"
```

Shells other than Bash require a slightly different approach, the [standalone usage](#411-standalone-usage) in a pipe, but most things still hold for this case. As a result of the Argparser's configurability (see below), it is necessary to give cour script's command line after a double hyphen, *i.e.*, using `-- "$@"`.
...
The argument-defining entries in the indexed array named by [`ARGPARSER_ARG_ARRAY_NAME`](#849-argparser_arg_array_name), defaulting to `"args"`, can be understood as some sort of key&ndash;value pair for each argument, but merged in one string (not as true keys and values in associative arrays). The key is a unique identifier for the Argparser functions, and the name under which the argument's value can be obtained from the associative array `args`. The corresponding value provides the argument's definition to the Argparser.

This Argparser-specific tabular format consists of eleven columns, each separated from each other by an [`ARGPARSER_ARG_DELIMITER_1`](#8411-argparser_arg_delimiter_1) character, defaulting to a pipe (`"|"`). Multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2) character, defaulting to a comma (`","`). The columns are defined as follows:
...
- `arg_group`: the argument group for grouping of keyword arguments in the help text (like `"Optional options"` for `var_4`, default: [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group))
...
The Argparser accepts over 50 options for configuring the argument parsing, checking their values and the consistency of the arguments definition, creating the various message types (see below), and setting the required companion files. These options are available as [environment variables](#84-environment-variables). By this, you can set them directly in your script, and even [`export`](https://www.gnu.org/software/bash/manual/html_node/Bourne-Shell-Builtins.html#index-export "gnu.org &rightarrow; Bourne Shell Builtins &rightarrow; export") them to child processes. Thus, you can set these variables once and use them throughout your script suite.
...
Likewise, the [usage (and help) message](#45-help-and-usage-messages) is completely unaffected:
...
No matter how many keyword arguments are defined, as long as [`ARGPARSER_ADD_HELP`](#842-argparser_add_help) and [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage) are set to `true` (the default), the Argparser interprets the flags from the [`ARGPARSER_HELP_OPTIONS`](#8427-argparser_help_options) (default: `-h` and `-?`) and `--help` as call for a verbose help message and the flags from the [`ARGPARSER_USAGE_OPTIONS`](#8452-argparser_usage_options) (default: `-u`) and `--usage` as call for a brief usage message. Then, these options are automatically added to the script's argument definition and override any same-named argument name (yielding an error message if [`ARGPARSER_CHECK_ARG_DEF`](#8415-argparser_check_arg_def) is set to `true`). This is to ensure that the novice user of your script can do exactly what we did, above: trying the most common variants to get some help over how to use a program or script by typing
...
For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8451-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8450-argparser_usage_message_option_type):
...
The help message details all short and long option names, their optionality (*i.e.*, whether there are default values), and their choice values, using the same syntax as in the usage message. Additionally, the help text and notes from the arguments definition are given. The arguments are separated by their groups, thus structuring the help message. First, the group for the positional arguments is given (indicated by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group)), then follow the keyword argument groups in alphabetical order. Finally, the default `--help`, `--usage`, and `--version` arguments (the latter for the [version message](#48-version-messages)) are given as separate, yet unnamed group.

The help message's structure aims at reproducing the commonly found structure in command-line programs. By setting [`ARGPARSER_MAX_COL_WIDTH_1`](#8430-argparser_max_col_width_1), [`ARGPARSER_MAX_COL_WIDTH_2`](#8431-argparser_max_col_width_2), or [`ARGPARSER_MAX_COL_WIDTH_3`](#8432-argparser_max_col_width_3) (as done in `try_argparser.sh`), the column widths may be adapted to your needs, recommendably totalling 77 characters (thus 79 characters including the separating spaces). Note that columns are automatically shrunk, when their content is narrower, but they're not expanded, when their content is wider. This is to guarantee that the help message, when *e.g.* sent as logging output, nicely fits in the space you have.

Alternatively, you may want to set [`ARGPARSER_MAX_WIDTH`](#8433-argparser_max_width). By this, the help message will have a defined width, independent of shrunk columns. This is achieved by expanding the third column (with the help text) to the remaining width. For this to work, [`ARGPARSER_MAX_COL_WIDTH_3`](#8432-argparser_max_col_width_3) must be set to `0`.
<!-- </section> -->

<!-- <section file="tutorial/help_and_usage_message_files.md"> -->
### 4.6. Help and usage message files

The Argparser is not only able to compile a help message, but can also be guided by a separate file. Using the [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file) environment variable pointing to this file, to a certain degree, you can customize the help message's look and structure by moving the blocks the message consists of around and enriching it by arbitrary text. Again, we use a simplified script as `try_help_file.sh` without alias names for the short and long options.
...
Additionally, we need a separate file, which we'll call `help_message.txt` and have passed as value to [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
When you compare the structure of this help message with both the previous version and the help file, you see that there, you can include the sections from the auto-generated help message by prefixing their names with an [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8425-argparser_help_file_include_char) character, defaulting to an `"@"`. Generally speaking, an include directive, as the commands are referred to, like `@Section`, includes the section named `"Section"`.

The following section names (include directives) are supported, explained in greater detail in the reference below:

- [`@All`](#831-all-directive)
- [`@<ArgumentGroup>`](#832-argumentgroup-directive)
- [`@Header`](#833-header-directive)
- [`@Help`](#836-help-directive)
- [`@Remark`](#834-remark-directive)
- [`@Usage`](#835-usage-directive)

Thereby, `<ArgumentGroup>` can be the name of any argument group given in the arguments definition, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. `@Help` prints the help, usage, and version options (depending on which of them are defined by [`ARGPARSER_ADD_HELP`](#842-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version)), `@Remark` prints the remark that mandatory arguments to long options are mandatory for short options too, and `@Usage` prints the usage line. Finally, the shorthand `@All` means to print the usage line, the remark, all argument groups, and the help options, in this order, while `@Header` prints the usage line and the remark.

Further, lines starting with a `"#"` character in the help file aren't printed if [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8426-argparser_help_file_keep_comments) is set to `false` (the default). This allows you to comment your help file, perhaps to explain the structure&mdash;or just to write a header or footer with your name and debug email address inside.

The same as for help messages can be done for usage messages, using the [`ARGPARSER_USAGE_FILE`](#8447-argparser_usage_file), [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8448-argparser_usage_file_include_char), and [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8449-argparser_usage_file_keep_comments) environment variables. However there, only the `@All` directive is supported, yet.
<!-- </section> -->

<!-- <section file="tutorial/help_and_usage_message_localization.md"> -->
### 4.7. Help and usage message localization

It is even possible to localize your script's help and usage message. For the usage message, all you need is an [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file), a simplified YAML file giving the translation of the auto-generated parts in the messages. For each section, you give the language identifier for the language you want the message to be translated to, *i.e.*, the [`ARGPARSER_LANGUAGE`](#8429-argparser_language). For the usage message, this suffices, but in the help message, also non-auto-generated parts are included, especially each argument's help text. For them to be translated, you need a dedicated [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file) and possibly a localized [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file).
...
Besides the the [`ARGPARSER_HELP_OPTIONS`](#8427-argparser_help_options), `--help`, the [`ARGPARSER_USAGE_OPTIONS`](#8452-argparser_usage_options), and `--usage`, there is a third option intended to help the user, the [`ARGPARSER_VERSION_OPTIONS`](#8459-argparser_version_options) (default: `-V`) and `--version`. This flag compiles a brief version message for your script, showing its canonical name (the [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name)) and the version number (the [`ARGPARSER_VERSION`](#8457-argparser_version)). Just as for the help and usage messages, you can disable the version message (and its corresponding flags) by setting [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version) to `false`. Note that the default short option name is an uppercase `V`, such that you can use the lowercase `v` (as `-v`) for your purposes, like `--verbatim` or `--verbose`. This is in line with the common behavior of command-line programs. By setting `ARGPARSER_VERSION_OPTIONS` accordingly, you can of course change it to your needs, if desired.
...
### 4.9. Error and warning messages

The Argparser outputs about a hundred different error and warning messages to give both you and your script's user as detailled feedback as possible about what went wrong with the argument parsing. Each message starts with your script's canonical name (the [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name)), followed by either `"Error:"` or `"Warning:"` and the respective message. Using the same simplified YAML file as for the help and usage messages (the [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file)), also the error and warning messages can be fully localized.
...
The [feature comparison](#51-feature-comparison) compares the various features for argument parsing, while some [example scripts](#52-example-scripts) later demonstrate the usage for the different parsers in an exemplary use case.
<!-- </section> -->
...
The reference details the actual definitions of all [colors and styles](#82-colors-and-styles), [include directives](#83-include-directives), and [environment variables](#84-environment-variables). While it may be advantageous to read it once in its entirety to see all features not discussed in the [tutorial](#4-tutorial), it is more designed as manual for specific questions regarding certain features.
<!-- </section> -->
...
The values in multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2) character, by default a comma (`","`). Absence of value is indicated by the empty string, resulting after trimming spaces. That is, a field consisting of only spaces means absence.
...
The argument identifier must be a valid variable identifier in Bash syntax (at least when [`ARGPARSER_SET_ARGS`](#8438-argparser_set_args) is set to `true`, else, the ID is only used as key in associative arrays). These are defined as a word beginning with an alphabetic character or an underscore, followed by an arbitrary number of alphanumeric characters or underscores. In Bash's extglob syntax, the regular expression for verification may look like `[[:alpha:]_]*([[:word:]])`, assuming C locale.

#### 8.1.2. Short option names (`short_opts`)

The short option names must comprise exactly one character, thereby, no leading hyphen may be given. Multiple short option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2) character. Bash is case-sensitive, so is the checking for option names. Thus, you would need to provide both `a` and `A` as short option names if you want both to be recognized. This distinction effectively allows doubling the number of available short option names defined as letters (`a-z` and `A-Z`).

#### 8.1.3. Long option names (`long_opts`)

The long option names must comprise more than one character, thereby, no leading hyphen may be given. Multiple long option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2) character.
...
The Python [`argparse`](https://docs.python.org/3/library/argparse.html "python.org &rightarrow; Python documentation &rightarrow; argparse module") module further defines `*` to accept any argument count, and `?` to accept exactly zero or one argument. Both features aren't yet supported by the Argparser, but the characters are reserved for future usage as such, invalidating them as values for [`ARGPARSER_ARG_DELIMITER_1`](#8411-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2).

#### 8.1.9. Argument group (`arg_group`)

The argument groups serve to group arguments in the help message. The first group shall comprise all positional arguments (if any is defined) and is named by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group). Any other argument group shall only contain keyword arguments (options), and is sorted alphabetically in the help message. In the future, argument groups will be expanded to allow actual grouping of arguments upon parsing, such that options may only be given together or mutually exclusively.
...
The help text should consist of a terse summary of the argument's function, like turning a feature on or off (which may be accomplished by flags), what a file is used for (like for input or output), or how your script's output may be modified. A help text can take any form, but be wary of it being wrapped to fit the width of the third column in the help message (if [`ARGPARSER_MAX_COL_WIDTH_3`](#8432-argparser_max_col_width_3) is non-zero) or the total line length ([`ARGPARSER_MAX_WIDTH`](#8433-argparser_max_width)). Help messages are no replacement for the manual, so the help text shouldn't be overly verbose.
<!-- </section> -->

<!-- <section file="reference/colors_and_styles.md"> -->
### 8.2. Colors and styles

The Argparser employs [Select Graphic Rendition (SGR) ANSI escape sequence codes](https://en.wikipedia.org/wiki/ANSI_escape_code#Select_Graphic_Rendition_parameters "wikipedia.org &rightarrow; ANSI escape code &rightarrow; Select Graphic Rendition parameters") to set the appearance of error, warning, help, usage, and version messages. To this end, five environment variable are defined, *viz.*, [`ARGPARSER_HELP_STYLE`](#8428-argparser_help_style), [`ARGPARSER_USAGE_STYLE`](#8453-argparser_usage_style), [`ARGPARSER_VERSION_STYLE`](#8460-argparser_version_style), [`ARGPARSER_ERROR_STYLE`](#8421-argparser_error_style), and [`ARGPARSER_WARNING_STYLE`](#8461-argparser_warning_style). Since the escape codes are nonprintable, not any terminal or text editor may support them. Many terminals do, while *e.g.* [`less`](https://man7.org/linux/man-pages/man1/less.1.html "man7.org &rightarrow; man pages &rightarrow; less(1)") has a dedicated flag, `--raw-control-chars`.
...
Six section names (include directives) are supported in the help and usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8425-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8448-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file) with the following content:
...
The `@<ArgumentGroup>` directive prints the help text for the respective `"<ArgumentGroup>"`, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file), denoting all arguments groups in the order preferred by you.
...
The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name), defaulting to your script's name. This should be given as first line.

#### 8.3.6. `@Help` directive

The `@Help` directive prints the help text for the `--help`, `--usage`, and `--version` flags (if added to the arguments definition by [`ARGPARSER_ADD_HELP`](#842-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version)). Usually, you want to give this at the very end of all options.
<!-- </section> -->
...
| ---------------------------------------------------------------------------------- | ---------- | ------------------------ |
| [`ARGPARSER_ADD_HELP`](#842-argparser_add_help)                                    | *bool*     | `true`                   |
| [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage)                                  | *bool*     | `true`                   |
| [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version)                              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_INVERSION`](#845-argparser_allow_flag_inversion)            | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_NEGATION`](#846-argparser_allow_flag_negation)              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#847-argparser_allow_option_abbreviation)  | *bool*     | `false`                  |
| [`ARGPARSER_ALLOW_OPTION_MERGING`](#848-argparser_allow_option_merging)            | *bool*     | `false`                  |
| [`ARGPARSER_ARG_ARRAY_NAME`](#849-argparser_arg_array_name)                        | *str*[^17] | `"args"`                 |
| [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file)                           | *file*     | `""`                     |
| [`ARGPARSER_ARG_DELIMITER_1`](#8411-argparser_arg_delimiter_1)                     | *char*     | `"\|"`[^18]              |
| [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2)                     | *char*     | `","`[^18]               |
| [`ARGPARSER_ARGPARSER_VERSION`](#8413-argparser_argparser_version)                 | *str*      | *None* (unset)           |
| [`ARGPARSER_ARGS`](#8414-argparser_args)                                           | *arr*      | *None* (unset)           |
| [`ARGPARSER_CHECK_ARG_DEF`](#8415-argparser_check_arg_def)                         | *bool*     | `false`                  |
| [`ARGPARSER_CHECK_ENV_VARS`](#8416-argparser_check_env_vars)                       | *bool*     | `false`                  |
| [`ARGPARSER_CONFIG_FILE`](#8417-argparser_config_file)                             | *file*     | `""`                     |
| [`ARGPARSER_COUNT_FLAGS`](#8418-argparser_count_flags)                             | *bool*     | `false`                  |
| [`ARGPARSER_DICTIONARY`](#8419-argparser_dictionary)                               | *dict*     | *None* (unset)           |
| [`ARGPARSER_ERROR_EXIT_CODE`](#8420-argparser_error_exit_code)                     | *int*      | `1`                      |
| [`ARGPARSER_ERROR_STYLE`](#8421-argparser_error_style)                             | *str*      | `"red,bold,reverse"`     |
| [`ARGPARSER_HELP_EXIT_CODE`](#8423-argparser_help_exit_code)                       | *int*      | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#8422-argparser_help_arg_group)                       | *str*      | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file)                                 | *file*     | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#8425-argparser_help_file_include_char)       | *char*     | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#8426-argparser_help_file_keep_comments)     | *bool*     | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#8427-argparser_help_options)                           | *char*     | `"h,?"`                  |
| [`ARGPARSER_HELP_STYLE`](#8428-argparser_help_style)                               | *str*      | `"italic"`               |
| [`ARGPARSER_LANGUAGE`](#8429-argparser_language)                                   | *str*      | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#8430-argparser_max_col_width_1)                     | *uint*     | `5`[^19]                 |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#8431-argparser_max_col_width_2)                     | *uint*     | `33`[^19]                |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#8432-argparser_max_col_width_3)                     | *uint*     | `0`[^19]                 |
| [`ARGPARSER_MAX_WIDTH`](#8433-argparser_max_width)                                 | *uint*     | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group)           | *str*      | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#8435-argparser_read_args)                                 | *bool*     | `true`                   |
| [`ARGPARSER_SCRIPT_ARGS`](#8436-argparser_script_args)                             | *arr*      | *None* (unset)           |
| [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name)                             | *str*      | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#8438-argparser_set_args)                                   | *bool*     | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#8439-argparser_set_arrays)                               | *bool*     | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#8440-argparser_silence_errors)                       | *bool*     | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#8441-argparser_silence_warnings)                   | *bool*     | `false`                  |
| [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file)                   | *file*     | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#8443-argparser_unset_args)                               | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#8444-argparser_unset_env_vars)                       | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#8445-argparser_unset_functions)                     | *bool*     | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#8446-argparser_usage_exit_code)                     | *int*      | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#8447-argparser_usage_file)                               | *file*     | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#8448-argparser_usage_file_include_char)     | *char*     | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#8449-argparser_usage_file_keep_comments)   | *bool*     | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8450-argparser_usage_message_option_type) | *str*      | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8451-argparser_usage_message_orientation) | *str*      | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#8452-argparser_usage_options)                         | *char*     | `"u"`                    |
| [`ARGPARSER_USAGE_STYLE`](#8453-argparser_usage_style)                             | *str*      | `"italic"`               |
| [`ARGPARSER_USE_LONG_OPTIONS`](#8454-argparser_use_long_options)                   | *bool*     | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#8455-argparser_use_short_options)                 | *bool*     | `true`                   |
| [`ARGPARSER_USE_STYLES_IN_FILES`](#8456-argparser_use_styles_in_files)             | *bool*     | `false`                  |
| [`ARGPARSER_VERSION`](#8457-argparser_version)                                     | *str*      | `"1.0.0"`                |
| [`ARGPARSER_VERSION_EXIT_CODE`](#8458-argparser_version_exit_code)                 | *int*      | `0`                      |
| [`ARGPARSER_VERSION_OPTIONS`](#8459-argparser_version_options)                     | *char*     | `"V"`                    |
| [`ARGPARSER_VERSION_STYLE`](#8460-argparser_version_style)                         | *str*      | `"bold"`                 |
| [`ARGPARSER_WARNING_STYLE`](#8461-argparser_warning_style)                         | *str*      | `"red,bold"`             |
| [`ARGPARSER_WRITE_ARGS`](#8462-argparser_write_args)                               | *bool*     | `false`                  |
...
- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#8434-argparser_positional_arg_group).

#### 8.5.2. `Help options`

- ***Message:*** `Help options`
- ***Description:*** The name of the help options' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_HELP_ARG_GROUP`](#8422-argparser_help_arg_group).
...
- ***Description:*** The remark that mandatory arguments to long options are mandatory for short options too, to be used in the help message for the [`@Remark`](#834-remark-directive) include directive.
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#8427-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#842-argparser_add_help) is set to `true`.

#### 8.5.12. `--usage`

- ***Message:*** `display the usage and exit`
- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#8452-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#843-argparser_add_usage) is set to `true`.

#### 8.5.13. `--version`

- ***Message:*** `display the version and exit`
- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#8459-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#844-argparser_add_version) is set to `true`.
...
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8416-argparser_check_env_vars) is set to `true`, the Argparser detected that an environment variable, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8417-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value not according to the data type `bool`. These Boolean values must be either `true` or `false`.
...
- ***Description:*** The error that an environment variable refers to an undefined [color or style](#82-colors-and-styles).
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8450-argparser_usage_message_option_type) is not set to `long` or `short`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8416-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8417-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value other than `long` and `short`. Since there are only short and long option names possible, other values are refused.
- ***Interpolated variables:***
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#8451-argparser_usage_message_orientation) is not set to `row` or `column`.
...
- ***Description:*** The error that the environment variables [`ARGPARSER_ARG_DELIMITER_1`](#8411-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#8412-argparser_arg_delimiter_2) have an identical value.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#8416-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variables `ARGPARSER_ARG_DELIMITER_1` and `ARGPARSER_ARG_DELIMITER_2`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#8417-argparser_config_file), on the Argparser invokation command line, or as an environment variable, have the same value. This renders parsing of the arguments definition impossible, as multi-value fields cannot be told apart from column delimiters.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8530-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#8455-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8530-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#8454-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the Argparser, as [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name).
...
- ***Description:*** The error that [`ARGPARSER_ARG_ARRAY_NAME`](#849-argparser_arg_array_name) refers to a variable that's not defined.
...
- ***Reasons for error:*** When reading the arguments definition, the Argparser found a definition line giving only an argument name, but no definition corresponding to this argument in the accompanying [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file).
- ***Interpolated variables:***
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#8437-argparser_script_name) with the problematic definition.

#### 8.5.45. `Error arg def file id`

- ***Message:*** `Error: In the arguments definition file "$1", the column "id" is missing.`
- ***Description:*** The error that the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file) lacks a column, instead giving an unused one.
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file) with the problematic definition.
...
- ***Description:*** The error that in the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#8410-argparser_arg_def_file), the lines have differing field counts.
...
- ***Reasons for error:*** When parsing the command line, the Argparser found an option that starts with a plus sign, meaning the intention to invert the flag, but [`ARGPARSER_ALLOW_FLAG_INVERSION`](#845-argparser_allow_flag_inversion) is set to `false`. This removes the ability to use the `+` prefix.
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#847-argparser_allow_option_abbreviation) is set to `true`, the Argparser found a long option being abbreviated, but matching more than one defined long option in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_FLAG_NEGATION`](#846-argparser_allow_flag_negation) is set to `true`, the Argparser found a long option starting with `--no-`, but the remaining (affirmative) version has not been defined in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_OPTION_MERGING`](#848-argparser_allow_option_merging) is set to `true`, the Argparser found a short option, merged with others, that has not been defined in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file), the Argparser found a YAML line that it doesn't recognize. This is most likely due to a YAML feature that the Argparser doesn't support to keep the parser simple.
- ***Interpolated variables:***
  - `$1`: The YAML line.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_HELP_FILE`](#8424-argparser_help_file) or [`ARGPARSER_USAGE_FILE`](#8447-argparser_usage_file), the Argparser found an include directive that is not supported.
- ***Interpolated variables:***
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file), the Argparser found that the identifier is missing in the [`ARGPARSER_DICTIONARY`](#8419-argparser_dictionary), and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file).
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file), the Argparser found that the translation to the [`ARGPARSER_LANGUAGE`](#8429-argparser_language) for the identifier is missing in the [`ARGPARSER_DICTIONARY`](#8419-argparser_dictionary), and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#8442-argparser_translation_file).
  - `$2`: The [`ARGPARSER_LANGUAGE_`](#8429-argparser_language).
