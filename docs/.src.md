...
1. [Reference](#8-reference)
   ...
   1. [Translations](#85-translations)
      ...
      1. [`Error env var short name inner duplication`](#8537-error-env-var-short-name-inner-duplication)
      1. [`Error env var short name outer duplication`](#8538-error-env-var-short-name-outer-duplication)
      ...
      1. [`Error arg def short name inner duplication`](#8557-error-arg-def-short-name-inner-duplication)
      1. [`Error arg def short name outer duplication`](#8558-error-arg-def-short-name-outer-duplication)
      ...
      1. [`Error arg def long name inner duplication`](#8564-error-arg-def-long-name-inner-duplication)
      1. [`Error arg def long name outer duplication`](#8565-error-arg-def-long-name-outer-duplication)
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8532-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#8456-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#8532-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#8455-argparser_use_long_options) prohibits this.
