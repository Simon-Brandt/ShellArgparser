...
1. [Contribution guide](#6-contribution-guide)
...
1. [Reference](#7-reference)
   1. [Arguments definition](#71-arguments-definition)
   ...
   1. [Colors and styles](#72-colors-and-styles)
   1. [Include directives](#73-include-directives)
   ...
   1. [Translations](#74-translations)
      1. [`Positional arguments`](#741-positional-arguments)
      1. [`Help options`](#742-help-options)
      1. [`Error`](#743-error)
      1. [`Warning`](#744-warning)
      1. [`Usage`](#745-usage)
      1. [`Arguments`](#746-arguments)
      1. [`Options`](#747-options)
      1. [`Mandatory arguments`](#748-mandatory-arguments)
      1. [`Deprecated`](#749-deprecated)
      1. [`Default`](#7410-default)
      1. [`--help`](#7411---help)
      1. [`--usage`](#7412---usage)
      1. [`--version`](#7413---version)
      1. [`false`](#7414-false)
      1. [`true`](#7415-true)
      1. [`Error env var bool`](#7416-error-env-var-bool)
      1. [`Error env var char`](#7417-error-env-var-char)
      1. [`Error env var identifier`](#7418-error-env-var-identifier)
      1. [`Error env var int`](#7419-error-env-var-int)
      1. [`Error env var uint`](#7420-error-env-var-uint)
      1. [`Error env var file 0001`](#7421-error-env-var-file-0001)
      1. [`Error env var file 0010`](#7422-error-env-var-file-0010)
      1. [`Error env var file 0011`](#7423-error-env-var-file-0011)
      1. [`Error env var file 0100`](#7424-error-env-var-file-0100)
      1. [`Error env var file 0101`](#7425-error-env-var-file-0101)
      1. [`Error env var file 0110`](#7426-error-env-var-file-0110)
      1. [`Error env var file 0111`](#7427-error-env-var-file-0111)
      1. [`Error env var file 1111`](#7428-error-env-var-file-1111)
      1. [`Error env var styles`](#7429-error-env-var-styles)
      1. [`Error env var option type`](#7430-error-env-var-option-type)
      1. [`Error env var orientation`](#7431-error-env-var-orientation)
      1. [`Error env var delimiters`](#7432-error-env-var-delimiters)
      1. [`Error env var short name empty`](#7433-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#7434-error-env-var-short-name-length)
      1. [`Error env var short name inner duplication`](#7435-error-env-var-short-name-inner-duplication)
      1. [`Error env var short name outer duplication`](#7436-error-env-var-short-name-outer-duplication)
      1. [`Error env var short options`](#7437-error-env-var-short-options)
      1. [`Error env var long options`](#7438-error-env-var-long-options)
      1. [`Error env var files`](#7439-error-env-var-files)
      1. [`Error arg array 1`](#7440-error-arg-array-1)
      1. [`Error arg array 2`](#7441-error-arg-array-2)
      1. [`Error arg array 3`](#7442-error-arg-array-3)
      1. [`Error no arg def`](#7443-error-no-arg-def)
      1. [`Error arg def id`](#7444-error-arg-def-id)
      1. [`Error arg def file id`](#7445-error-arg-def-file-id)
      1. [`Error arg def field count`](#7446-error-arg-def-field-count)
      1. [`Error arg def file id`](#7447-error-arg-def-file-id)
   1. [Environment variables](#75-environment-variables)
      1. [Overview](#751-overview)
      1. [`ARGPARSER_ADD_HELP`](#752-argparser_add_help)
      1. [`ARGPARSER_ADD_USAGE`](#753-argparser_add_usage)
      1. [`ARGPARSER_ADD_VERSION`](#754-argparser_add_version)
      1. [`ARGPARSER_ALLOW_FLAG_INVERSION`](#755-argparser_allow_flag_inversion)
      1. [`ARGPARSER_ALLOW_FLAG_NEGATION`](#756-argparser_allow_flag_negation)
      1. [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#757-argparser_allow_option_abbreviation)
      1. [`ARGPARSER_ALLOW_OPTION_MERGING`](#758-argparser_allow_option_merging)
      1. [`ARGPARSER_ARG_ARRAY_NAME`](#759-argparser_arg_array_name)
      1. [`ARGPARSER_ARG_DEF_FILE`](#7510-argparser_arg_def_file)
      1. [`ARGPARSER_ARG_DELIMITER_1`](#7511-argparser_arg_delimiter_1)
      1. [`ARGPARSER_ARG_DELIMITER_2`](#7512-argparser_arg_delimiter_2)
      1. [`ARGPARSER_ARGPARSER_VERSION`](#7513-argparser_argparser_version)
      1. [`ARGPARSER_ARGS`](#7514-argparser_args)
      1. [`ARGPARSER_CHECK_ARG_DEF`](#7515-argparser_check_arg_def)
      1. [`ARGPARSER_CHECK_ENV_VARS`](#7516-argparser_check_env_vars)
      1. [`ARGPARSER_CONFIG_FILE`](#7517-argparser_config_file)
      1. [`ARGPARSER_COUNT_FLAGS`](#7518-argparser_count_flags)
      1. [`ARGPARSER_DICTIONARY`](#7519-argparser_dictionary)
      1. [`ARGPARSER_ERROR_EXIT_CODE`](#7520-argparser_error_exit_code)
      1. [`ARGPARSER_ERROR_STYLE`](#7521-argparser_error_style)
      1. [`ARGPARSER_HELP_ARG_GROUP`](#7522-argparser_help_arg_group)
      1. [`ARGPARSER_HELP_EXIT_CODE`](#7523-argparser_help_exit_code)
      1. [`ARGPARSER_HELP_FILE`](#7524-argparser_help_file)
      1. [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#7525-argparser_help_file_include_char)
      1. [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#7526-argparser_help_file_keep_comments)
      1. [`ARGPARSER_HELP_OPTIONS`](#7527-argparser_help_options)
      1. [`ARGPARSER_HELP_STYLE`](#7528-argparser_help_style)
      1. [`ARGPARSER_LANGUAGE`](#7529-argparser_language)
      1. [`ARGPARSER_MAX_COL_WIDTH_1`](#7530-argparser_max_col_width_1)
      1. [`ARGPARSER_MAX_COL_WIDTH_2`](#7531-argparser_max_col_width_2)
      1. [`ARGPARSER_MAX_COL_WIDTH_3`](#7532-argparser_max_col_width_3)
      1. [`ARGPARSER_MAX_WIDTH`](#7533-argparser_max_width)
      1. [`ARGPARSER_POSITIONAL_ARG_GROUP`](#7534-argparser_positional_arg_group)
      1. [`ARGPARSER_READ_ARGS`](#7535-argparser_read_args)
      1. [`ARGPARSER_SCRIPT_ARGS`](#7536-argparser_script_args)
      1. [`ARGPARSER_SCRIPT_NAME`](#7537-argparser_script_name)
      1. [`ARGPARSER_SET_ARGS`](#7538-argparser_set_args)
      1. [`ARGPARSER_SET_ARRAYS`](#7539-argparser_set_arrays)
      1. [`ARGPARSER_SILENCE_ERRORS`](#7540-argparser_silence_errors)
      1. [`ARGPARSER_SILENCE_WARNINGS`](#7541-argparser_silence_warnings)
      1. [`ARGPARSER_TRANSLATION_FILE`](#7542-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#7543-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#7544-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#7545-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#7546-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#7547-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#7548-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#7549-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#7550-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#7551-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#7552-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#7553-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#7554-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#7555-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#7556-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION`](#7557-argparser_version)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#7558-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_OPTIONS`](#7559-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#7560-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#7561-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#7562-argparser_write_args)
<!-- </toc> -->
<!-- </section> -->
...
- `arg_group`: the argument group for grouping of keyword arguments in the help text (like `"Optional options"` for `var_4`, default: [`ARGPARSER_POSITIONAL_ARG_GROUP`](#7534-argparser_positional_arg_group))
...
The Argparser accepts over 50 options for configuring the argument parsing, checking their values and the consistency of the arguments definition, creating the various message types (see below), and setting the required companion files. These options are available as [environment variables](#75-environment-variables). By this, you can set them directly in your script, and even [`export`](https://www.gnu.org/software/bash/manual/html_node/Bourne-Shell-Builtins.html#index-export "gnu.org &rightarrow; Bourne Shell Builtins &rightarrow; export") them to child processes. Thus, you can set these variables once and use them throughout your script suite.
...
No matter how many keyword arguments are defined, as long as [`ARGPARSER_ADD_HELP`](#752-argparser_add_help) and [`ARGPARSER_ADD_USAGE`](#753-argparser_add_usage) are set to `true` (the default), the Argparser interprets the flags from the [`ARGPARSER_HELP_OPTIONS`](#7527-argparser_help_options) (default: `-h` and `-?`) and `--help` as call for a verbose help message and the flags from the [`ARGPARSER_USAGE_OPTIONS`](#7552-argparser_usage_options) (default: `-u`) and `--usage` as call for a brief usage message. Then, these options are automatically added to the script's argument definition and override any same-named argument name (yielding an error message if [`ARGPARSER_CHECK_ARG_DEF`](#7515-argparser_check_arg_def) is set to `true`). This is to ensure that the novice user of your script can do exactly what we did, above: trying the most common variants to get some help over how to use a program or script by typing
...
For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#7551-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#7550-argparser_usage_message_option_type):
...
Additionally, we need a separate file, which we'll call `help_message.txt` and have passed as value to [`ARGPARSER_HELP_FILE`](#7524-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
Besides the the [`ARGPARSER_HELP_OPTIONS`](#7527-argparser_help_options), `--help`, the [`ARGPARSER_USAGE_OPTIONS`](#7552-argparser_usage_options), and `--usage`, there is a third option intended to help the user, the [`ARGPARSER_VERSION_OPTIONS`](#7559-argparser_version_options) (default: `-V`) and `--version`. This flag compiles a brief version message for your script, showing its canonical name (the [`ARGPARSER_SCRIPT_NAME`](#7537-argparser_script_name)) and the version number (the [`ARGPARSER_VERSION`](#7557-argparser_version)). Just as for the help and usage messages, you can disable the version message (and its corresponding flags) by setting [`ARGPARSER_ADD_VERSION`](#754-argparser_add_version) to `false`. Note that the default short option name is an uppercase `V`, such that you can use the lowercase `v` (as `-v`) for your purposes, like `--verbatim` or `--verbose`. This is in line with the common behavior of command-line programs. By setting `ARGPARSER_VERSION_OPTIONS` accordingly, you can of course change it to your needs, if desired.
...
The reference details the actual definitions of all [colors and styles](#72-colors-and-styles), [include directives](#73-include-directives), and [environment variables](#75-environment-variables). While it may be advantageous to read it once in its entirety to see all features not discussed in the [tutorial](#3-tutorial), it is more designed as manual for specific questions regarding certain features.
<!-- </section> -->
...
The values in multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#7512-argparser_arg_delimiter_2) character, by default a comma (`","`). Absence of value is indicated by the empty string, resulting after trimming spaces. That is, a field consisting of only spaces means absence.
...
The argument identifier must be a valid variable identifier in Bash syntax (at least when [`ARGPARSER_SET_ARGS`](#7538-argparser_set_args) is set to `true`, else, the ID is only used as key in associative arrays). These are defined as a word beginning with an alphabetic character or an underscore, followed by an arbitrary number of alphanumeric characters or underscores. In Bash's extglob syntax, the regular expression for verification may look like `[[:alpha:]_]*([[:word:]])`, assuming C locale.

#### 7.1.2. Short option names (`short_opts`)

The short option names must comprise exactly one character, thereby, no leading hyphen may be given. Multiple short option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#7512-argparser_arg_delimiter_2) character. Bash is case-sensitive, so is the checking for option names. Thus, you would need to provide both `a` and `A` as short option names if you want both to be recognized. This distinction effectively allows doubling the number of available short option names defined as letters (`a-z` and `A-Z`).

#### 7.1.3. Long option names (`long_opts`)

The long option names must comprise more than one character, thereby, no leading hyphen may be given. Multiple long option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#7512-argparser_arg_delimiter_2) character.
...
The help text should consist of a terse summary of the argument's function, like turning a feature on or off (which may be accomplished by flags), what a file is used for (like for input or output), or how your script's output may be modified. A help text can take any form, but be wary of it being wrapped to fit the width of the third column in the help message (if [`ARGPARSER_MAX_COL_WIDTH_3`](#7532-argparser_max_col_width_3) is non-zero) or the total line length ([`ARGPARSER_MAX_WIDTH`](#7533-argparser_max_width)). Help messages are no replacement for the manual, so the help text shouldn't be overly verbose.
<!-- </section> -->

<!-- <section file="reference/colors_and_styles.md"> -->
### 7.2. Colors and styles

The Argparser employs [Select Graphic Rendition (SGR) ANSI escape sequence codes](https://en.wikipedia.org/wiki/ANSI_escape_code#Select_Graphic_Rendition_parameters "wikipedia.org &rightarrow; ANSI escape code &rightarrow; Select Graphic Rendition parameters") to set the appearance of error, warning, help, usage, and version messages. To this end, five environment variable are defined, *viz.*, [`ARGPARSER_HELP_STYLE`](#7528-argparser_help_style), [`ARGPARSER_USAGE_STYLE`](#7553-argparser_usage_style), [`ARGPARSER_VERSION_STYLE`](#7560-argparser_version_style), [`ARGPARSER_ERROR_STYLE`](#7521-argparser_error_style), and [`ARGPARSER_WARNING_STYLE`](#7561-argparser_warning_style). Since the escape codes are nonprintable, not any terminal or text editor may support them. Many terminals do, while *e.g.* [`less`](https://man7.org/linux/man-pages/man1/less.1.html "man7.org &rightarrow; man pages &rightarrow; less(1)") has a dedicated flag, `--raw-control-chars`.
...
Six section names (include directives) are supported in the help and usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#7525-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#7548-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#7524-argparser_help_file) with the following content:
...
The `@<ArgumentGroup>` directive prints the help text for the respective `"<ArgumentGroup>"`, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#7534-argparser_positional_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#7524-argparser_help_file), denoting all arguments groups in the order preferred by you.
...
The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#7537-argparser_script_name), defaulting to your script's name. This should be given as first line.

#### 7.3.6. `@Help` directive

The `@Help` directive prints the help text for the `--help`, `--usage`, and `--version` flags (if added to the arguments definition by [`ARGPARSER_ADD_HELP`](#752-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#753-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#754-argparser_add_version)). Usually, you want to give this at the very end of all options.
<!-- </section> -->
...
- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#7534-argparser_positional_arg_group).

#### 7.4.2. `Help options`

- ***Description:*** The name of the help options' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_HELP_ARG_GROUP`](#7522-argparser_help_arg_group).
...
- ***Description:*** The remark that mandatory arguments to long options are mandatory for short options too, to be used in the help message for the [`@Remark`](#734-remark-directive) include directive.
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#7527-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#752-argparser_add_help) is set to `true`.

#### 7.4.12. `--usage`

- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#7552-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#753-argparser_add_usage) is set to `true`.

#### 7.4.13. `--version`

- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#7559-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#754-argparser_add_version) is set to `true`.
...
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#7516-argparser_check_env_vars) is set to `true`, the Argparser detected that an environment variable, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#7517-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value other than `true` and `false`.
...
- ***Description:*** The error that an environment variable refers to an undefined [color or style](#72-colors-and-styles).
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#7550-argparser_usage_message_option_type) is not set to `long` or `short`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#7516-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#7517-argparser_config_file), on the Argparser invokation command line, or as an environment variable, has a value other than `long` and `short`.
- ***Interpolated variables:***
  - `$1`: The environment variable's value.

#### 7.4.31. `Error env var orientation`

- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#7551-argparser_usage_message_orientation) is not set to `row` or `column`.
...
- ***Description:*** The error that the environment variables [`ARGPARSER_ARG_DELIMITER_1`](#7511-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#7512-argparser_arg_delimiter_2) have an identical value.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#7516-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variables `ARGPARSER_ARG_DELIMITER_1` and `ARGPARSER_ARG_DELIMITER_2`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#7517-argparser_config_file), on the Argparser invokation command line, or as an environment variable, have the same value, rendering parsing of the arguments definition impossible.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#7430-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#7555-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#7430-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#7554-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the Argparser, as [`ARGPARSER_SCRIPT_NAME`](#7537-argparser_script_name).

#### 7.4.41. `Error arg array 2`

- ***Description:*** The error that [`ARGPARSER_ARG_ARRAY_NAME`](#759-argparser_arg_array_name) refers to a variable that's not defined.
...
- ***Reasons for error:*** When reading the arguments definition, the Argparser found a definition line giving only an argument name, but no definition corresponding to this argument in the accompanying [`ARGPARSER_ARG_DEF_FILE`](#7510-argparser_arg_def_file).
- ***Interpolated variables:***
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#7537-argparser_script_name) with the problematic definition.

#### 7.4.45. `Error arg def file id`

- ***Description:*** The error that the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#7510-argparser_arg_def_file) lacks a column, instead giving an unused one.
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_ARG_DEF_FILE`](#7510-argparser_arg_def_file) with the problematic definition.
...
- ***Description:*** The error that in the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#7510-argparser_arg_def_file), the lines have differing field counts.
...
|------------------------------------------------------------------------------------|------------|--------------------------|
| [`ARGPARSER_ADD_HELP`](#752-argparser_add_help)                                    | *bool*     | `true`                   |
| [`ARGPARSER_ADD_USAGE`](#753-argparser_add_usage)                                  | *bool*     | `true`                   |
| [`ARGPARSER_ADD_VERSION`](#754-argparser_add_version)                              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_INVERSION`](#755-argparser_allow_flag_inversion)            | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_NEGATION`](#756-argparser_allow_flag_negation)              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#757-argparser_allow_option_abbreviation)  | *bool*     | `false`                  |
| [`ARGPARSER_ALLOW_OPTION_MERGING`](#758-argparser_allow_option_merging)            | *bool*     | `false`                  |
| [`ARGPARSER_ARG_ARRAY_NAME`](#759-argparser_arg_array_name)                        | *str*[^17] | `"args"`                 |
| [`ARGPARSER_ARG_DEF_FILE`](#7510-argparser_arg_def_file)                           | *file*     | `""`                     |
| [`ARGPARSER_ARG_DELIMITER_1`](#7511-argparser_arg_delimiter_1)                     | *char*     | `"\|"`[^18]              |
| [`ARGPARSER_ARG_DELIMITER_2`](#7512-argparser_arg_delimiter_2)                     | *char*     | `","`[^18]               |
| [`ARGPARSER_ARGPARSER_VERSION`](#7513-argparser_argparser_version)                 | *str*      | *None* (unset)           |
| [`ARGPARSER_ARGS`](#7514-argparser_args)                                           | *arr*      | *None* (unset)           |
| [`ARGPARSER_CHECK_ARG_DEF`](#7515-argparser_check_arg_def)                         | *bool*     | `false`                  |
| [`ARGPARSER_CHECK_ENV_VARS`](#7516-argparser_check_env_vars)                       | *bool*     | `false`                  |
| [`ARGPARSER_CONFIG_FILE`](#7517-argparser_config_file)                             | *file*     | `""`                     |
| [`ARGPARSER_COUNT_FLAGS`](#7518-argparser_count_flags)                             | *bool*     | `false`                  |
| [`ARGPARSER_DICTIONARY`](#7519-argparser_dictionary)                               | *dict*     | *None* (unset)           |
| [`ARGPARSER_ERROR_EXIT_CODE`](#7520-argparser_error_exit_code)                     | *int*      | `1`                      |
| [`ARGPARSER_ERROR_STYLE`](#7521-argparser_error_style)                             | *str*      | `"red,bold,reverse"`     |
| [`ARGPARSER_HELP_EXIT_CODE`](#7523-argparser_help_exit_code)                       | *int*      | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#7522-argparser_help_arg_group)                       | *str*      | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#7524-argparser_help_file)                                 | *file*     | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#7525-argparser_help_file_include_char)       | *char*     | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#7526-argparser_help_file_keep_comments)     | *bool*     | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#7527-argparser_help_options)                           | *char*     | `"h,?"`                  |
| [`ARGPARSER_HELP_STYLE`](#7528-argparser_help_style)                               | *str*      | `"italic"`               |
| [`ARGPARSER_LANGUAGE`](#7529-argparser_language)                                   | *str*      | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#7530-argparser_max_col_width_1)                     | *uint*     | `5`[^19]                 |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#7531-argparser_max_col_width_2)                     | *uint*     | `33`[^19]                |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#7532-argparser_max_col_width_3)                     | *uint*     | `0`[^19]                 |
| [`ARGPARSER_MAX_WIDTH`](#7533-argparser_max_width)                                 | *uint*     | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#7534-argparser_positional_arg_group)           | *str*      | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#7535-argparser_read_args)                                 | *bool*     | `true`                   |
| [`ARGPARSER_SCRIPT_ARGS`](#7536-argparser_script_args)                             | *arr*      | *None* (unset)           |
| [`ARGPARSER_SCRIPT_NAME`](#7537-argparser_script_name)                             | *str*      | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#7538-argparser_set_args)                                   | *bool*     | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#7539-argparser_set_arrays)                               | *bool*     | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#7540-argparser_silence_errors)                       | *bool*     | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#7541-argparser_silence_warnings)                   | *bool*     | `false`                  |
| [`ARGPARSER_TRANSLATION_FILE`](#7542-argparser_translation_file)                   | *file*     | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#7543-argparser_unset_args)                               | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#7544-argparser_unset_env_vars)                       | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#7545-argparser_unset_functions)                     | *bool*     | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#7546-argparser_usage_exit_code)                     | *int*      | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#7547-argparser_usage_file)                               | *file*     | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#7548-argparser_usage_file_include_char)     | *char*     | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#7549-argparser_usage_file_keep_comments)   | *bool*     | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#7550-argparser_usage_message_option_type) | *str*      | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#7551-argparser_usage_message_orientation) | *str*      | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#7552-argparser_usage_options)                         | *char*     | `"u"`                    |
| [`ARGPARSER_USAGE_STYLE`](#7553-argparser_usage_style)                             | *str*      | `"italic"`               |
| [`ARGPARSER_USE_LONG_OPTIONS`](#7554-argparser_use_long_options)                   | *bool*     | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#7555-argparser_use_short_options)                 | *bool*     | `true`                   |
| [`ARGPARSER_USE_STYLES_IN_FILES`](#7556-argparser_use_styles_in_files)             | *bool*     | `false`                  |
| [`ARGPARSER_VERSION`](#7557-argparser_version)                                     | *str*      | `"1.0.0"`                |
| [`ARGPARSER_VERSION_EXIT_CODE`](#7558-argparser_version_exit_code)                 | *int*      | `0`                      |
| [`ARGPARSER_VERSION_OPTIONS`](#7559-argparser_version_options)                     | *char*     | `"V"`                    |
| [`ARGPARSER_VERSION_STYLE`](#7560-argparser_version_style)                         | *str*      | `"bold"`                 |
| [`ARGPARSER_WARNING_STYLE`](#7561-argparser_warning_style)                         | *str*      | `"red,bold"`             |
| [`ARGPARSER_WRITE_ARGS`](#7562-argparser_write_args)                               | *bool*     | `false`                  |
