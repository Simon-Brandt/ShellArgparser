...
1. [Reference](#9-reference)
   ...
   1. [Translations](#95-translations)
      ...
      1. [`Error style file styles`](#95125-error-style-file-styles)
      1. [`Error include directive`](#95126-error-include-directive)
      1. [`Warning no identifier`](#95127-warning-no-identifier)
      1. [`Warning no translation`](#95128-warning-no-translation)
      1. [`Warning style file message key`](#95129-warning-style-file-message-key)
      1. [`Warning deprecation`](#95130-warning-deprecation)
      1. [`Warning wrong arg number 1`](#95131-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#95132-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#95133-warning-wrong-arg-number-3)
      1. [`Warning wrong arg number 4`](#95134-warning-wrong-arg-number-4)
<!-- </toc> -->
<!-- </section> -->
...
- ***Description:*** The error that a style file's line refers to an undefined [color or style](#92-colors-and-styles).
- ***Reasons for error:*** When parsing the [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file), the Argparser found a line trying to set a message color or style which does not exist.
- ***Interpolated variables:***
