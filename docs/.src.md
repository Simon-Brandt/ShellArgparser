...
1. [Tutorial](#5-tutorial)
   1. [Argument passing](#51-argument-passing)
      ...
      1. [Flags](#515-flags)
   1. [Argparser invocation](#52-argparser-invocation)
   ...
   1. [Standalone usage](#511-standalone-usage)
      ...
      1. [Invocation from other shells](#5112-invocation-from-other-shells)
...
1. [Roadmap](#7-roadmap)
   ...
   1. [Release notes](#72-release-notes)
   ...
   1. [Future enhancements](#73-future-enhancements)
      1. [Argument relations](#731-argument-relations)
      1. [Environment variables and configuration files](#732-environment-variables-and-configuration-files)
      1. [Single-hyphen long options](#733-single-hyphen-long-options)
      1. [Usage message include directives](#734-usage-message-include-directives)
      1. [License note](#735-license-note)
      1. [Programmable argument completion](#736-programmable-argument-completion)
      1. [POSIX compliance](#737-posix-compliance)
      1. [Alternative option prefixes (`+`/`/`)](#738-alternative-option-prefixes-)
   1. [Known bugs](#74-known-bugs)
   1. [Deprecations and removals](#75-deprecations-and-removals)
...
1. [Reference](#9-reference)
   ...
   1. [Environment variables](#94-environment-variables)
      ...
      1. [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#948-argparser_allow_option_abbreviation)
      ...
      1. [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file)
      1. [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#9445-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#9446-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#9447-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#9448-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#9449-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#9450-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#9451-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9452-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#9453-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#9454-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#9455-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#9456-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#9457-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES`](#9458-argparser_use_styles)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#9459-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#9460-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_NUMBER`](#9461-argparser_version_number)
      1. [`ARGPARSER_VERSION_OPTIONS`](#9462-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#9463-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#9464-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#9465-argparser_write_args)
   1. [Translations](#95-translations)
      ...
      1. [`Error`](#954-error)
      1. [`Errors`](#955-errors)
      1. [`Warning`](#956-warning)
      1. [`Warnings`](#957-warnings)
      1. [`Usage`](#958-usage)
      1. [`Arguments`](#959-arguments)
      1. [`Options`](#9510-options)
      1. [`Mandatory arguments`](#9511-mandatory-arguments)
      1. [`Deprecated`](#9512-deprecated)
      1. [`Default`](#9513-default)
      1. [`--help`](#9514---help)
      1. [`--usage`](#9515---usage)
      1. [`--version`](#9516---version)
      1. [`false`](#9517-false)
      1. [`true`](#9518-true)
      1. [`Error env var bool`](#9519-error-env-var-bool)
      1. [`Error env var char`](#9520-error-env-var-char)
      1. [`Error env var identifier`](#9521-error-env-var-identifier)
      1. [`Error env var int`](#9522-error-env-var-int)
      1. [`Error env var uint`](#9523-error-env-var-uint)
      1. [`Error env var file 0001`](#9524-error-env-var-file-0001)
      1. [`Error env var file 0010`](#9525-error-env-var-file-0010)
      1. [`Error env var file 0011`](#9526-error-env-var-file-0011)
      1. [`Error env var file 0100`](#9527-error-env-var-file-0100)
      1. [`Error env var file 0101`](#9528-error-env-var-file-0101)
      1. [`Error env var file 0110`](#9529-error-env-var-file-0110)
      1. [`Error env var file 0111`](#9530-error-env-var-file-0111)
      1. [`Error env var file 1111`](#9531-error-env-var-file-1111)
      1. [`Error env var delimiters reserved`](#9532-error-env-var-delimiters-reserved)
      1. [`Error env var styles`](#9533-error-env-var-styles)
      1. [`Error env var style usage`](#9534-error-env-var-style-usage)
      1. [`Error env var option type`](#9535-error-env-var-option-type)
      1. [`Error env var orientation`](#9536-error-env-var-orientation)
      1. [`Error env var delimiters identical`](#9537-error-env-var-delimiters-identical)
      1. [`Error env var short name empty`](#9538-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#9539-error-env-var-short-name-length)
      1. [`Error env var short name duplication 1`](#9540-error-env-var-short-name-duplication-1)
      1. [`Error env var short name duplication 2`](#9541-error-env-var-short-name-duplication-2)
      1. [`Error env var short options`](#9542-error-env-var-short-options)
      1. [`Error env var long options`](#9543-error-env-var-long-options)
      1. [`Error env var files`](#9544-error-env-var-files)
      1. [`Error arg array 1`](#9545-error-arg-array-1)
      1. [`Error arg array 2`](#9546-error-arg-array-2)
      1. [`Error arg array 3`](#9547-error-arg-array-3)
      1. [`Error no arg def`](#9548-error-no-arg-def)
      1. [`Error arg def id`](#9549-error-arg-def-id)
      1. [`Error arg def file id`](#9550-error-arg-def-file-id)
      1. [`Error arg def field count`](#9551-error-arg-def-field-count)
      1. [`Error arg def file field count`](#9552-error-arg-def-file-field-count)
      1. [`Error arg def choice range hyphens`](#9553-error-arg-def-choice-range-hyphens)
      1. [`Error arg def choice range`](#9554-error-arg-def-choice-range)
      1. [`Error arg def short name empty`](#9555-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#9556-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#9557-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#9558-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#9559-error-arg-def-short-name-length)
      1. [`Error arg def short name duplication 1`](#9560-error-arg-def-short-name-duplication-1)
      1. [`Error arg def short name duplication 2`](#9561-error-arg-def-short-name-duplication-2)
      1. [`Error arg def long name empty`](#9562-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#9563-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#9564-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#9565-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#9566-error-arg-def-long-name-length)
      1. [`Error arg def long name duplication 1`](#9567-error-arg-def-long-name-duplication-1)
      1. [`Error arg def long name duplication 2`](#9568-error-arg-def-long-name-duplication-2)
      1. [`Error arg def pos default flag`](#9569-error-arg-def-pos-default-flag)
      1. [`Error arg def pos default 1`](#9570-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#9571-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice true`](#9572-error-arg-def-pos-choice-true)
      1. [`Error arg def pos choice default`](#9573-error-arg-def-pos-choice-default)
      1. [`Error arg def pos optionals`](#9574-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#9575-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#9576-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#9577-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#9578-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#9579-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#9580-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#9581-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#9582-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#9583-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#9584-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#9585-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#9586-error-arg-def-pos-note)
      1. [`Error arg def option default flag`](#9587-error-arg-def-option-default-flag)
      1. [`Error arg def option default 1`](#9588-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#9589-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#9590-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice true`](#9591-error-arg-def-option-choice-true)
      1. [`Error arg def option choice default`](#9592-error-arg-def-option-choice-default)
      1. [`Error arg def option type`](#9593-error-arg-def-option-type)
      1. [`Error arg def option bool`](#9594-error-arg-def-option-bool)
      1. [`Error arg def option char`](#9595-error-arg-def-option-char)
      1. [`Error arg def option float`](#9596-error-arg-def-option-float)
      1. [`Error arg def option int`](#9597-error-arg-def-option-int)
      1. [`Error arg def option uint`](#9598-error-arg-def-option-uint)
      1. [`Error arg def option note`](#9599-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#95100-error-arg-double-hyphen)
      1. [`Error arg double plus`](#95101-error-arg-double-plus)
      1. [`Error arg inversion`](#95102-error-arg-inversion)
      1. [`Error arg unknown`](#95103-error-arg-unknown)
      1. [`Error long option match`](#95104-error-long-option-match)
      1. [`Error long option negation`](#95105-error-long-option-negation)
      1. [`Error long option unknown`](#95106-error-long-option-unknown)
      1. [`Error short option merge`](#95107-error-short-option-merge)
      1. [`Error short option unknown`](#95108-error-short-option-unknown)
      1. [`Error pos arg count 1`](#95109-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#95110-error-pos-arg-count-2)
      1. [`Error arg no flag 1`](#95111-error-arg-no-flag-1)
      1. [`Error arg no flag 2`](#95112-error-arg-no-flag-2)
      1. [`Error arg no flag 3`](#95113-error-arg-no-flag-3)
      1. [`Error mandatory arg`](#95114-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#95115-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#95116-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#95117-error-wrong-arg-number-3)
      1. [`Error wrong arg number 4`](#95118-error-wrong-arg-number-4)
      1. [`Error arg choice`](#95119-error-arg-choice)
      1. [`Error arg bool`](#95120-error-arg-bool)
      1. [`Error arg char`](#95121-error-arg-char)
      1. [`Error arg float`](#95122-error-arg-float)
      1. [`Error arg int`](#95123-error-arg-int)
      1. [`Error arg uint`](#95124-error-arg-uint)
      1. [`Error YAML`](#95125-error-yaml)
      1. [`Error style file equals sign`](#95126-error-style-file-equals-sign)
      1. [`Error style file frame styles`](#95127-error-style-file-frame-styles)
      1. [`Error style file text styles`](#95128-error-style-file-text-styles)
      1. [`Error include directive`](#95129-error-include-directive)
      1. [`Warning no identifier`](#95130-warning-no-identifier)
      1. [`Warning no translation`](#95131-warning-no-translation)
      1. [`Warning style file message key`](#95132-warning-style-file-message-key)
      1. [`Warning deprecation`](#95133-warning-deprecation)
      1. [`Warning wrong arg number 1`](#95134-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#95135-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#95136-warning-wrong-arg-number-3)
      1. [`Warning wrong arg number 4`](#95137-warning-wrong-arg-number-4)
<!-- </toc> -->
<!-- </section> -->
...
<!-- <section file="tutorial/argparser_invocation.md"> -->
...
The arguments are separated by their groups, thus structuring the help message. First, the group for the positional arguments is given (indicated by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#9436-argparser_positional_arg_group)), then follow the keyword argument groups in alphabetical order. Finally, the default `--help`, `--usage`, and `--version` arguments (the latter for the [version message](#58-version-messages)) are given as separate group (indicated by [`ARGPARSER_HELP_ARG_GROUP`](#9423-argparser_help_arg_group)).
...
Alternatively, you may want to set [`ARGPARSER_MAX_WIDTH`](#9435-argparser_max_width). By this, the help message will have a defined width, independent of shrunk columns. This is achieved by expanding the third column (with the help text) to the remaining width. For this to work, [`ARGPARSER_MAX_COL_WIDTH_3`](#9434-argparser_max_col_width_3) must be set to `0`.
...
For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#9453-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9452-argparser_usage_message_option_type):
...
Additionally, we need a separate file, which we'll call [`help_message.txt`](../resources/help_message.txt) and have passed as value to [`ARGPARSER_HELP_FILE`](#9426-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
Further, lines starting with a `"#"` character in the help file aren't printed if [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#9428-argparser_help_file_keep_comments) is set to `false` (the default). This allows you to comment your help file, perhaps to explain the structure&mdash;or just to write a header or footer with your name and debug email address inside.

The same as for help messages can be done for usage messages, using the [`ARGPARSER_USAGE_FILE`](#9449-argparser_usage_file), [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#9450-argparser_usage_file_include_char), and [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#9451-argparser_usage_file_keep_comments) environment variables. However there, only the `@All` directive is supported, yet.  Further, since there are no sections, the include character cannot be doubled.
<!-- </section> -->

<!-- <section file="tutorial/help_and_usage_message_localization.md"> -->
### 5.7. Help and usage message localization

It is even possible to localize your script's help and usage message. For the usage message, all you need is an [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file), a simplified [YAML](https://en.wikipedia.org/wiki/YAML "wikipedia.org &rightarrow; YAML") file giving the translation of the auto-generated parts in the messages. For each section, you give the language identifier for the language you want the message to be translated to, *i.e.*, the [`ARGPARSER_LANGUAGE`](#9431-argparser_language). For the usage message, this suffices, but in the help message, also non-auto-generated parts are included, especially each argument's help text. For them to be translated, you need a dedicated [`ARGPARSER_ARG_DEF_FILE`](#9411-argparser_arg_def_file) and possibly a localized [`ARGPARSER_HELP_FILE`](#9426-argparser_help_file).
...
Besides the [`ARGPARSER_HELP_OPTIONS`](#9429-argparser_help_options), `--help`, the [`ARGPARSER_USAGE_OPTIONS`](#9454-argparser_usage_options), and `--usage`, there is a third option intended to help the user, the [`ARGPARSER_VERSION_OPTIONS`](#9462-argparser_version_options) (default: `-V`) and `--version`. This flag compiles a brief version message for your script, showing its canonical name (the [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name)) and the version number (the [`ARGPARSER_VERSION_NUMBER`](#9461-argparser_version_number)). Just as for the help and usage messages, you can disable the version message (and its corresponding flags) by setting [`ARGPARSER_ADD_VERSION`](#944-argparser_add_version) to `false`. Note that the default short option name is an uppercase `"V"`, such that you can use the lowercase `"v"` (as `-v`) for your purposes, like `--verbatim` or `--verbose`. This is in line with the common behavior of command-line programs. By setting `ARGPARSER_VERSION_OPTIONS` accordingly, you can of course change it to your needs, if desired.
...
The Argparser outputs about a hundred different error and warning messages to give both you and your script's user as detailled feedback as possible about what went wrong with the argument parsing, value checking, *etc.* Each message starts with your script's canonical name (the [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name)), followed by either `"Error:"` or `"Warning:"` and the respective message. Using the same simplified [YAML](https://en.wikipedia.org/wiki/YAML "wikipedia.org &rightarrow; YAML") file as for the help and usage messages (the [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file)), also the error and warning messages can be fully localized.
...
For the default values currently in use, refer to the [reference](#92-colors-and-styles). You may also want to have a look at the template [`styles.cfg`](../resources/styles.cfg), where frames are employed.
<!-- </section> -->
...
- Deprecations with removal in `v2.0.0`:
  - [`ARGPARSER_USE_STYLES_IN_FILES`](#9459-argparser_use_styles_in_files) has been replaced by [`ARGPARSER_USE_STYLES`](#9458-argparser_use_styles) in `v1.3.0`, which now also offers disabling message stylizations for terminals or both terminals and files. The old behavior of `ARGPARSER_USE_STYLES_IN_FILES` (with `true` and `false` as possible values) can be accessed by setting `ARGPARSER_USE_STYLES` to `always` (`true`) or `tty` (`false`), respectively.
  - [`ARGPARSER_HELP_STYLE`](#9430-argparser_help_style), [`ARGPARSER_USAGE_STYLE`](#9455-argparser_usage_style), [`ARGPARSER_VERSION_STYLE`](#9463-argparser_version_style), [`ARGPARSER_ERROR_STYLE`](#9422-argparser_error_style), and [`ARGPARSER_WARNING_STYLE`](#9464-argparser_warning_style) have been superseded by more fine-grained stylization possibilities in `v1.3.0`, optionally using an [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file). Even though the environment variables only affect the visual appearance of the help, usage, version, error, and warning messages, which are excluded from SemVer, keeping them active until `v2.0.0` does little or no harm. While deprecated, they can still be set and will override the default styles *and* the style file's styles.  
  Due to how the new styles are implemented, the visual output is not entirely identical, but close to the previous workings. Particularly, the [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name) is needed in all five message types, but set *via* the same message key (`script_name`). Thus, when either of `ARGPARSER_HELP_STYLE`, `ARGPARSER_USAGE_STYLE`, `ARGPARSER_VERSION_STYLE`, `ARGPARSER_ERROR_STYLE`, or `ARGPARSER_WARNING_STYLE`, in this order, is set, its style definition overrides the latter ones' for the script name. Further, the help style overrides the usage style, if both are given, since they also share all message keys.
<!-- </section> -->
...
The values in multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#9413-argparser_arg_delimiter_2) character, by default a comma (`","`). The absence of a value is indicated by the empty string, resulting after trimming spaces. That is, a field consisting of only spaces means absence.
...
The argument identifier must be a valid variable identifier in Bash syntax (at least when [`ARGPARSER_SET_ARGS`](#9439-argparser_set_args) is set to `true`, else, the ID is only used as key in associative arrays). These are defined as a word beginning with an alphabetic character or an underscore, followed by an arbitrary number of alphanumeric characters or underscores. In Bash's extglob syntax, the regular expression for verification may look like `[[:alpha:]_]*([[:word:]])`, assuming C locale.

#### 9.1.2. Short option names (`short_opts`)

The short option names must comprise exactly one character, thereby, no leading hyphen may be given. Multiple short option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#9413-argparser_arg_delimiter_2) character. Bash is case-sensitive, so is the checking for option names. Thus, you would need to provide both `a` and `A` as short option names if you want both to be recognized. This distinction effectively allows doubling the number of available short option names defined as letters (`a-z` and `A-Z`).

#### 9.1.3. Long option names (`long_opts`)

The long option names must comprise more than one character, thereby, no leading hyphen may be given. Multiple long option names that shall be treated as aliases for the same option must be separated by an [`ARGPARSER_ARG_DELIMITER_2`](#9413-argparser_arg_delimiter_2) character.
...
The help text should consist of a terse summary of the argument's function, like turning a feature on or off (which may be accomplished by flags), what a file is used for (like for input or output), or how your script's output may be modified. A help text can take any form, but be wary of it being wrapped to fit the width of the third column in the help message (if [`ARGPARSER_MAX_COL_WIDTH_3`](#9434-argparser_max_col_width_3) is non-zero) or the total line length ([`ARGPARSER_MAX_WIDTH`](#9435-argparser_max_width)). Help messages are no replacement for the manual, so the help text shouldn't be overly verbose.
<!-- </section> -->

<!-- <section file="reference/colors_and_styles.md"> -->
### 9.2. Colors and styles

The Argparser employs [Select Graphic Rendition (SGR) ANSI escape sequence codes](https://en.wikipedia.org/wiki/ANSI_escape_code#Select_Graphic_Rendition_parameters "wikipedia.org &rightarrow; ANSI escape code &rightarrow; Select Graphic Rendition parameters") to set the appearance of help, usage, version, error, and warning messages. To this end, you can use an [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file) or fall back to the Argparser's default colors and styles. The five environment variables previously used for stylization, *viz.* [`ARGPARSER_HELP_STYLE`](#9430-argparser_help_style), [`ARGPARSER_USAGE_STYLE`](#9455-argparser_usage_style), [`ARGPARSER_VERSION_STYLE`](#9463-argparser_version_style), [`ARGPARSER_ERROR_STYLE`](#9422-argparser_error_style), and [`ARGPARSER_WARNING_STYLE`](#9464-argparser_warning_style), are deprecated and will be removed in `v2.0.0`, in favor of the more fine-grained control the style file offers.
...
Six section names (include directives) are supported in the help files, and one (`@All`) in the usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#9427-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#9450-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#9426-argparser_help_file) with the following content:
...
Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#9436-argparser_positional_arg_group)) and succeeded by the help options group (the [`ARGPARSER_HELP_ARG_GROUP`](#9423-argparser_help_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#9426-argparser_help_file), denoting all arguments groups in the order preferred by you.

By using one [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#9427-argparser_help_file_include_char), the arguments group's arguments are preceded by the group's name as section heading. You can double the include character to suppress this addition.

#### 9.3.3. `@Description` directive

The `@Description` directive prints the contents of [`ARGPARSER_HELP_DESCRIPTION`](#9424-argparser_help_description), wrapped to fit [`ARGPARSER_MAX_WIDTH`](#9435-argparser_max_width). If `ARGPARSER_HELP_DESCRIPTION` is empty (the default), nothing is printed.
...
The `@Help` directive prints the help text for the `--help`, `--usage`, and `--version` flags (if added to the arguments definition by [`ARGPARSER_ADD_HELP`](#942-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#943-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#944-argparser_add_version)). Usually, you want to give this at the very end of all options.  Again, you can suppress the [`ARGPARSER_HELP_ARG_GROUP`](#9423-argparser_help_arg_group) heading by doubling the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#9427-argparser_help_file_include_char), which is also the default behaviour within the [`@All`](#931-all-directive) include directive (and thus the default when not using help files).

#### 9.3.6. `@Remark` directive

The `@Remark` directive prints the note that mandatory arguments to long options are mandatory for short options too, wrapped to fit [`ARGPARSER_MAX_WIDTH`](#9435-argparser_max_width). This should be given just before all arguments.

#### 9.3.7. `@Usage` directive

The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name), defaulting to your script's name. This should be given as first line.
<!-- </section> -->
...
| [`ARGPARSER_ALLOW_ARG_INTERMIXING`](#945-argparser_allow_arg_intermixing)          | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_INVERSION`](#946-argparser_allow_flag_inversion)            | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_NEGATION`](#947-argparser_allow_flag_negation)              | *bool*     | `true`                   |
| [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#948-argparser_allow_option_abbreviation)  | *bool*     | `false`                  |
| [`ARGPARSER_ALLOW_OPTION_MERGING`](#949-argparser_allow_option_merging)            | *bool*     | `false`                  |
| [`ARGPARSER_ARG_ARRAY_NAME`](#9410-argparser_arg_array_name)                       | *str*[^17] | `"args"`                 |
| [`ARGPARSER_ARG_DEF_FILE`](#9411-argparser_arg_def_file)                           | *file*     | `""`                     |
| [`ARGPARSER_ARG_DELIMITER_1`](#9412-argparser_arg_delimiter_1)                     | *char*     | `"\|"`[^18]              |
| [`ARGPARSER_ARG_DELIMITER_2`](#9413-argparser_arg_delimiter_2)                     | *char*     | `","`[^18]               |
| [`ARGPARSER_ARGS`](#9414-argparser_args)                                           | *arr*      | *None* (unset)           |
| [`ARGPARSER_CHECK_ARG_DEF`](#9415-argparser_check_arg_def)                         | *bool*     | `false`                  |
| [`ARGPARSER_CHECK_ENV_VARS`](#9416-argparser_check_env_vars)                       | *bool*     | `false`                  |
| [`ARGPARSER_CONFIG_FILE`](#9417-argparser_config_file)                             | *file*     | `""`                     |
| [`ARGPARSER_COUNT_FLAGS`](#9418-argparser_count_flags)                             | *bool*     | `false`                  |
| [`ARGPARSER_CREATE_ARG_DEF`](#9419-argparser_create_arg_def)                       | *bool*     | `false`                  |
| [`ARGPARSER_DEBUG`](#9420-argparser_debug)                                         | *bool*     | `false`                  |
| [`ARGPARSER_ERROR_EXIT_CODE`](#9421-argparser_error_exit_code)                     | *int*      | `1`                      |
| ~~[`ARGPARSER_ERROR_STYLE`](#9422-argparser_error_style)~~ [^19]                   | ~~*str*~~  | ~~`"red,bold,reverse"`~~ |
| [`ARGPARSER_HELP_EXIT_CODE`](#9425-argparser_help_exit_code)                       | *int*      | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#9423-argparser_help_arg_group)                       | *str*      | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#9426-argparser_help_file)                                 | *file*     | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#9427-argparser_help_file_include_char)       | *char*     | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#9428-argparser_help_file_keep_comments)     | *bool*     | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#9429-argparser_help_options)                           | *char*     | `"h,?"`                  |
| ~~[`ARGPARSER_HELP_STYLE`](#9430-argparser_help_style)~~ [^19]                     | ~~*str*~~  | ~~`"italic"`~~           |
| [`ARGPARSER_LANGUAGE`](#9431-argparser_language)                                   | *str*      | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#9432-argparser_max_col_width_1)                     | *uint*     | `9`[^20]                 |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#9433-argparser_max_col_width_2)                     | *uint*     | `33`[^20]                |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#9434-argparser_max_col_width_3)                     | *uint*     | `0`[^20]                 |
| [`ARGPARSER_MAX_WIDTH`](#9435-argparser_max_width)                                 | *uint*     | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#9436-argparser_positional_arg_group)           | *str*      | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#9437-argparser_read_args)                                 | *bool*     | `true`                   |
| [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name)                             | *str*      | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#9439-argparser_set_args)                                   | *bool*     | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#9440-argparser_set_arrays)                               | *bool*     | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#9441-argparser_silence_errors)                       | *bool*     | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#9442-argparser_silence_warnings)                   | *bool*     | `false`                  |
| [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file)                               | *file*     | `""`                     |
| [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file)                   | *file*     | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#9445-argparser_unset_args)                               | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#9446-argparser_unset_env_vars)                       | *bool*     | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#9447-argparser_unset_functions)                     | *bool*     | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#9448-argparser_usage_exit_code)                     | *int*      | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#9449-argparser_usage_file)                               | *file*     | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#9450-argparser_usage_file_include_char)     | *char*     | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#9451-argparser_usage_file_keep_comments)   | *bool*     | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9452-argparser_usage_message_option_type) | *str*      | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#9453-argparser_usage_message_orientation) | *str*      | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#9454-argparser_usage_options)                         | *char*     | `"u"`                    |
| ~~[`ARGPARSER_USAGE_STYLE`](#9455-argparser_usage_style)~~ [^19]                   | ~~*str*~~  | ~~`"italic"`~~           |
| [`ARGPARSER_USE_LONG_OPTIONS`](#9456-argparser_use_long_options)                   | *bool*     | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#9457-argparser_use_short_options)                 | *bool*     | `true`                   |
| [`ARGPARSER_USE_STYLES`](#9458-argparser_use_styles)                               | *str*      | `"tty"`                  |
| ~~[`ARGPARSER_USE_STYLES_IN_FILES`](#9459-argparser_use_styles_in_files)~~ [^19]   | ~~*bool*~~ | ~~`false`~~              |
| [`ARGPARSER_VERSION_EXIT_CODE`](#9460-argparser_version_exit_code)                 | *int*      | `0`                      |
| [`ARGPARSER_VERSION_NUMBER`](#9461-argparser_version_number)                       | *str*      | `"1.0.0"`                |
| [`ARGPARSER_VERSION_OPTIONS`](#9462-argparser_version_options)                     | *char*     | `"V"`                    |
| ~~[`ARGPARSER_VERSION_STYLE`](#9463-argparser_version_style)~~ [^19]               | ~~*str*~~  | ~~`"bold"`~~             |
| ~~[`ARGPARSER_WARNING_STYLE`](#9464-argparser_warning_style)~~ [^19]               | ~~*str*~~  | ~~`"red,bold"`~~         |
| [`ARGPARSER_WRITE_ARGS`](#9465-argparser_write_args)                               | *bool*     | `false`                  |
...
[^20]: Sum of values is recommended to be 77, except when [`ARGPARSER_MAX_COL_WIDTH_3`](#9434-argparser_max_col_width_3) is `0`.
<!-- </section> -->
...
- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#9436-argparser_positional_arg_group).

#### 9.5.2. `Help options`

- ***Message:*** `Help options`
- ***Description:*** The name of the help options' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_HELP_ARG_GROUP`](#9423-argparser_help_arg_group).

#### 9.5.3. `Help description`

- ***Message:*** `""`
- ***Description:*** The script's description, indicating its purpose in the help message, *i.e.*, the translated [`ARGPARSER_HELP_DESCRIPTION`](#9424-argparser_help_description). The value is empty by default, and hence also the translations.
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#9429-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#942-argparser_add_help) is set to `true`.

#### 9.5.15. `--usage`

- ***Message:*** `display the usage and exit`
- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#9454-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#943-argparser_add_usage) is set to `true`.

#### 9.5.16. `--version`

- ***Message:*** `display the version and exit`
- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#9462-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#944-argparser_add_version) is set to `true`.
...
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#9416-argparser_check_env_vars) is set to `true`, the Argparser detected that an environment variable, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#9417-argparser_config_file), on the Argparser invocation command line, or as an environment variable, has a value not according to the data type `bool`. These Boolean values must be either `true` or `false`.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USE_STYLES`](#9458-argparser_use_styles) is not set to `always`, `never`, `file`, or `tty`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#9416-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variable `ARGPARSER_USE_STYLES`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#9417-argparser_config_file), on the Argparser invocation command line, or as an environment variable, has a value other than `always`, `never`, `file`, and `tty`. Since there are only files and TTYs where the help, usage, version, error, and warning messages may be redirected to, other values are refused.
- ***Interpolated variables:***
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9452-argparser_usage_message_option_type) is not set to `long` or `short`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#9416-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#9417-argparser_config_file), on the Argparser invocation command line, or as an environment variable, has a value other than `long` and `short`. Since there are only short and long option names possible, other values are refused.
- ***Interpolated variables:***
  - `$1`: The environment variable's value.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#9453-argparser_usage_message_orientation) is not set to `row` or `column`.
...
- ***Description:*** The error that the environment variables [`ARGPARSER_ARG_DELIMITER_1`](#9412-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#9413-argparser_arg_delimiter_2) have an identical value.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#9416-argparser_check_env_vars) is set to `true`, the Argparser detected that the environment variables `ARGPARSER_ARG_DELIMITER_1` and `ARGPARSER_ARG_DELIMITER_2`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#9417-argparser_config_file), on the Argparser invocation command line, or as an environment variable, have the same value. This renders parsing of the arguments definition impossible, as multi-value fields cannot be told apart from column delimiters.
- ***Interpolated variables:***
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9535-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#9457-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9535-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#9456-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the Argparser, as [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name).
...
- ***Description:*** The error that [`ARGPARSER_ARG_ARRAY_NAME`](#9410-argparser_arg_array_name) refers to a variable that's not defined.
...
- ***Reasons for error:*** When reading the arguments definition, the Argparser found a definition line giving only an argument name, but no definition corresponding to this argument in the accompanying [`ARGPARSER_ARG_DEF_FILE`](#9411-argparser_arg_def_file).
- ***Interpolated variables:***
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#9438-argparser_script_name) with the problematic definition.

#### 9.5.50. `Error arg def file id`

- ***Message:*** `Error: In the arguments definition file "$1", the column "id" is missing.`
- ***Description:*** The error that the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#9411-argparser_arg_def_file) lacks a column, instead giving an unused one.
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_ARG_DEF_FILE`](#9411-argparser_arg_def_file) with the problematic definition.
...
- ***Description:*** The error that in the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#9411-argparser_arg_def_file), the lines have differing field counts.
...
- ***Reasons for error:*** When parsing the command line, the Argparser found an option that starts with a plus sign, meaning the intention to invert the flag, but [`ARGPARSER_ALLOW_FLAG_INVERSION`](#946-argparser_allow_flag_inversion) is set to `false`. This removes the ability to use the `+` prefix.
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#948-argparser_allow_option_abbreviation) is set to `true`, the Argparser found a long option being abbreviated, but matching more than one defined long option in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_FLAG_NEGATION`](#947-argparser_allow_flag_negation) is set to `true`, the Argparser found a long option starting with `--no-`, but the remaining (affirmative) version has not been defined in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the command line and [`ARGPARSER_ALLOW_OPTION_MERGING`](#949-argparser_allow_option_merging) is set to `true`, the Argparser found a short option, merged with others, that has not been defined in the arguments definition.
- ***Interpolated variables:***
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file), the Argparser found a YAML line that it doesn't recognize. This is most likely due to a YAML feature that the Argparser doesn't support to keep the parser simple.
- ***Interpolated variables:***
  - `$1`: The YAML line.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file), the Argparser found a line that it doesn't recognize. Each line must contain key&ndash;value pairs, delimited by an equals sign (`"="`), or be entirely empty, or start with a hashmark (`"#"`), indicating the line to be commented.
- ***Interpolated variables:***
  - `$1`: The style file.
  - `$2`: The line.
...
- ***Description:*** The error that a style file's line refers to an undefined [color or frame style](#92-colors-and-styles).
- ***Reasons for error:*** When parsing the [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file), the Argparser found a line trying to set a frame color or frame style which does not exist.
- ***Interpolated variables:***
...
- ***Description:*** The error that a style file's line refers to an undefined [color or text style](#92-colors-and-styles).
- ***Reasons for error:*** When parsing the [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file), the Argparser found a line trying to set a text/message color or text/message style which does not exist.
- ***Interpolated variables:***
  - `$1`: The style's message key.
  - `$2`: The style.
...
- ***Reasons for error:*** When parsing the [`ARGPARSER_HELP_FILE`](#9426-argparser_help_file) or [`ARGPARSER_USAGE_FILE`](#9449-argparser_usage_file), the Argparser found an include directive that is not supported.
- ***Interpolated variables:***
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file), the Argparser found that the identifier is missing in the dictionary, and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file).
...
- ***Reasons for warning:*** When trying to translate a string from the [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file), the Argparser found that the translation to the [`ARGPARSER_LANGUAGE`](#9431-argparser_language) for the identifier is missing in the dictionary, and by this, also in the translation file. Thus, it uses the untranslated English string as fallback.
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_TRANSLATION_FILE`](#9444-argparser_translation_file).
  - `$2`: The [`ARGPARSER_LANGUAGE`](#9431-argparser_language).
...
- ***Reasons for warning:*** When parsing the [`ARGPARSER_STYLE_FILE`](#9443-argparser_style_file), the Argparser found a line that sets a message key (the part before the equals sign) which the Argparser never uses, and which is thus unnecessary to give.
- ***Interpolated variables:***
  - `$1`: The style file.
  - `$2`: The line.
