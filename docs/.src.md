...
1. [Roadmap](#7-roadmap)
   ...
   1. [Future enhancements](#72-future-enhancements)
      ...
      1. [Environment variables and configuration files](#722-environment-variables-and-configuration-files)
      1. [Single-hyphen long options](#723-single-hyphen-long-options)
      1. [Usage message include directives](#724-usage-message-include-directives)
      1. [License note](#725-license-note)
      1. [Programmable argument completion](#726-programmable-argument-completion)
      1. [POSIX compliance](#727-posix-compliance)
      1. [Alternative option prefixes (`+`/`/`)](#728-alternative-option-prefixes-)
   1. [Known bugs](#73-known-bugs)
   1. [Deprecations and removals](#74-deprecations-and-removals)
...
1. [Reference](#9-reference)
   ...
   1. [Translations](#95-translations)
      ...
      1. [`Error env var style usage`](#9532-error-env-var-style-usage)
      1. [`Error env var option type`](#9533-error-env-var-option-type)
      1. [`Error env var orientation`](#9534-error-env-var-orientation)
      1. [`Error env var delimiters identical`](#9535-error-env-var-delimiters-identical)
      1. [`Error env var short name empty`](#9536-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#9537-error-env-var-short-name-length)
      1. [`Error env var short name duplication 1`](#9538-error-env-var-short-name-duplication-1)
      1. [`Error env var short name duplication 2`](#9539-error-env-var-short-name-duplication-2)
      1. [`Error env var short options`](#9540-error-env-var-short-options)
      1. [`Error env var long options`](#9541-error-env-var-long-options)
      1. [`Error env var files`](#9542-error-env-var-files)
      1. [`Error arg array 1`](#9543-error-arg-array-1)
      1. [`Error arg array 2`](#9544-error-arg-array-2)
      1. [`Error arg array 3`](#9545-error-arg-array-3)
      1. [`Error no arg def`](#9546-error-no-arg-def)
      1. [`Error arg def id`](#9547-error-arg-def-id)
      1. [`Error arg def file id`](#9548-error-arg-def-file-id)
      1. [`Error arg def field count`](#9549-error-arg-def-field-count)
      1. [`Error arg def file field count`](#9550-error-arg-def-file-field-count)
      1. [`Error arg def choice range hyphens`](#9551-error-arg-def-choice-range-hyphens)
      1. [`Error arg def choice range`](#9552-error-arg-def-choice-range)
      1. [`Error arg def short name empty`](#9553-error-arg-def-short-name-empty)
      1. [`Error arg def short name help`](#9554-error-arg-def-short-name-help)
      1. [`Error arg def short name usage`](#9555-error-arg-def-short-name-usage)
      1. [`Error arg def short name version`](#9556-error-arg-def-short-name-version)
      1. [`Error arg def short name length`](#9557-error-arg-def-short-name-length)
      1. [`Error arg def short name duplication 1`](#9558-error-arg-def-short-name-duplication-1)
      1. [`Error arg def short name duplication 2`](#9559-error-arg-def-short-name-duplication-2)
      1. [`Error arg def long name empty`](#9560-error-arg-def-long-name-empty)
      1. [`Error arg def long name help`](#9561-error-arg-def-long-name-help)
      1. [`Error arg def long name usage`](#9562-error-arg-def-long-name-usage)
      1. [`Error arg def long name version`](#9563-error-arg-def-long-name-version)
      1. [`Error arg def long name length`](#9564-error-arg-def-long-name-length)
      1. [`Error arg def long name duplication 1`](#9565-error-arg-def-long-name-duplication-1)
      1. [`Error arg def long name duplication 2`](#9566-error-arg-def-long-name-duplication-2)
      1. [`Error arg def pos default flag`](#9567-error-arg-def-pos-default-flag)
      1. [`Error arg def pos default 1`](#9568-error-arg-def-pos-default-1)
      1. [`Error arg def pos default 2`](#9569-error-arg-def-pos-default-2)
      1. [`Error arg def pos choice true`](#9570-error-arg-def-pos-choice-true)
      1. [`Error arg def pos choice default`](#9571-error-arg-def-pos-choice-default)
      1. [`Error arg def pos optionals`](#9572-error-arg-def-pos-optionals)
      1. [`Error arg def pos optional infinite`](#9573-error-arg-def-pos-optional-infinite)
      1. [`Error arg def pos flag`](#9574-error-arg-def-pos-flag)
      1. [`Error arg def pos infinites`](#9575-error-arg-def-pos-infinites)
      1. [`Error arg def pos infinite optional 1`](#9576-error-arg-def-pos-infinite-optional-1)
      1. [`Error arg def pos infinite optional 2`](#9577-error-arg-def-pos-infinite-optional-2)
      1. [`Error arg def pos type`](#9578-error-arg-def-pos-type)
      1. [`Error arg def pos bool`](#9579-error-arg-def-pos-bool)
      1. [`Error arg def pos char`](#9580-error-arg-def-pos-char)
      1. [`Error arg def pos float`](#9581-error-arg-def-pos-float)
      1. [`Error arg def pos int`](#9582-error-arg-def-pos-int)
      1. [`Error arg def pos uint`](#9583-error-arg-def-pos-uint)
      1. [`Error arg def pos note`](#9584-error-arg-def-pos-note)
      1. [`Error arg def option default flag`](#9585-error-arg-def-option-default-flag)
      1. [`Error arg def option default 1`](#9586-error-arg-def-option-default-1)
      1. [`Error arg def option default 2`](#9587-error-arg-def-option-default-2)
      1. [`Error arg def option choice flag`](#9588-error-arg-def-option-choice-flag)
      1. [`Error arg def option choice true`](#9589-error-arg-def-option-choice-true)
      1. [`Error arg def option choice default`](#9590-error-arg-def-option-choice-default)
      1. [`Error arg def option type`](#9591-error-arg-def-option-type)
      1. [`Error arg def option bool`](#9592-error-arg-def-option-bool)
      1. [`Error arg def option char`](#9593-error-arg-def-option-char)
      1. [`Error arg def option float`](#9594-error-arg-def-option-float)
      1. [`Error arg def option int`](#9595-error-arg-def-option-int)
      1. [`Error arg def option uint`](#9596-error-arg-def-option-uint)
      1. [`Error arg def option note`](#9597-error-arg-def-option-note)
      1. [`Error arg double hyphen`](#9598-error-arg-double-hyphen)
      1. [`Error arg double plus`](#9599-error-arg-double-plus)
      1. [`Error arg inversion`](#95100-error-arg-inversion)
      1. [`Error arg unknown`](#95101-error-arg-unknown)
      1. [`Error long option match`](#95102-error-long-option-match)
      1. [`Error long option negation`](#95103-error-long-option-negation)
      1. [`Error long option unknown`](#95104-error-long-option-unknown)
      1. [`Error short option merge`](#95105-error-short-option-merge)
      1. [`Error short option unknown`](#95106-error-short-option-unknown)
      1. [`Error pos arg count 1`](#95107-error-pos-arg-count-1)
      1. [`Error pos arg count 2`](#95108-error-pos-arg-count-2)
      1. [`Error arg no flag 1`](#95109-error-arg-no-flag-1)
      1. [`Error arg no flag 2`](#95110-error-arg-no-flag-2)
      1. [`Error arg no flag 3`](#95111-error-arg-no-flag-3)
      1. [`Error mandatory arg`](#95112-error-mandatory-arg)
      1. [`Error wrong arg number 1`](#95113-error-wrong-arg-number-1)
      1. [`Error wrong arg number 2`](#95114-error-wrong-arg-number-2)
      1. [`Error wrong arg number 3`](#95115-error-wrong-arg-number-3)
      1. [`Error wrong arg number 4`](#95116-error-wrong-arg-number-4)
      1. [`Error arg choice`](#95117-error-arg-choice)
      1. [`Error arg bool`](#95118-error-arg-bool)
      1. [`Error arg char`](#95119-error-arg-char)
      1. [`Error arg float`](#95120-error-arg-float)
      1. [`Error arg int`](#95121-error-arg-int)
      1. [`Error arg uint`](#95122-error-arg-uint)
      1. [`Error YAML`](#95123-error-yaml)
      1. [`Error style file equals sign`](#95124-error-style-file-equals-sign)
      1. [`Error style file frame styles`](#95125-error-style-file-frame-styles)
      1. [`Error style file text styles`](#95126-error-style-file-text-styles)
      1. [`Error include directive`](#95127-error-include-directive)
      1. [`Warning no identifier`](#95128-warning-no-identifier)
      1. [`Warning no translation`](#95129-warning-no-translation)
      1. [`Warning style file message key`](#95130-warning-style-file-message-key)
      1. [`Warning deprecation`](#95131-warning-deprecation)
      1. [`Warning wrong arg number 1`](#95132-warning-wrong-arg-number-1)
      1. [`Warning wrong arg number 2`](#95133-warning-wrong-arg-number-2)
      1. [`Warning wrong arg number 3`](#95134-warning-wrong-arg-number-3)
      1. [`Warning wrong arg number 4`](#95135-warning-wrong-arg-number-4)
<!-- </toc> -->
<!-- </section> -->
...
The `@Description` directive prints the contents of [`ARGPARSER_HELP_DESCRIPTION`](#9424-argparser_help_description), wrapped to fit the help message's [`ARGPARSER_MAX_WIDTH`](#9435-argparser_max_width). If `ARGPARSER_HELP_DESCRIPTION` is empty (the default), nothing is printed.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9533-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#9457-argparser_use_short_options) prohibits this.
...
- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#9533-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#9456-argparser_use_long_options) prohibits this.
