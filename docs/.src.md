...
1. [Roadmap](#6-roadmap)
   1. [Future enhancements](#61-future-enhancements)
      ...
      1. [Choice value ranges for floats](#615-choice-value-ranges-for-floats)
      1. [Intermixed positional and keyword arguments](#616-intermixed-positional-and-keyword-arguments)
      1. [Single-hyphen long options](#617-single-hyphen-long-options)
...
The [feature comparison](#51-feature-comparison) compares the various features for argument parsing, while some [example scripts](#52-example-scripts) later demonstrate the usage for the different parsers.
<!-- </section> -->
