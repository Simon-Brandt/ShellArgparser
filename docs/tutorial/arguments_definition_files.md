...
Usage: try_arg_def_file.sh [-h,-? | -u | -V]
                           [-d={A-C}]
                           [-f]
                           [-g]
                           [--var-5=VAL_5]
