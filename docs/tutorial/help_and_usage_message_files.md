...
Additionally, we need a separate file, which we'll call `help_message.txt` and have passed as value to [`ARGPARSER_HELP_FILE`](../reference/environment_variables/environment_variables.md#8425-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
- [`@Description`](../reference/include_directives.md#834-description-directive)
- [`@Header`](../reference/include_directives.md#833-header-directive)
- [`@Help`](../reference/include_directives.md#837-help-directive)
- [`@Remark`](../reference/include_directives.md#835-remark-directive)
- [`@Usage`](../reference/include_directives.md#836-usage-directive)
