...
1. [`ARGPARSER_STYLE_FILE`](environment_variables.md#9443-argparser_style_file)
1. [`ARGPARSER_TRANSLATION_FILE`](environment_variables.md#9444-argparser_translation_file)
1. [`ARGPARSER_UNSET_ARGS`](environment_variables.md#9445-argparser_unset_args)
1. [`ARGPARSER_UNSET_ENV_VARS`](environment_variables.md#9446-argparser_unset_env_vars)
1. [`ARGPARSER_UNSET_FUNCTIONS`](environment_variables.md#9447-argparser_unset_functions)
1. [`ARGPARSER_USAGE_EXIT_CODE`](environment_variables.md#9448-argparser_usage_exit_code)
1. [`ARGPARSER_USAGE_FILE`](environment_variables.md#9449-argparser_usage_file)
1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](environment_variables.md#9450-argparser_usage_file_include_char)
1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](environment_variables.md#9451-argparser_usage_file_keep_comments)
1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](environment_variables.md#9452-argparser_usage_message_option_type)
1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](environment_variables.md#9453-argparser_usage_message_orientation)
1. [`ARGPARSER_USAGE_OPTIONS`](environment_variables.md#9454-argparser_usage_options)
1. [`ARGPARSER_USAGE_STYLE`](environment_variables.md#9455-argparser_usage_style)
1. [`ARGPARSER_USE_LONG_OPTIONS`](environment_variables.md#9456-argparser_use_long_options)
1. [`ARGPARSER_USE_SHORT_OPTIONS`](environment_variables.md#9457-argparser_use_short_options)
1. [`ARGPARSER_USE_STYLES`](environment_variables.md#9458-argparser_use_styles)
1. [`ARGPARSER_USE_STYLES_IN_FILES`](environment_variables.md#9459-argparser_use_styles_in_files)
1. [`ARGPARSER_VERSION_EXIT_CODE`](environment_variables.md#9460-argparser_version_exit_code)
1. [`ARGPARSER_VERSION_NUMBER`](environment_variables.md#9461-argparser_version_number)
1. [`ARGPARSER_VERSION_OPTIONS`](environment_variables.md#9462-argparser_version_options)
1. [`ARGPARSER_VERSION_STYLE`](environment_variables.md#9463-argparser_version_style)
1. [`ARGPARSER_WARNING_STYLE`](environment_variables.md#9464-argparser_warning_style)
1. [`ARGPARSER_WRITE_ARGS`](environment_variables.md#9465-argparser_write_args)
<!-- </toc> -->
