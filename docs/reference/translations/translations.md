...
#### 9.5.35. `Error env var delimiters identical`
...
#### 9.5.36. `Error env var short name empty`
...
#### 9.5.37. `Error env var short name length`
...
#### 9.5.38. `Error env var short name duplication 1`
...
#### 9.5.39. `Error env var short name duplication 2`
...
#### 9.5.49. `Error arg def field count`
...
#### 9.5.50. `Error arg def file field count`
...
#### 9.5.51. `Error arg def choice range hyphens`
...
#### 9.5.52. `Error arg def choice range`
...
#### 9.5.53. `Error arg def short name empty`
...
#### 9.5.54. `Error arg def short name help`
...
#### 9.5.55. `Error arg def short name usage`
...
#### 9.5.56. `Error arg def short name version`
...
#### 9.5.57. `Error arg def short name length`
...
#### 9.5.58. `Error arg def short name duplication 1`
...
#### 9.5.59. `Error arg def short name duplication 2`
...
#### 9.5.60. `Error arg def long name empty`
...
#### 9.5.61. `Error arg def long name help`
...
#### 9.5.62. `Error arg def long name usage`
...
#### 9.5.63. `Error arg def long name version`
...
#### 9.5.64. `Error arg def long name length`
...
#### 9.5.65. `Error arg def long name duplication 1`
...
#### 9.5.66. `Error arg def long name duplication 2`
...
#### 9.5.67. `Error arg def pos default flag`
...
#### 9.5.68. `Error arg def pos default 1`
...
#### 9.5.69. `Error arg def pos default 2`
...
#### 9.5.70. `Error arg def pos choice true`
...
#### 9.5.71. `Error arg def pos choice default`
...
#### 9.5.72. `Error arg def pos optionals`
...
#### 9.5.73. `Error arg def pos optional infinite`
...
#### 9.5.75. `Error arg def pos infinites`
...
#### 9.5.76. `Error arg def pos infinite optional 1`
...
#### 9.5.77. `Error arg def pos infinite optional 2`
...
#### 9.5.81. `Error arg def pos float`
...
#### 9.5.85. `Error arg def option default flag`
...
#### 9.5.86. `Error arg def option default 1`
...
#### 9.5.87. `Error arg def option default 2`
...
#### 9.5.88. `Error arg def option choice flag`
...
#### 9.5.89. `Error arg def option choice true`
...
#### 9.5.90. `Error arg def option choice default`
...
#### 9.5.91. `Error arg def option type`
...
#### 9.5.92. `Error arg def option bool`
...
#### 9.5.93. `Error arg def option char`
...
#### 9.5.94. `Error arg def option float`
...
#### 9.5.95. `Error arg def option int`
...
#### 9.5.96. `Error arg def option uint`
...
#### 9.5.97. `Error arg def option note`
...
#### 9.5.98. `Error arg double hyphen`
...
#### 9.5.102. `Error long option match`
...
#### 9.5.103. `Error long option negation`
...
#### 9.5.104. `Error long option unknown`
...
#### 9.5.105. `Error short option merge`
...
#### 9.5.106. `Error short option unknown`
...
#### 9.5.113. `Error wrong arg number 1`
...
#### 9.5.114. `Error wrong arg number 2`
...
#### 9.5.115. `Error wrong arg number 3`
...
#### 9.5.116. `Error wrong arg number 4`
...
#### 9.5.124. `Error include directive`
...
#### 9.5.126. `Warning wrong arg number 1`
...
#### 9.5.127. `Warning wrong arg number 2`
...
#### 9.5.128. `Warning wrong arg number 3`
...
#### 9.5.129. `Warning wrong arg number 4`
