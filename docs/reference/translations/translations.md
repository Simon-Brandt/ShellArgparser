...
- ***Message:*** `Error: The argument with the identifier "$1" has an empty string given as one of the $2 short option names, instead of a legit name.`
...
- ***Message:*** `Error: The argument with the identifier "$1" has an empty string given as one of the $2 long option names, instead of a legit name.`
...
- ***Message:*** `Error: The argument with the identifier "$1" has the long option "--help" defined, which is reserved for invoking the help message.`
...
- ***Message:*** `Error: The argument with the identifier "$1" has the long option "--usage" defined, which is reserved for invoking the usage message.`
...
- ***Message:*** `Error: The argument with the identifier "$1" has the long option "--version" defined, which is reserved for invoking the version message.`
