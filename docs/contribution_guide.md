...
1. [General advice](#61-general-advice)
   1. [Language](#611-language)
   1. [Commit messages](#612-commit-messages)
1. [Code](#62-code)
   1. [Adding functionality](#621-adding-functionality)
   1. [Coding style](#622-coding-style)
   1. [ShellCheck](#623-shellcheck)
1. [Documentation](#63-documentation)
   1. [Files](#631-files)
   1. [Documentation style](#632-documentation-style)
...
- ***Sentences:*** Separate sentences with one space, not two. This goes against the recommendation for [code](#622-coding-style).
- ***Headings:***
