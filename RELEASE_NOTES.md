...
- [`v1.2.0` *"Callospermophilus lateralis"*](#v120-callospermophilus-lateralis)
- [`v1.1.2` *"Biswamoyopterus laoensis"*](#v112-biswamoyopterus-laoensis)
- [`v1.1.1` *"Biswamoyopterus gaoligongensis"*](#v111-biswamoyopterus-gaoligongensis)
- [`v1.1.0` *"Biswamoyopterus biswasi"*](#v110-biswamoyopterus-biswasi)
