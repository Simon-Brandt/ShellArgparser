...
1. [Reference](#5-reference)
   1. [Arguments definition](#53-arguments-definition)
      1. [Argument ID (`id`)](#531-argument-id-id)
      1. [Short option names (`short_opts`)](#532-short-option-names-short_opts)
      1. [Long option names (`long_opts`)](#533-long-option-names-long_opts)
      1. [Value names (`val_names`)](#534-value-names-val_names)
      1. [Default values (`defaults`)](#535-default-values-defaults)
      1. [Choice values (`choices`)](#536-choice-values-choices)
      1. [Data type (`type`)](#537-data-type-type)
      1. [Argument count (`arg_no`)](#538-argument-count-arg_no)
      1. [Argument group (`arg_group`)](#539-argument-group-arg_group)
      1. [Notes (`notes`)](#5310-notes-notes)
      1. [Help text (`help`)](#5311-help-text-help)
   1. [Colors and styles](#54-colors-and-styles)
   1. [Include directives](#55-include-directives)
      1. [`@All` directive](#551-all-directive)
      1. [`@<ArgumentGroup>` directive](#552-argumentgroup-directive)
      1. [`@Header` directive](#553-header-directive)
      1. [`@Remark` directive](#554-remark-directive)
      1. [`@Usage` directive](#555-usage-directive)
      1. [`@Help` directive](#556-help-directive)
   1. [Translations](#56-translations)
      1. [`Positional arguments`](#561-positional-arguments)
      1. [`Help options`](#562-help-options)
      1. [`Error`](#563-error)
      1. [`Warning`](#564-warning)
      1. [`Usage`](#565-usage)
      1. [`Arguments`](#566-arguments)
      1. [`Options`](#567-options)
      1. [`Mandatory arguments`](#568-mandatory-arguments)
      1. [`Deprecated`](#569-deprecated)
      1. [`Default`](#5610-default)
      1. [`--help`](#5611---help)
      1. [`--usage`](#5612---usage)
      1. [`--version`](#5613---version)
      1. [`false`](#5614-false)
      1. [`true`](#5615-true)
      1. [`Error env var bool`](#5616-error-env-var-bool)
      1. [`Error env var char`](#5617-error-env-var-char)
      1. [`Error env var identifier`](#5618-error-env-var-identifier)
      1. [`Error env var int`](#5619-error-env-var-int)
      1. [`Error env var uint`](#5620-error-env-var-uint)
      1. [`Error env var file 0001`](#5621-error-env-var-file-0001)
      1. [`Error env var file 0010`](#5622-error-env-var-file-0010)
      1. [`Error env var file 0011`](#5623-error-env-var-file-0011)
      1. [`Error env var file 0100`](#5624-error-env-var-file-0100)
      1. [`Error env var file 0101`](#5625-error-env-var-file-0101)
      1. [`Error env var file 0110`](#5626-error-env-var-file-0110)
      1. [`Error env var file 0111`](#5627-error-env-var-file-0111)
      1. [`Error env var file 1111`](#5628-error-env-var-file-1111)
      1. [`Error env var styles`](#5629-error-env-var-styles)
      1. [`Error env var option type`](#5630-error-env-var-option-type)
      1. [`Error env var orientation`](#5631-error-env-var-orientation)
      1. [`Error env var delimiters`](#5632-error-env-var-delimiters)
      1. [`Error env var short name empty`](#5633-error-env-var-short-name-empty)
      1. [`Error env var short name length`](#5634-error-env-var-short-name-length)
      1. [`Error env var short name inner duplication`](#5635-error-env-var-short-name-inner-duplication)
      1. [`Error env var short name outer duplication`](#5636-error-env-var-short-name-outer-duplication)
      1. [`Error env var short options`](#5637-error-env-var-short-options)
      1. [`Error env var long options`](#5638-error-env-var-long-options)
      1. [`Error env var files`](#5639-error-env-var-files)
      1. [`Error arg array 1`](#5640-error-arg-array-1)
      1. [`Error arg array 2`](#5641-error-arg-array-2)
      1. [`Error arg array 3`](#5642-error-arg-array-3)
      1. [`Error wrong arg def`](#5643-error-wrong-arg-def)
      1. [`Error no arg def`](#5644-error-no-arg-def)
      1. [`Error arg def field`](#5645-error-arg-def-field)
      1. [`Error arg def file field`](#5646-error-arg-def-file-field)
   1. [Environment variables](#57-environment-variables)
      1. [Overview](#571-overview)
      1. [`ARGPARSER_ADD_HELP`](#572-argparser_add_help)
      1. [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage)
      1. [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version)
      1. [`ARGPARSER_ALLOW_FLAG_INVERSION`](#575-argparser_allow_flag_inversion)
      1. [`ARGPARSER_ALLOW_FLAG_NEGATION`](#576-argparser_allow_flag_negation)
      1. [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#577-argparser_allow_option_abbreviation)
      1. [`ARGPARSER_ALLOW_OPTION_MERGING`](#578-argparser_allow_option_merging)
      1. [`ARGPARSER_ARG_ARRAY_NAME`](#579-argparser_arg_array_name)
      1. [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file)
      1. [`ARGPARSER_ARG_DEF_FILE_HAS_HEADER`](#5711-argparser_arg_def_file_has_header)
      1. [`ARGPARSER_ARG_DEF_HAS_HEADER`](#5712-argparser_arg_def_has_header)
      1. [`ARGPARSER_ARG_DELIMITER_1`](#5713-argparser_arg_delimiter_1)
      1. [`ARGPARSER_ARG_DELIMITER_2`](#5714-argparser_arg_delimiter_2)
      1. [`ARGPARSER_ARGPARSER_VERSION`](#5715-argparser_argparser_version)
      1. [`ARGPARSER_ARGS`](#5716-argparser_args)
      1. [`ARGPARSER_CHECK_ARG_DEF`](#5717-argparser_check_arg_def)
      1. [`ARGPARSER_CHECK_ENV_VARS`](#5718-argparser_check_env_vars)
      1. [`ARGPARSER_CONFIG_FILE`](#5719-argparser_config_file)
      1. [`ARGPARSER_COUNT_FLAGS`](#5720-argparser_count_flags)
      1. [`ARGPARSER_DICTIONARY`](#5721-argparser_dictionary)
      1. [`ARGPARSER_ERROR_EXIT_CODE`](#5722-argparser_error_exit_code)
      1. [`ARGPARSER_ERROR_STYLE`](#5723-argparser_error_style)
      1. [`ARGPARSER_HELP_ARG_GROUP`](#5724-argparser_help_arg_group)
      1. [`ARGPARSER_HELP_EXIT_CODE`](#5725-argparser_help_exit_code)
      1. [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file)
      1. [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#5727-argparser_help_file_include_char)
      1. [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#5728-argparser_help_file_keep_comments)
      1. [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options)
      1. [`ARGPARSER_HELP_STYLE`](#5730-argparser_help_style)
      1. [`ARGPARSER_LANGUAGE`](#5731-argparser_language)
      1. [`ARGPARSER_MAX_COL_WIDTH_1`](#5732-argparser_max_col_width_1)
      1. [`ARGPARSER_MAX_COL_WIDTH_2`](#5733-argparser_max_col_width_2)
      1. [`ARGPARSER_MAX_COL_WIDTH_3`](#5734-argparser_max_col_width_3)
      1. [`ARGPARSER_MAX_WIDTH`](#5735-argparser_max_width)
      1. [`ARGPARSER_POSITIONAL_ARG_GROUP`](#5736-argparser_positional_arg_group)
      1. [`ARGPARSER_READ_ARGS`](#5737-argparser_read_args)
      1. [`ARGPARSER_SCRIPT_ARGS`](#5738-argparser_script_args)
      1. [`ARGPARSER_SCRIPT_NAME`](#5739-argparser_script_name)
      1. [`ARGPARSER_SET_ARGS`](#5740-argparser_set_args)
      1. [`ARGPARSER_SET_ARRAYS`](#5741-argparser_set_arrays)
      1. [`ARGPARSER_SILENCE_ERRORS`](#5742-argparser_silence_errors)
      1. [`ARGPARSER_SILENCE_WARNINGS`](#5743-argparser_silence_warnings)
      1. [`ARGPARSER_TRANSLATION_FILE`](#5744-argparser_translation_file)
      1. [`ARGPARSER_UNSET_ARGS`](#5745-argparser_unset_args)
      1. [`ARGPARSER_UNSET_ENV_VARS`](#5746-argparser_unset_env_vars)
      1. [`ARGPARSER_UNSET_FUNCTIONS`](#5747-argparser_unset_functions)
      1. [`ARGPARSER_USAGE_EXIT_CODE`](#5748-argparser_usage_exit_code)
      1. [`ARGPARSER_USAGE_FILE`](#5749-argparser_usage_file)
      1. [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#5750-argparser_usage_file_include_char)
      1. [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#5751-argparser_usage_file_keep_comments)
      1. [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#5752-argparser_usage_message_option_type)
      1. [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#5753-argparser_usage_message_orientation)
      1. [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options)
      1. [`ARGPARSER_USAGE_STYLE`](#5755-argparser_usage_style)
      1. [`ARGPARSER_USE_LONG_OPTIONS`](#5756-argparser_use_long_options)
      1. [`ARGPARSER_USE_SHORT_OPTIONS`](#5757-argparser_use_short_options)
      1. [`ARGPARSER_USE_STYLES_IN_FILES`](#5758-argparser_use_styles_in_files)
      1. [`ARGPARSER_VERSION`](#5759-argparser_version)
      1. [`ARGPARSER_VERSION_EXIT_CODE`](#5760-argparser_version_exit_code)
      1. [`ARGPARSER_VERSION_OPTIONS`](#5761-argparser_version_options)
      1. [`ARGPARSER_VERSION_STYLE`](#5762-argparser_version_style)
      1. [`ARGPARSER_WARNING_STYLE`](#5763-argparser_warning_style)
      1. [`ARGPARSER_WRITE_ARGS`](#5764-argparser_write_args)
<!-- </toc> -->
...
Further, long option names can be abbreviated, as long as no collision with other names arises (like when giving `--verb` in the example above). This requires [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#577-argparser_allow_option_abbreviation) to be set to `true`. In contrast, short option names may be merged with their value or other short option names (if they're flags, see below), given that [`ARGPARSER_ALLOW_OPTION_MERGING`](#578-argparser_allow_option_merging) is set to `true`. For the sake of an example without needing a novel script, we'll set the latter variable to the environment of the script execution by prefixing the assignments to the usual command line:
...
This argparser-specific tabular format consists of eleven columns, each separated from each other by an [`ARGPARSER_ARG_DELIMITER_1`](#5713-argparser_arg_delimiter_1) character, defaulting to a pipe (`"|"`). Multi-value fields are delimited by an [`ARGPARSER_ARG_DELIMITER_2`](#5714-argparser_arg_delimiter_2) character, defaulting to a comma (`","`). The columns are defined as follows:
...
The argparser accepts over 50 options for configuring the argument parsing, checking their values and the consistency of the arguments definition, creating the various message types (see below), and setting the required companion files. These options are available as [environment variables](#57-environment-variables). By this, you can set them directly in your script, and even [`export`](https://www.gnu.org/software/bash/manual/html_node/Bourne-Shell-Builtins.html#index-export "gnu.org &rightarrow; Bourne Shell Builtins &rightarrow; export") them to child processes. Thus, you can set these variables once and use them throughout your script suite.
...
No matter how many keyword arguments are defined, as long as [`ARGPARSER_ADD_HELP`](#572-argparser_add_help) and [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage) are set to `true` (the default), the argparser interprets the flags from the [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options) (default: `-h` and `-?`) and `--help` as call for a verbose help message and the flags from the [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options) (default: `-u`) and `--usage` as call for a brief usage message. Then, these options are automatically added to the script's argument definition and override any same-named argument name (yielding an error message if [`ARGPARSER_CHECK_ARG_DEF`](#5717-argparser_check_arg_def) is set to `true`). This is to ensure that the novice user of your script can do exactly what we did, above: trying the most common variants to get some help over how to use a program or script by typing
...
For a better overview when having lots of arguments, we can choose a columnar layout instead of the single row, using [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#5753-argparser_usage_message_orientation):
...
Additionally, we may choose to show the long options by [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#5752-argparser_usage_message_option_type):
...
The help message details all short and long option names, their optionality (*i.e.*, whether there are default values), and their choice values, using the same syntax as in the usage message. Additionally, the help text and notes from the arguments definition are given. The arguments are separated by their groups, thus structuring the help message. First, the group for the positional arguments is given (indicated by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#5736-argparser_positional_arg_group)), then follow the keyword argument groups in alphabetical order. Finally, the default `--help`, `--usage`, and `--version` arguments (the latter for the [version message](#38-version-messages)) are given as separate, yet unnamed group.

The help message's structure aims at reproducing the commonly found structure in command-line programs. By setting [`ARGPARSER_MAX_COL_WIDTH_1`](#5732-argparser_max_col_width_1), [`ARGPARSER_MAX_COL_WIDTH_2`](#5733-argparser_max_col_width_2), or [`ARGPARSER_MAX_COL_WIDTH_3`](#5734-argparser_max_col_width_3) (as done in `try_argparser.sh`), the column widths may be adapted to your needs, recommendably totalling 77 characters (thus 79 characters including the separating spaces). Note that columns are automatically shrunk, when their content is narrower, but they're not expanded, when their content is wider. This is to guarantee that the help message, when *e.g.* sent as logging output, nicely fits in the space you have.

Alternatively, you may want to set [`ARGPARSER_MAX_WIDTH`](#5735-argparser_max_width). By this, the help message will have a defined width, independent of shrunk columns. This is achieved by expanding the third column (with the help text) to the remaining width. For this to work, [`ARGPARSER_MAX_COL_WIDTH_3`](#5734-argparser_max_col_width_3) must be set to `0`.

### 3.6. Help and usage message files

The argparser is not only able to compile a help message, but can also be guided by a separate file. Using the [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file) environment variable pointing to this file, to a certain degree, you can customize the help message's look and structure by moving the blocks the message consists of around and enriching it by arbitrary text. Again, we use a simplified script as `try_help_file.sh` without alias names for the short and long options.
...
Additionally, we need a separate file, which we'll call `help_message.txt` and have passed as value to [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file). This plain-text file stores the help message's structure and can contain arbitrary additional content.
...
When you compare the structure of this help message with both the previous version and the help file, you see that there, you can include the sections from the auto-generated help message by prefixing their names with an [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#5727-argparser_help_file_include_char) character, defaulting to an `"@"`. Generally speaking, an include directive, as the commands are referred to, like `@Section`, includes the section named `"Section"`.

The following section names (include directives) are supported, explained in greater detail in the reference below:

- [`@All`](#551-all-directive)
- [`@<ArgumentGroup>`](#552-argumentgroup-directive)
- [`@Header`](#553-header-directive)
- [`@Help`](#556-help-directive)
- [`@Remark`](#554-remark-directive)
- [`@Usage`](#555-usage-directive)

Thereby, `<ArgumentGroup>` can be the name of any argument group given in the arguments definition, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. `@Help` prints the help, usage, and version options (depending on which of them are defined by [`ARGPARSER_ADD_HELP`](#572-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version)), `@Remark` prints the remark that mandatory arguments to long options are mandatory for short options too, and `@Usage` prints the usage line. Finally, the shorthand `@All` means to print the usage line, the remark, all argument groups, and the help options, in this order, while `@Header` prints the usage line and the remark.

Further, lines starting with a `"#"` character in the help file aren't printed if [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#5728-argparser_help_file_keep_comments) is set to `false` (the default). This allows you to comment your help file, perhaps to explain the structure&mdash;or just to write a header or footer with your name and debug email address inside.

The same as for help messages can be done for usage messages, using the [`ARGPARSER_USAGE_FILE`](#5749-argparser_usage_file), [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#5750-argparser_usage_file_include_char), and [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#5751-argparser_usage_file_keep_comments) environment variables. However there, only the `@All` directive is supported, yet.

### 3.7. Help and usage message localization

It is even possible to localize your script's help and usage message. For the usage message, all you need is an [`ARGPARSER_TRANSLATION_FILE`](#5744-argparser_translation_file), a simplified YAML file giving the translation of the auto-generated parts in the messages. For each section, you give the language identifier for the language you want the message to be translated to, *i.e.*, the [`ARGPARSER_LANGUAGE`](#5731-argparser_language). For the usage message, this suffices, but in the help message, also non-auto-generated parts are included, especially each argument's help text. For them to be translated, you need a dedicated [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file) and possibly a localized [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file).
...
You need to manually translate the arguments definition (only the argument groups and the help texts) in the new arguments definition file, here shown as using no header (stated by the [`ARGPARSER_ARG_DEF_FILE_HAS_HEADER`](#5711-argparser_arg_def_file_has_header) environment variable):
...
Besides the the [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options), `--help`, the [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options), and `--usage`, there is a third option intended to help the user, the [`ARGPARSER_VERSION_OPTIONS`](#5761-argparser_version_options) (default: `-V`) and `--version`. This flag compiles a brief version message for your script, showing its canonical name (the [`ARGPARSER_SCRIPT_NAME`](#5739-argparser_script_name)) and the version number (the [`ARGPARSER_VERSION`](#5759-argparser_version)). Just as for the help and usage messages, you can disable the version message (and its corresponding flags) by setting [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version) to `false`. Note that the default short option name is an uppercase `V`, such that you can use the lowercase `v` (as `-v`) for your purposes, like `--verbatim` or `--verbose`. This is in line with the common behavior of command-line programs. By setting `ARGPARSER_VERSION_OPTIONS` accordingly, you can of course change it to your needs, if desired.
...
#### 5.3.6. Choice values (`choices`)

It is possible to restrict the range of acceptable values for an argument to a set indicated by the choice values. If [default values](#535-default-values-defaults) are given, they must lie within the choice values.

#### 5.3.7. Data type (`type`)
...
The Python [`argparse`](https://docs.python.org/3/library/argparse.html "python.org &rightarrow; Python documentation &rightarrow; argparse module") module further defines `*` to accept any argument count, and `?` to accept exactly zero or one argument. Both features aren't yet supported by the argparser, but the characters are reserved for future usage as such, invalidating them as values for [`ARGPARSER_ARG_DELIMITER_1`](#5713-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#5714-argparser_arg_delimiter_2).

#### 5.3.9. Argument group (`arg_group`)

The argument groups serve to group arguments in the help message. The first group shall comprise all positional arguments (if any is defined) and is named by [`ARGPARSER_POSITIONAL_ARG_GROUP`](#5736-argparser_positional_arg_group). Any other argument group shall only contain keyword arguments (options), and is sorted alphabetically in the help message. In the future, argument groups will be expanded to allow actual grouping of arguments upon parsing, such that options may only be given together or mutually exclusively.
...
#### 5.3.11. Help text (`help`)

The help text should consist of a terse summary of the argument's function, like turning a feature on or off (which may be accomplished by flags), what a file is used for (like for input or output), or how your script's output may be modified. A help text can take any form, but be wary of it being wrapped to fit the width of the third column in the help message (if [`ARGPARSER_MAX_COL_WIDTH_3`](#5734-argparser_max_col_width_3) is non-zero) or the total line length ([`ARGPARSER_MAX_WIDTH`](#5735-argparser_max_width)). Help messages are no replacement for the manual, so the help text shouldn't be overly verbose.

### 5.4. Colors and styles

The argparser employs [Select Graphic Rendition (SGR) ANSI escape sequence codes](https://en.wikipedia.org/wiki/ANSI_escape_code#Select_Graphic_Rendition_parameters "wikipedia.org &rightarrow; ANSI escape code &rightarrow; Select Graphic Rendition parameters") to set the appearance of error, warning, help, usage, and version messages. To this end, five environment variable are defined, *viz.*, [`ARGPARSER_HELP_STYLE`](#5730-argparser_help_style), [`ARGPARSER_USAGE_STYLE`](#5755-argparser_usage_style), [`ARGPARSER_VERSION_STYLE`](#5762-argparser_version_style), [`ARGPARSER_ERROR_STYLE`](#5723-argparser_error_style), and [`ARGPARSER_WARNING_STYLE`](#5763-argparser_warning_style). Since the escape codes are nonprintable, not any terminal or text editor may support them. Many terminals do, while *e.g.* [`less`](https://man7.org/linux/man-pages/man1/less.1.html "man7.org &rightarrow; man pages &rightarrow; less(1)") has a dedicated flag, `--raw-control-chars`.

When [`ARGPARSER_USE_STYLES_IN_FILES`](#5758-argparser_use_styles_in_files) is set to `false`, the escape sequences are only included when `STDOUT`/`STDERR` is a terminal, keeping files plain 7-bit ASCII for simpler parsing. Note that, when your arguments definition or help file includes non-ASCII characters (as is usual for almost any language other than English varieties), the output contains these characters as well.
...
### 5.5. Include directives

Six section names (include directives) are supported in the help and usage files. These are introduced with the [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#5727-argparser_help_file_include_char) or [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#5750-argparser_usage_file_include_char), respectively, defaulting to `"@"`.
...
The `@All` directive comprises all include directives in the following order: [`@Usage`](#555-usage-directive), [`@Remark`](#554-remark-directive), [`@<ArgumentGroup>`](#552-argumentgroup-directive), and [`@Help`](#556-help-directive), separated from each other by a blank line.

Consequently, the help message generated from the [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file) with the following content:
...
#### 5.5.2. `@<ArgumentGroup>` directive

The `@<ArgumentGroup>` directive prints the help text for the respective `"<ArgumentGroup>"`, like `"Mandatory options"` for the include directive `@Mandatory options` or `"Optional options"` for the include directive `@Optional options`. Their order in the auto-generated help message would be alphabetical for the keyword arguments, preceded by the group for the positional arguments (the [`ARGPARSER_POSITIONAL_ARG_GROUP`](#5736-argparser_positional_arg_group)). Thus, if you have reasons for another structure, you need an [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file), denoting all arguments groups in the order preferred by you.

#### 5.5.3. `@Header` directive

The `@Header` directive comprises the [`@Usage`](#555-usage-directive) and [`@Remark`](#554-remark-directive) include directive, separated from each other by a blank line, and is thus the shorthand for including both.

#### 5.5.4. `@Remark` directive
...
#### 5.5.5. `@Usage` directive

The `@Usage` directive prints the line `Usage: <script_name> ...`, with `<script_name>` replaced by [`ARGPARSER_SCRIPT_NAME`](#5739-argparser_script_name), defaulting to your script's name. This should be given as first line.

#### 5.5.6. `@Help` directive

The `@Help` directive prints the help text for the `--help`, `--usage`, and `--version` flags (if added to the arguments definition by [`ARGPARSER_ADD_HELP`](#572-argparser_add_help), [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage), or [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version)). Usually, you want to give this at the very end of all options.
...
#### 5.6.1. `Positional arguments`

- ***Description:*** The name of the positional arguments' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_POSITIONAL_ARG_GROUP`](#5736-argparser_positional_arg_group).

#### 5.6.2. `Help options`

- ***Description:*** The name of the help options' argument group in the arguments definition, to be shown in the help message, *i.e.*, the translated [`ARGPARSER_HELP_ARG_GROUP`](#5724-argparser_help_arg_group).
...
#### 5.6.8. `Mandatory arguments`

- ***Description:*** The remark that mandatory arguments to long options are mandatory for short options too, to be used in the help message for the [`@Remark`](#554-remark-directive) include directive.
...
- ***Description:*** the help text for the help options, *i.e.*, the [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options) and `--help`, if [`ARGPARSER_ADD_HELP`](#572-argparser_add_help) is set to `true`.

#### 5.6.12. `--usage`

- ***Description:*** the help text for the usage options, *i.e.*, the [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options) and `--usage`, if [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage) is set to `true`.

#### 5.6.13. `--version`

- ***Description:*** the help text for the version options, *i.e.*, the [`ARGPARSER_VERSION_OPTIONS`](#5761-argparser_version_options) and `--version`, if [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version) is set to `true`.
...
#### 5.6.18. `Error env var identifier`
...
#### 5.6.21. `Error env var file 0001`
...
#### 5.6.22. `Error env var file 0010`
...
#### 5.6.23. `Error env var file 0011`
...
#### 5.6.24. `Error env var file 0100`
...
#### 5.6.25. `Error env var file 0101`
...
#### 5.6.26. `Error env var file 0110`
...
#### 5.6.27. `Error env var file 0111`
...
#### 5.6.28. `Error env var file 1111`
...
#### 5.6.29. `Error env var styles`

- ***Description:*** The error that an environment variable refers to an undefined [color or style](#54-colors-and-styles).
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#5718-argparser_check_env_vars) is set to `true`, the argparser detected that an environment variable, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#5719-argparser_config_file), on the argparser invokation command line, or as an environment variable, has a value intended to set a message color or style which does not exist.
- ***Interpolated variables:***
  - `$1`: The environment variable's name.
  - `$2`: The environment variable's value.

#### 5.6.30. `Error env var option type`

- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#5752-argparser_usage_message_option_type) is not set to `long` or `short`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#5718-argparser_check_env_vars) is set to `true`, the argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#5719-argparser_config_file), on the argparser invokation command line, or as an environment variable, has a value other than `long` and `short`.
- ***Interpolated variables:***
  - `$1`: The environment variable's value.

#### 5.6.31. `Error env var orientation`

- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#5753-argparser_usage_message_orientation) is not set to `row` or `column`.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#5718-argparser_check_env_vars) is set to `true`, the argparser detected that the environment variable `ARGPARSER_USAGE_MESSAGE_ORIENTATION`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#5719-argparser_config_file), on the argparser invokation command line, or as an environment variable, has a value other than `row` and `column`.
- ***Interpolated variables:***
  - `$1`: The environment variable's value.

#### 5.6.32. `Error env var delimiters`

- ***Description:*** The error that the environment variables [`ARGPARSER_ARG_DELIMITER_1`](#5713-argparser_arg_delimiter_1) and [`ARGPARSER_ARG_DELIMITER_2`](#5714-argparser_arg_delimiter_2) have an identical value.
- ***Reasons for error:*** When [`ARGPARSER_CHECK_ENV_VARS`](#5718-argparser_check_env_vars) is set to `true`, the argparser detected that the environment variables `ARGPARSER_ARG_DELIMITER_1` and `ARGPARSER_ARG_DELIMITER_2`, provided by either an option from the [`ARGPARSER_CONFIG_FILE`](#5719-argparser_config_file), on the argparser invokation command line, or as an environment variable, have the same value, rendering parsing of the arguments definition impossible.

#### 5.6.33. `Error env var short name empty`
...
#### 5.6.34. `Error env var short name length`
...
#### 5.6.35. `Error env var short name inner duplication`
...
#### 5.6.36. `Error env var short name outer duplication`
...
#### 5.6.37. `Error env var short options`

- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#5630-error-env-var-option-type) requests short option names, while [`ARGPARSER_USE_SHORT_OPTIONS`](#5757-argparser_use_short_options) prohibits this.
...
#### 5.6.38. `Error env var long options`

- ***Description:*** The error that the environment variable [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#5630-error-env-var-option-type) requests long option names, while [`ARGPARSER_USE_LONG_OPTIONS`](#5756-argparser_use_long_options) prohibits this.
...
- ***Interpolated variables:***
  - `$1`: The path to the argparser, as [`ARGPARSER_SCRIPT_NAME`](#5739-argparser_script_name).

#### 5.6.41. `Error arg array 2`

- ***Description:*** The error that [`ARGPARSER_ARG_ARRAY_NAME`](#579-argparser_arg_array_name) refers to a variable that's not defined.
...
#### 5.6.43. `Error wrong arg def`

- ***Description:*** The error that an argument has a malformed definition.
- ***Reasons for error:*** When reading the arguments definition, the argparser found a definition line giving either a wrong number of columns or only an argument name, with a likewise malformed definition corresponding to this argument in the accompanying [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file).
- ***Interpolated variables:***
  - `$1`: The problematic arguments definition line with the argument.

#### 5.6.44. `Error no arg def`

- ***Description:*** The error that an argument is lacking a definition.
- ***Reasons for error:*** When reading the arguments definition, the argparser found a definition line giving only an argument name, but no definition corresponding to this argument in the accompanying [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file).
- ***Interpolated variables:***
  - `$1`: The problematic arguments definition line with the argument.

#### 5.6.45. `Error arg def field`
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_SCRIPT_NAME`](#5739-argparser_script_name) with the problematic definition.
  - `$2`: The missing column.

#### 5.6.46. `Error arg def file field`

- ***Description:*** The error that the arguments definition in the [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file) lacks a column, instead giving an unused one.
...
- ***Interpolated variables:***
  - `$1`: The [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file) with the problematic definition.
  - `$2`: The missing column.
...
|------------------------------------------------------------------------------------|-----------|--------------------------|
| [`ARGPARSER_ADD_HELP`](#572-argparser_add_help)                                    | *bool*    | `true`                   |
| [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage)                                  | *bool*    | `true`                   |
| [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version)                              | *bool*    | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_INVERSION`](#575-argparser_allow_flag_inversion)            | *bool*    | `true`                   |
| [`ARGPARSER_ALLOW_FLAG_NEGATION`](#576-argparser_allow_flag_negation)              | *bool*    | `true`                   |
| [`ARGPARSER_ALLOW_OPTION_ABBREVIATION`](#577-argparser_allow_option_abbreviation)  | *bool*    | `false`                  |
| [`ARGPARSER_ALLOW_OPTION_MERGING`](#578-argparser_allow_option_merging)            | *bool*    | `false`                  |
| [`ARGPARSER_ARG_ARRAY_NAME`](#579-argparser_arg_array_name)                        | *str*[^4] | `"args"`                 |
| [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file)                           | *file*    | `""`                     |
| [`ARGPARSER_ARG_DEF_FILE_HAS_HEADER`](#5711-argparser_arg_def_file_has_header)     | *bool*    | `true`                   |
| [`ARGPARSER_ARG_DEF_HAS_HEADER`](#5712-argparser_arg_def_has_header)               | *bool*    | `true`                   |
| [`ARGPARSER_ARG_DELIMITER_1`](#5713-argparser_arg_delimiter_1)                     | *char*    | `"\|"`[^5]               |
| [`ARGPARSER_ARG_DELIMITER_2`](#5714-argparser_arg_delimiter_2)                     | *char*    | `","`[^5]                |
| [`ARGPARSER_ARGPARSER_VERSION`](#5715-argparser_argparser_version)                 | *str*     | *None* (unset)           |
| [`ARGPARSER_ARGS`](#5716-argparser_args)                                           | *arr*     | *None* (unset)           |
| [`ARGPARSER_CHECK_ARG_DEF`](#5717-argparser_check_arg_def)                         | *bool*    | `false`                  |
| [`ARGPARSER_CHECK_ENV_VARS`](#5718-argparser_check_env_vars)                       | *bool*    | `false`                  |
| [`ARGPARSER_CONFIG_FILE`](#5719-argparser_config_file)                             | *file*    | `""`                     |
| [`ARGPARSER_COUNT_FLAGS`](#5720-argparser_count_flags)                             | *bool*    | `false`                  |
| [`ARGPARSER_DICTIONARY`](#5721-argparser_dictionary)                               | *dict*    | *None* (unset)           |
| [`ARGPARSER_ERROR_EXIT_CODE`](#5722-argparser_error_exit_code)                     | *int*     | `1`                      |
| [`ARGPARSER_ERROR_STYLE`](#5723-argparser_error_style)                             | *str*     | `"red,bold,reverse"`     |
| [`ARGPARSER_HELP_EXIT_CODE`](#5725-argparser_help_exit_code)                       | *int*     | `0`                      |
| [`ARGPARSER_HELP_ARG_GROUP`](#5724-argparser_help_arg_group)                       | *str*     | `"Help options"`         |
| [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file)                                 | *file*    | `""`                     |
| [`ARGPARSER_HELP_FILE_INCLUDE_CHAR`](#5727-argparser_help_file_include_char)       | *char*    | `"@"`                    |
| [`ARGPARSER_HELP_FILE_KEEP_COMMENTS`](#5728-argparser_help_file_keep_comments)     | *bool*    | `false`                  |
| [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options)                           | *char*    | `"h,?"`                  |
| [`ARGPARSER_HELP_STYLE`](#5730-argparser_help_style)                               | *str*     | `"italic"`               |
| [`ARGPARSER_LANGUAGE`](#5731-argparser_language)                                   | *str*     | `"en"`                   |
| [`ARGPARSER_MAX_COL_WIDTH_1`](#5732-argparser_max_col_width_1)                     | *uint*    | `5`[^6]                  |
| [`ARGPARSER_MAX_COL_WIDTH_2`](#5733-argparser_max_col_width_2)                     | *uint*    | `33`[^6]                 |
| [`ARGPARSER_MAX_COL_WIDTH_3`](#5734-argparser_max_col_width_3)                     | *uint*    | `0`[^6]                  |
| [`ARGPARSER_MAX_WIDTH`](#5735-argparser_max_width)                                 | *uint*    | `79`                     |
| [`ARGPARSER_POSITIONAL_ARG_GROUP`](#5736-argparser_positional_arg_group)           | *str*     | `"Positional arguments"` |
| [`ARGPARSER_READ_ARGS`](#5737-argparser_read_args)                                 | *bool*    | `true`                   |
| [`ARGPARSER_SCRIPT_ARGS`](#5738-argparser_script_args)                             | *arr*     | *None* (unset)           |
| [`ARGPARSER_SCRIPT_NAME`](#5739-argparser_script_name)                             | *str*     | `"${0##*/}"`             |
| [`ARGPARSER_SET_ARGS`](#5740-argparser_set_args)                                   | *bool*    | `true`                   |
| [`ARGPARSER_SET_ARRAYS`](#5741-argparser_set_arrays)                               | *bool*    | `true`                   |
| [`ARGPARSER_SILENCE_ERRORS`](#5742-argparser_silence_errors)                       | *bool*    | `false`                  |
| [`ARGPARSER_SILENCE_WARNINGS`](#5743-argparser_silence_warnings)                   | *bool*    | `false`                  |
| [`ARGPARSER_TRANSLATION_FILE`](#5744-argparser_translation_file)                   | *file*    | `""`                     |
| [`ARGPARSER_UNSET_ARGS`](#5745-argparser_unset_args)                               | *bool*    | `true`                   |
| [`ARGPARSER_UNSET_ENV_VARS`](#5746-argparser_unset_env_vars)                       | *bool*    | `true`                   |
| [`ARGPARSER_UNSET_FUNCTIONS`](#5747-argparser_unset_functions)                     | *bool*    | `true`                   |
| [`ARGPARSER_USAGE_EXIT_CODE`](#5748-argparser_usage_exit_code)                     | *int*     | `0`                      |
| [`ARGPARSER_USAGE_FILE`](#5749-argparser_usage_file)                               | *file*    | `""`                     |
| [`ARGPARSER_USAGE_FILE_INCLUDE_CHAR`](#5750-argparser_usage_file_include_char)     | *char*    | `"@"`                    |
| [`ARGPARSER_USAGE_FILE_KEEP_COMMENTS`](#5751-argparser_usage_file_keep_comments)   | *bool*    | `false`                  |
| [`ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`](#5752-argparser_usage_message_option_type) | *str*     | `"short"`                |
| [`ARGPARSER_USAGE_MESSAGE_ORIENTATION`](#5753-argparser_usage_message_orientation) | *str*     | `"row"`                  |
| [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options)                         | *char*    | `"u"`                    |
| [`ARGPARSER_USAGE_STYLE`](#5755-argparser_usage_style)                             | *str*     | `"italic"`               |
| [`ARGPARSER_USE_LONG_OPTIONS`](#5756-argparser_use_long_options)                   | *bool*    | `true`                   |
| [`ARGPARSER_USE_SHORT_OPTIONS`](#5757-argparser_use_short_options)                 | *bool*    | `true`                   |
| [`ARGPARSER_USE_STYLES_IN_FILES`](#5758-argparser_use_styles_in_files)             | *bool*    | `false`                  |
| [`ARGPARSER_VERSION`](#5759-argparser_version)                                     | *str*     | `"1.0.0"`                |
| [`ARGPARSER_VERSION_EXIT_CODE`](#5760-argparser_version_exit_code)                 | *int*     | `0`                      |
| [`ARGPARSER_VERSION_OPTIONS`](#5761-argparser_version_options)                     | *char*    | `"V"`                    |
| [`ARGPARSER_VERSION_STYLE`](#5762-argparser_version_style)                         | *str*     | `"bold"`                 |
| [`ARGPARSER_WARNING_STYLE`](#5763-argparser_warning_style)                         | *str*     | `"red,bold"`             |
| [`ARGPARSER_WRITE_ARGS`](#5764-argparser_write_args)                               | *bool*    | `false`                  |
...
#### 5.7.2. `ARGPARSER_ADD_HELP`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to add the [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options) and `--help` as flags to call the help message.

#### 5.7.3. `ARGPARSER_ADD_USAGE`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to add the [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options) and `--usage` as flags to call the usage message.

#### 5.7.4. `ARGPARSER_ADD_VERSION`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to add the [`ARGPARSER_VERSION_OPTIONS`](#5761-argparser_version_options) and `--version` as flags to call the version message.

#### 5.7.5. `ARGPARSER_ALLOW_FLAG_INVERSION`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to allow the user to give flags with a prefixed `+` instead of `-` (for short option names) or `++` instead of `--` (for long option names) to negate its value. If [`ARGPARSER_ALLOW_FLAG_NEGATION`](#576-argparser_allow_flag_negation) is set to `true`, this doubles with the effect of using `no-` as prefix for long option names.

#### 5.7.6. `ARGPARSER_ALLOW_FLAG_NEGATION`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to allow the user to give long option names for flags with a prefixed `no-` to negate its value.  If [`ARGPARSER_ALLOW_FLAG_INVERSION`](#575-argparser_allow_flag_inversion) is set to `true`, this doubles with the effect of using `++` as prefix, instead of `--`.

#### 5.7.7. `ARGPARSER_ALLOW_OPTION_ABBREVIATION`
...
#### 5.7.8. `ARGPARSER_ALLOW_OPTION_MERGING`
...
#### 5.7.9. `ARGPARSER_ARG_ARRAY_NAME`
...
#### 5.7.11. `ARGPARSER_ARG_DEF_FILE_HAS_HEADER`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether the arguments definition file has a header explaining the columns. This is only evaluated if an [`ARGPARSER_ARG_DEF_FILE`](#5710-argparser_arg_def_file) is given.

#### 5.7.12. `ARGPARSER_ARG_DEF_HAS_HEADER`
...
#### 5.7.13. `ARGPARSER_ARG_DELIMITER_1`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique character that's not used as [`ARGPARSER_ARG_DELIMITER_2`](#5714-argparser_arg_delimiter_2), no hyphen (`-`), plus sign (`+`), asterisk (`*`), or question mark (`?`)
- ***Default value:*** `"|"`
...
#### 5.7.14. `ARGPARSER_ARG_DELIMITER_2`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique character that's not used as [`ARGPARSER_ARG_DELIMITER_1`](#5713-argparser_arg_delimiter_1), no hyphen (`-`), plus sign (`+`), asterisk (`*`), or question mark (`?`)
- ***Default value:*** `","`
...
#### 5.7.17. `ARGPARSER_CHECK_ARG_DEF`
...
#### 5.7.18. `ARGPARSER_CHECK_ENV_VARS`
...
#### 5.7.24. `ARGPARSER_HELP_ARG_GROUP`
...
#### 5.7.25. `ARGPARSER_HELP_EXIT_CODE`

- ***Type:*** *int* (Integer)
- ***Allowed values:*** Any integer, usually zero
- ***Default value:*** `0`
- ***Description:*** The exit code when a help message was requested using the [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options)  or the `--help` flag.

#### 5.7.26. `ARGPARSER_HELP_FILE`

- ***Type:*** *file* (Filepath)
- ***Allowed values:*** Any legit filepath or the empty string `""`
- ***Default value:*** `""`
- ***Description:*** The path to a file holding the extended help message. This file may be used by multiple scripts, even if they share no arguments. By this, the default structure and content of the auto-generated help message (invoked with the [`ARGPARSER_HELP_OPTIONS`](#5729-argparser_help_options)  or `--help`) can be overridden for all scripts in a project in the same way, without repeating yourself upon specifying the look.

#### 5.7.27. `ARGPARSER_HELP_FILE_INCLUDE_CHAR`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique character that's not used as a line's first character in an [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file)
- ***Default value:*** `"@"`
- ***Description:*** The character that introduces an include directive in an [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file). You must ensure that it is set to a character or glyph that does not occur as any line's first character in the help file, where it should not mean an include directive. This is only evaluated if an `ARGPARSER_HELP_FILE` is given.

#### 5.7.28. `ARGPARSER_HELP_FILE_KEEP_COMMENTS`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `false`
- ***Description:*** Whether to keep commented lines (and their trailing blank lines) in the help file. By this, you can choose whether you want to include lines serving as a comment (starting with a hashmark, *i.e.*, `#`) in the help file also in the help message. This is only evaluated if an [`ARGPARSER_HELP_FILE`](#5726-argparser_help_file) is given.

#### 5.7.29. `ARGPARSER_HELP_OPTIONS`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique short-option character that's not used in the arguments definition
- ***Default value:*** `"h,?"`
- ***Description:*** The short option names used to call the help message. This is only evaluated if [`ARGPARSER_ADD_HELP`](#572-argparser_add_help) is `true`.

#### 5.7.30. `ARGPARSER_HELP_STYLE`
...
#### 5.7.36. `ARGPARSER_POSITIONAL_ARG_GROUP`
...
#### 5.7.37. `ARGPARSER_READ_ARGS`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to read the arguments from the command line (*i.e.*, from `"$@"`) and parse them to the associative array the [`ARGPARSER_ARG_ARRAY_NAME`](#579-argparser_arg_array_name) sets.

#### 5.7.38. `ARGPARSER_SCRIPT_ARGS`
...
#### 5.7.40. `ARGPARSER_SET_ARGS`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `true`
- ***Description:*** Whether to set the (read and parsed) arguments from the associative array the [`ARGPARSER_ARG_ARRAY_NAME`](#579-argparser_arg_array_name) refers to as variables in the calling script's scope.
...
#### 5.7.46. `ARGPARSER_UNSET_ENV_VARS`
...
#### 5.7.47. `ARGPARSER_UNSET_FUNCTIONS`
...
#### 5.7.48. `ARGPARSER_USAGE_EXIT_CODE`

- ***Type:*** *int* (Integer)
- ***Allowed values:*** Any integer, usually zero
- ***Default value:*** `0`
- ***Description:*** The exit code when a usage message was requested using the [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options) or the `--usage` flag.

#### 5.7.49. `ARGPARSER_USAGE_FILE`

- ***Type:*** *file* (Filepath)
- ***Allowed values:*** Any legit filepath or the empty string `""`
- ***Default value:*** `""`
- ***Description:*** The path to a file holding the extended usage message. This file may be used by multiple scripts, even if they share no arguments. By this, the default structure and content of the auto-generated usage message (invoked with the [`ARGPARSER_USAGE_OPTIONS`](#5754-argparser_usage_options) or `--usage`) can be overridden for all scripts in a project in the same way, without repeating yourself upon specifying the look.

#### 5.7.50. `ARGPARSER_USAGE_FILE_INCLUDE_CHAR`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique character that's not used as a line's first character in an [`ARGPARSER_USAGE_FILE`](#5749-argparser_usage_file)
- ***Default value:*** `"@"`
- ***Description:*** The character that introduces an include directive in an [`ARGPARSER_USAGE_FILE`](#5749-argparser_usage_file). You must ensure that it is set to a character or glyph that does not occur as any line's first character in the usage file, where it should not mean an include directive. This is only evaluated if an `ARGPARSER_USAGE_FILE` is given.

#### 5.7.51. `ARGPARSER_USAGE_FILE_KEEP_COMMENTS`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `false`
- ***Description:*** Whether to keep commented lines (and their trailing blank lines) in the usage file. By this, you can choose whether you want to include lines serving as a comment (starting with a hashmark, *i.e.*, `#`) in the usage file also in the usage message. This is only evaluated if an [`ARGPARSER_USAGE_FILE`](#5749-argparser_usage_file) is given.

#### 5.7.52. `ARGPARSER_USAGE_MESSAGE_OPTION_TYPE`
...
#### 5.7.53. `ARGPARSER_USAGE_MESSAGE_ORIENTATION`
...
#### 5.7.54. `ARGPARSER_USAGE_OPTIONS`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique short-option character that's not used in the arguments definition
- ***Default value:*** `"u"`
- ***Description:*** The short option names used to call the usage message. This is only evaluated if [`ARGPARSER_ADD_USAGE`](#573-argparser_add_usage) is `true`.

#### 5.7.55. `ARGPARSER_USAGE_STYLE`
...
#### 5.7.60. `ARGPARSER_VERSION_EXIT_CODE`

- ***Type:*** *int* (Integer)
- ***Allowed values:*** Any integer, usually zero
- ***Default value:*** `0`
- ***Description:*** The exit code when a version message was requested using the [`ARGPARSER_VERSION_OPTIONS`](#5761-argparser_version_options) or the `--version` flag.

#### 5.7.61. `ARGPARSER_VERSION_OPTIONS`

- ***Type:*** *char* (Character)
- ***Allowed values:*** Any unique short-option character that's not used in the arguments definition
- ***Default value:*** `"V"`
- ***Description:*** The short option names used to call the version message. This is only evaluated if [`ARGPARSER_ADD_VERSION`](#574-argparser_add_version) is `true`.

#### 5.7.62. `ARGPARSER_VERSION_STYLE`
...
#### 5.7.63. `ARGPARSER_WARNING_STYLE`
...
#### 5.7.64. `ARGPARSER_WRITE_ARGS`

- ***Type:*** *bool* (Boolean)
- ***Allowed values:*** `true` and `false`
- ***Default value:*** `false`
- ***Description:*** Whether to write the arguments from [`ARGPARSER_ARG_ARRAY_NAME`](#579-argparser_arg_array_name) to STDOUT. This is required for running the argparser in a pipe to be able to access the parsed arguments. These are output as key&ndash;value pairs, separated by linefeeds.
